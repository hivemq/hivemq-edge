...
public class EipTagDefinition implements TagDefinition {
    ...
    @ModuleConfigField(title = "address", description = "Address of the tag on the device", required = true)
    ...
    @ModuleConfigField(
            ...
            enumDisplayValues = {
                "Bool", "DInt", "Int", "LInt", "LReal", "LTime", "Real", "SInt", "String", "Time", "UDInt", "UInt",
                "ULInt", "USInt"
            },
            required = true)
    ...
    @JsonCreator
    public EipTagDefinition(
            @JsonProperty(value = "address", required = true) final @NotNull String address,
