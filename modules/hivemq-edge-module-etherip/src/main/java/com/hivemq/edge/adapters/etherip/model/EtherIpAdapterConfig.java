...
public class EtherIpAdapterConfig implements ProtocolAdapterConfig {
    ...
    private @NotNull List<EtherIpAdapterConfig.PollingContextImpl> subscriptions = new ArrayList<>();
    ...
    public static class EIPPollingContextImpl extends PollingContextImpl {
        ...
        @ModuleConfigField(title = "Data Type", description = "The expected data type of the tag", enumDisplayValues = {
                ...
                "ULInt",
                "USInt"}, required = true)
        private @NotNull EIP_DATA_TYPE eipDataType;

        public EIP_DATA_TYPE getEipDataType() {
            return eipDataType;
        }
    }
    ...
    public @NotNull List<EtherIpAdapterConfig.PollingContextImpl> getSubscriptions() {
    ...
    public static class PollingContextImpl implements PollingContext {
        ...
        @ModuleConfigField(title = "Data Type",
                           ...
                           required = true)
        private @NotNull EtherIpDataTypes.DATA_TYPE dataType;
        ...
        public EtherIpDataTypes.DATA_TYPE getDataType() {
            return dataType;
        }
