...
import com.hivemq.extension.sdk.api.adapters.config.MessageHandlingOptions;
...
public class ModbusAdapterConfig implements ProtocolAdapterConfig {
    ...
    public static class AdapterSubscription implements
            com.hivemq.extension.sdk.api.adapters.config.AdapterSubscription {
