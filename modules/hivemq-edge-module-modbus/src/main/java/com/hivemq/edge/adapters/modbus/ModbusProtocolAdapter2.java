...
/**
 * {@link com.hivemq.adapter.sdk.api.ProtocolAdapter2 ProtocolAdapter2} implementation for the Modbus adapter.
 * Northbound only (read from device, publish to MQTT).
 */
public class ModbusProtocolAdapter2 extends ProtocolAdapter2Bridge {

    public ModbusProtocolAdapter2(
