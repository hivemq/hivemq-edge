 ...
 * 
 * <p>Java class for PressureDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PressureDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}PressureEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PressureDataSetType")
@XmlType(name = "PressureDataSetType", propOrder = {
    "entry"
})
public class PressureDataSetType
    extends EventType
{
    ...
    protected List<PressureEntryType> entry;
    /**
     ...
     */
    public List<PressureEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
