...
/**
 * DataSet of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
 *         {{property(result)}} is not `WAIT`, the
 *         {{property(Observation::isUnavailable)}} property of
 *         {{block(WaitState)}} **MUST** be `true`.
 * 
 * <p>Java class for WaitStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WaitStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}WaitStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WaitStateDataSetType")
@XmlType(name = "WaitStateDataSetType", propOrder = {
    "entry"
})
public class WaitStateDataSetType
    extends EventType
{
    ...
    protected List<WaitStateEntryType> entry;
    /**
     ...
     */
    public List<WaitStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
