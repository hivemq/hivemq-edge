 ...
 * 
 * <p>Java class for SensorStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SensorStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}SensorStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SensorStateTableType")
@XmlType(name = "SensorStateTableType", propOrder = {
    "entry"
})
public class SensorStateTableType
    extends EventType
{
    ...
    protected List<SensorStateTableEntryType> entry;
    /**
     ...
     * {@link SensorStateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<SensorStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
