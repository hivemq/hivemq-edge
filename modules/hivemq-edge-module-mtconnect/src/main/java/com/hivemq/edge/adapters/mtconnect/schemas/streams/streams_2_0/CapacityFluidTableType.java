 ...
 * 
 * <p>Java class for CapacityFluidTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CapacityFluidTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}CapacityFluidTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CapacityFluidTableType")
@XmlType(name = "CapacityFluidTableType", propOrder = {
    "entry"
})
public class CapacityFluidTableType
    extends EventType
{
    ...
    protected List<CapacityFluidTableEntryType> entry;
    /**
     ...
     * {@link CapacityFluidTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<CapacityFluidTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
