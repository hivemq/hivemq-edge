 ...
 * 
 * <p>Java class for ChuckStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ChuckStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ChuckStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ChuckStateTableType")
@XmlType(name = "ChuckStateTableType", propOrder = {
    "entry"
})
public class ChuckStateTableType
    extends EventType
{
    ...
    protected List<ChuckStateTableEntryType> entry;
    /**
     ...
     */
    public List<ChuckStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
