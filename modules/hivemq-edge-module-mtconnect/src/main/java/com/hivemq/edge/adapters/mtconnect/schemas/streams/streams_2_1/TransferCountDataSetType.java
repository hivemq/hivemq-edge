 ...
 * 
 * <p>Java class for TransferCountDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TransferCountDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}TransferCountEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TransferCountDataSetType")
@XmlType(name = "TransferCountDataSetType", propOrder = {
    "entry"
})
public class TransferCountDataSetType
    extends EventType
{
    ...
    protected List<TransferCountEntryType> entry;
    /**
     ...
     */
    public List<TransferCountEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
