 ...
 * 
 * <p>Java class for ChuckInterlockTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ChuckInterlockTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ChuckInterlockTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ChuckInterlockTableType")
@XmlType(name = "ChuckInterlockTableType", propOrder = {
    "entry"
})
public class ChuckInterlockTableType
    extends EventType
{
    ...
    protected List<ChuckInterlockTableEntryType> entry;
    /**
     ...
     * {@link ChuckInterlockTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ChuckInterlockTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
