 ...
 * 
 * <p>Java class for DiameterDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DiameterDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}DiameterEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DiameterDataSetType")
@XmlType(name = "DiameterDataSetType", propOrder = {
    "entry"
})
public class DiameterDataSetType
    extends EventType
{
    ...
    protected List<DiameterEntryType> entry;
    /**
     ...
     */
    public List<DiameterEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
