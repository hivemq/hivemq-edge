...
public enum ExecutionValueType {
    ...
    /**
     * The action of a {{block(Component)}} has been suspended due to an
     *             external signal.
     * 
     */
    INTERRUPTED,
    ...
    /**
     * Motion of a {{block(Component)}} has been commanded to stop at its
     *             current position.
     * 
     */
    FEED_HOLD,
    ...
    /**
     * The execution of the {{block(Controller)}}'s program has been
     *             stopped by a command from within the program.
     * 
     */
    PROGRAM_STOPPED,
