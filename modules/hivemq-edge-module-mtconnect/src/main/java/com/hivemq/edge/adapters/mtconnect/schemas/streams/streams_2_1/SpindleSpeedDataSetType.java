 ...
 * 
 * <p>Java class for SpindleSpeedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SpindleSpeedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}SpindleSpeedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SpindleSpeedDataSetType")
@XmlType(name = "SpindleSpeedDataSetType", propOrder = {
    "entry"
})
public class SpindleSpeedDataSetType
    extends EventType
{
    ...
    protected List<SpindleSpeedEntryType> entry;
    /**
     ...
     */
    public List<SpindleSpeedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
