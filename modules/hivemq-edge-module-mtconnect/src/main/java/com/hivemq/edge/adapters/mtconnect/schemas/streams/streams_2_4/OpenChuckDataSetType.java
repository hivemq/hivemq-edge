 ...
 * 
 * <p>Java class for OpenChuckDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OpenChuckDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}OpenChuckEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OpenChuckDataSetType")
@XmlType(name = "OpenChuckDataSetType", propOrder = {
    "entry"
})
public class OpenChuckDataSetType
    extends EventType
{
    ...
    protected List<OpenChuckEntryType> entry;
    /**
     ...
     */
    public List<OpenChuckEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
