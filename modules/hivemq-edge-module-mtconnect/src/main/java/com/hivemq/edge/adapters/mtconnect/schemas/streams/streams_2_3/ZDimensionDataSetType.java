 ...
 * 
 * <p>Java class for ZDimensionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ZDimensionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ZDimensionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ZDimensionDataSetType")
@XmlType(name = "ZDimensionDataSetType", propOrder = {
    "entry"
})
public class ZDimensionDataSetType
    extends EventType
{
    ...
    protected List<ZDimensionEntryType> entry;
    /**
     ...
     */
    public List<ZDimensionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
