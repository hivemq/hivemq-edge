 ...
 * 
 * <p>Java class for OrientationTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OrientationTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}OrientationTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OrientationTableType")
@XmlType(name = "OrientationTableType", propOrder = {
    "entry"
})
public class OrientationTableType
    extends EventType
{
    ...
    protected List<OrientationTableEntryType> entry;
    /**
     ...
     * {@link OrientationTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<OrientationTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
