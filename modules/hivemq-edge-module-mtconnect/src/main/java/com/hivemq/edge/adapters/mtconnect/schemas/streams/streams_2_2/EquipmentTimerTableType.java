 ...
 * 
 * <p>Java class for EquipmentTimerTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EquipmentTimerTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}EquipmentTimerTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EquipmentTimerTableType")
@XmlType(name = "EquipmentTimerTableType", propOrder = {
    "entry"
})
public class EquipmentTimerTableType
    extends EventType
{
    ...
    protected List<EquipmentTimerTableEntryType> entry;
    /**
     ...
     * {@link EquipmentTimerTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<EquipmentTimerTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
