 ...
 *         <choice>
 *           <sequence>
 *             <element name="CuttingToolDefinition" type="{urn:mtconnect.org:MTConnectAssets:2.1}CuttingToolDefinitionType"/>
 *             <element name="CuttingToolLifeCycle" type="{urn:mtconnect.org:MTConnectAssets:2.1}CuttingToolLifeCycleType" minOccurs="0"/>
 *           </sequence>
 *           <element name="CuttingToolLifeCycle" type="{urn:mtconnect.org:MTConnectAssets:2.1}CuttingToolLifeCycleType"/>
 *         </choice>
 *       </sequence>
 *       <attribute name="serialNumber" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.1}SerialNumberAttrType" />
 *       <attribute name="manufacturers" type="{urn:mtconnect.org:MTConnectAssets:2.1}ManufacturersType" />
 *       <attribute name="toolId" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.1}CuttingToolIdType" />
 *     </extension>
 *   </complexContent>
 * </complexType>
 * }</pre>
    ...
    extends AssetType
{
     ...
     * line 13469 of file:/Users/yingda.cao/coding/HiveMQ/hivemq-edge/modules/hivemq-edge-module-mtconnect/schema/MTConnectAssets_2.1.xsd
     * line 13457 of file:/Users/yingda.cao/coding/HiveMQ/hivemq-edge/modules/hivemq-edge-module-mtconnect/schema/MTConnectAssets_2.1.xsd
     * <p>
     ...
     */
    @XmlElementRefs({
        @XmlElementRef(name = "Description", namespace = "urn:mtconnect.org:MTConnectAssets:2.1", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "CuttingToolDefinition", namespace = "urn:mtconnect.org:MTConnectAssets:2.1", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "CuttingToolLifeCycle", namespace = "urn:mtconnect.org:MTConnectAssets:2.1", type = JAXBElement.class, required = false)
    })
