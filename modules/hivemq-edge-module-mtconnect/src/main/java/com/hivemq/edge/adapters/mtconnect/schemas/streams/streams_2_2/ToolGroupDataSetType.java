 ...
 * 
 * <p>Java class for ToolGroupDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolGroupDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ToolGroupEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolGroupDataSetType")
@XmlType(name = "ToolGroupDataSetType", propOrder = {
    "entry"
})
public class ToolGroupDataSetType
    extends EventType
{
    ...
    protected List<ToolGroupEntryType> entry;
    /**
     ...
     */
    public List<ToolGroupEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
