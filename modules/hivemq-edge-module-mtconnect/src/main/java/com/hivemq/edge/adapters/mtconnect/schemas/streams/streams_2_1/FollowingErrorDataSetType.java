 ...
 * 
 * <p>Java class for FollowingErrorDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FollowingErrorDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}FollowingErrorEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FollowingErrorDataSetType")
@XmlType(name = "FollowingErrorDataSetType", propOrder = {
    "entry"
})
public class FollowingErrorDataSetType
    extends EventType
{
    ...
    protected List<FollowingErrorEntryType> entry;
    /**
     ...
     */
    public List<FollowingErrorEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
