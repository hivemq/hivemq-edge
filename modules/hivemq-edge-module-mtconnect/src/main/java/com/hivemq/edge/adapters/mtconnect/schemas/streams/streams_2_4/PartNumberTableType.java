 ...
 * 
 * <p>Java class for PartNumberTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartNumberTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}PartNumberTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartNumberTableType")
@XmlType(name = "PartNumberTableType", propOrder = {
    "entry"
})
public class PartNumberTableType
    extends EventType
{
    ...
    protected List<PartNumberTableEntryType> entry;
    /**
     ...
     */
    public List<PartNumberTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
