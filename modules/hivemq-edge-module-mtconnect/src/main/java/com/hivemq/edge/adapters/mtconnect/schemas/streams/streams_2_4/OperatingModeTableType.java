 ...
 * 
 * <p>Java class for OperatingModeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OperatingModeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}OperatingModeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OperatingModeTableType")
@XmlType(name = "OperatingModeTableType", propOrder = {
    "entry"
})
public class OperatingModeTableType
    extends EventType
{
    ...
    protected List<OperatingModeTableEntryType> entry;
    /**
     ...
     * {@link OperatingModeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<OperatingModeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
