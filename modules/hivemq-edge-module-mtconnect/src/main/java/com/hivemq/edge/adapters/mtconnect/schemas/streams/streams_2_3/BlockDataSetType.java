 ...
 * 
 * <p>Java class for BlockDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BlockDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}BlockEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BlockDataSetType")
@XmlType(name = "BlockDataSetType", propOrder = {
    "entry"
})
public class BlockDataSetType
    extends EventType
{
    ...
    protected List<BlockEntryType> entry;
    /**
     ...
     */
    public List<BlockEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
