 ...
 * 
 * <p>Java class for OpennessTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OpennessTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}OpennessTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OpennessTableType")
@XmlType(name = "OpennessTableType", propOrder = {
    "entry"
})
public class OpennessTableType
    extends EventType
{
    ...
    protected List<OpennessTableEntryType> entry;
    /**
     ...
     */
    public List<OpennessTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
