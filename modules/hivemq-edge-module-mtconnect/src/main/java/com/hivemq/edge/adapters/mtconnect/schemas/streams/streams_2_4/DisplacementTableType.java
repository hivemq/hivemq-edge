 ...
 * 
 * <p>Java class for DisplacementTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DisplacementTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}DisplacementTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DisplacementTableType")
@XmlType(name = "DisplacementTableType", propOrder = {
    "entry"
})
public class DisplacementTableType
    extends EventType
{
    ...
    protected List<DisplacementTableEntryType> entry;
    /**
     ...
     * {@link DisplacementTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DisplacementTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
