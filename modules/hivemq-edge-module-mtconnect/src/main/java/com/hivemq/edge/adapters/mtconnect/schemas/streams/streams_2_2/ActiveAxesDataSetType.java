 ...
 * 
 * <p>Java class for ActiveAxesDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ActiveAxesDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ActiveAxesEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ActiveAxesDataSetType")
@XmlType(name = "ActiveAxesDataSetType", propOrder = {
    "entry"
})
public class ActiveAxesDataSetType
    extends EventType
{
    ...
    protected List<ActiveAxesEntryType> entry;
    /**
     ...
     */
    public List<ActiveAxesEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
