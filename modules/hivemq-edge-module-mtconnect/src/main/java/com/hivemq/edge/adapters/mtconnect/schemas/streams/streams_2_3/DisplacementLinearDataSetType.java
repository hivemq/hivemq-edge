 ...
 *         {{block(Component)}}.
 * 
 * <p>Java class for DisplacementLinearDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DisplacementLinearDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}DisplacementLinearEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DisplacementLinearDataSetType")
@XmlType(name = "DisplacementLinearDataSetType", propOrder = {
    "entry"
})
public class DisplacementLinearDataSetType
    extends EventType
{
    ...
    protected List<DisplacementLinearEntryType> entry;
    /**
     ...
     * {@link DisplacementLinearEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DisplacementLinearEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
