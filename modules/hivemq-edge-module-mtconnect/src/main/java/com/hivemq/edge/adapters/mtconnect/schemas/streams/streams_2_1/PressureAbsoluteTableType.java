 ...
 * 
 * <p>Java class for PressureAbsoluteTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PressureAbsoluteTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}PressureAbsoluteTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PressureAbsoluteTableType")
@XmlType(name = "PressureAbsoluteTableType", propOrder = {
    "entry"
})
public class PressureAbsoluteTableType
    extends EventType
{
    ...
    protected List<PressureAbsoluteTableEntryType> entry;
    /**
     ...
     * {@link PressureAbsoluteTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<PressureAbsoluteTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
