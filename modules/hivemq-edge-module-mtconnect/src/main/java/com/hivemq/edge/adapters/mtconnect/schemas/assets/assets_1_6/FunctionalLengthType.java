...
/**
 * The distance from the gauge plane or from the end of the shank to the
 ...
 *         cuttingtool functional length will be the length of the entire tool, not
 *         a single Cutting Item. Each cuttingitem can have an independent
 *         functionallength represented in its measurements.
 * 
