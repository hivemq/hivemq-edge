 ...
 * 
 * <p>Java class for MaterialDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}MaterialEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialDataSetType")
@XmlType(name = "MaterialDataSetType", propOrder = {
    "entry"
})
public class MaterialDataSetType
    extends EventType
{
    ...
    protected List<MaterialEntryType> entry;
    /**
     ...
     */
    public List<MaterialEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
