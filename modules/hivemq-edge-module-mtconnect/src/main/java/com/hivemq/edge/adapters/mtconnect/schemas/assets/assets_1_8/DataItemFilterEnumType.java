...
public enum DataItemFilterEnumType {
    ...
    /**
     * For a `MINIMUM_DELTA` type {{block(Filter)}}, a new value **MUST
     *             NOT** be reported for a data item unless the measured value has
     *             changed from the last reported value by at least the delta given as
     *             the value of this element. The value of {{block(Filter)}} **MUST**
     *             be an absolute value using the same units as the reported data.
     * 
     */
    MINIMUM_DELTA,

    /**
     * For a `PERIOD` type {{block(Filter)}}, the data reported for a data
