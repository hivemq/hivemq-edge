 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}MaintenanceListEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@XmlType(name = "MaintenanceListDataSetType", propOrder = {
    "entry"
})
    ...
    extends EventType
{
    ...
    protected List<MaintenanceListEntryType> entry;
    /**
     ...
     */
    public List<MaintenanceListEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
