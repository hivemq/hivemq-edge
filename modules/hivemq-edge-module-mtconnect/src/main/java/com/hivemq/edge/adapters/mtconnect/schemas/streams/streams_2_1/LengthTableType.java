 ...
 * 
 * <p>Java class for LengthTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LengthTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}LengthTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LengthTableType")
@XmlType(name = "LengthTableType", propOrder = {
    "entry"
})
public class LengthTableType
    extends EventType
{
    ...
    protected List<LengthTableEntryType> entry;
    /**
     ...
     */
    public List<LengthTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
