 ...
 *       <sequence>
 *         <element name="Cell" type="{urn:mtconnect.org:MTConnectStreams:2.1}DisplacementAngularCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "DisplacementAngularTableEntryType", propOrder = {
    "cell"
})
    ...
    extends EntryType
{
    ...
    protected List<DisplacementAngularCellType> cell;
     ...
     * {@link DisplacementAngularCellType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DisplacementAngularCellType> getCell() {
        if (cell == null) {
            cell = new ArrayList<>();
        }
        return this.cell;
