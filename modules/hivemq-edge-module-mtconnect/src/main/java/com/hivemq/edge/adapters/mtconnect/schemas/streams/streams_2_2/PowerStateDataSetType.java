 ...
 * 
 * <p>Java class for PowerStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PowerStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}PowerStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PowerStateDataSetType")
@XmlType(name = "PowerStateDataSetType", propOrder = {
    "entry"
})
public class PowerStateDataSetType
    extends EventType
{
    ...
    protected List<PowerStateEntryType> entry;
    /**
     ...
     */
    public List<PowerStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
