 ...
 * 
 * <p>Java class for UnloadCountTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="UnloadCountTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}UnloadCountTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "UnloadCountTableType")
@XmlType(name = "UnloadCountTableType", propOrder = {
    "entry"
})
public class UnloadCountTableType
    extends EventType
{
    ...
    protected List<UnloadCountTableEntryType> entry;
    /**
     ...
     * {@link UnloadCountTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<UnloadCountTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
