 ...
 * 
 * <p>Java class for DepositionMassTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DepositionMassTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}DepositionMassTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DepositionMassTableType")
@XmlType(name = "DepositionMassTableType", propOrder = {
    "entry"
})
public class DepositionMassTableType
    extends EventType
{
    ...
    protected List<DepositionMassTableEntryType> entry;
    /**
     ...
     * {@link DepositionMassTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DepositionMassTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
