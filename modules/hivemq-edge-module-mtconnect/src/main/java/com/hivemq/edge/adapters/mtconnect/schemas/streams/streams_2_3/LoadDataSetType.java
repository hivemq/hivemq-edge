 ...
 * 
 * <p>Java class for LoadDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LoadDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}LoadEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LoadDataSetType")
@XmlType(name = "LoadDataSetType", propOrder = {
    "entry"
})
public class LoadDataSetType
    extends EventType
{
    ...
    protected List<LoadEntryType> entry;
    /**
     ...
     */
    public List<LoadEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
