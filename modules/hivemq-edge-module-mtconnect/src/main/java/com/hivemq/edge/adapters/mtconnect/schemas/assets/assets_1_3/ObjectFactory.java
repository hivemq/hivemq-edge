 ...
 * generated in the com.hivemq.edge.adapters.mtconnect.schemas.assets.assets_1_3 package. 
...
public class ObjectFactory {
    ...
    private static final QName _MTConnectAssets_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "MTConnectAssets");
    private static final QName _Asset_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "Asset");
    private static final QName _CuttingTool_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingTool");
    private static final QName _CuttingToolArchetype_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingToolArchetype");
    private static final QName _Measurement_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "Measurement");
    private static final QName _CommonMeasurement_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CommonMeasurement");
    private static final QName _AssemblyMeasurement_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "AssemblyMeasurement");
    private static final QName _CuttingItemMeasurement_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingItemMeasurement");
    private static final QName _ProtrudingLength_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "ProtrudingLength");
    private static final QName _Weight_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "Weight");
    private static final QName _FunctionalLength_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "FunctionalLength");
    private static final QName _BodyDiameterMax_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "BodyDiameterMax");
    private static final QName _BodyLengthMax_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "BodyLengthMax");
    private static final QName _CuttingDiameterMax_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingDiameterMax");
    private static final QName _FlangeDiameterMax_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "FlangeDiameterMax");
    private static final QName _DepthOfCutMax_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "DepthOfCutMax");
    private static final QName _OverallToolLength_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "OverallToolLength");
    private static final QName _ShankDiameter_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "ShankDiameter");
    private static final QName _ShankHeight_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "ShankHeight");
    private static final QName _ShankLength_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "ShankLength");
    private static final QName _UsableLengthMax_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "UsableLengthMax");
    private static final QName _CuttingDiameter_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingDiameter");
    private static final QName _CornerRadius_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CornerRadius");
    private static final QName _CuttingEdgeLength_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingEdgeLength");
    private static final QName _CuttingHeight_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingHeight");
    private static final QName _CuttingReferencePoint_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingReferencePoint");
    private static final QName _FlangeDiameter_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "FlangeDiameter");
    private static final QName _FunctionalWidth_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "FunctionalWidth");
    private static final QName _InclinationAngle_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "InclinationAngle");
    private static final QName _IncribedCircleDiameter_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "IncribedCircleDiameter");
    private static final QName _PointAngle_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "PointAngle");
    private static final QName _StepDiameterLength_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "StepDiameterLength");
    private static final QName _StepIncludedAngle_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "StepIncludedAngle");
    private static final QName _ToolCuttingEdgeAngle_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "ToolCuttingEdgeAngle");
    private static final QName _ToolLeadAngle_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "ToolLeadAngle");
    private static final QName _WiperEdgeLength_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "WiperEdgeLength");
    private static final QName _CuttingToolArchetypeTypeDescription_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "Description");
    private static final QName _CuttingToolArchetypeTypeCuttingToolDefinition_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingToolDefinition");
    private static final QName _CuttingToolArchetypeTypeCuttingToolLifeCycle_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingToolLifeCycle");
    private static final QName _CuttingToolTypeCuttingToolArchetypeReference_QNAME = new QName("urn:mtconnect.org:MTConnectAssets:1.3", "CuttingToolArchetypeReference");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hivemq.edge.adapters.mtconnect.schemas.assets.assets_1_3
     * 
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link CuttingToolArchetypeReferenceType }{@code >}
     */
    ...
    public JAXBElement<CuttingToolArchetypeReferenceType> createCuttingToolTypeCuttingToolArchetypeReference(CuttingToolArchetypeReferenceType value) {
        return new JAXBElement<>(_CuttingToolTypeCuttingToolArchetypeReference_QNAME, CuttingToolArchetypeReferenceType.class, CuttingToolType.class, value);
    }
