 ...
 * 
 * <p>Java class for WorkholdingIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WorkholdingIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}WorkholdingIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WorkholdingIdDataSetType")
@XmlType(name = "WorkholdingIdDataSetType", propOrder = {
    "entry"
})
public class WorkholdingIdDataSetType
    extends EventType
{
    ...
    protected List<WorkholdingIdEntryType> entry;
    /**
     ...
     */
    public List<WorkholdingIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
