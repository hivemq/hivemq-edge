 ...
 * 
 * <p>Java class for ThicknessTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ThicknessTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ThicknessTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ThicknessTableType")
@XmlType(name = "ThicknessTableType", propOrder = {
    "entry"
})
public class ThicknessTableType
    extends EventType
{
    ...
    protected List<ThicknessTableEntryType> entry;
    /**
     ...
     */
    public List<ThicknessTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
