 ...
 * 
 * <p>Java class for ClockTimeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ClockTimeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ClockTimeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ClockTimeTableType")
@XmlType(name = "ClockTimeTableType", propOrder = {
    "entry"
})
public class ClockTimeTableType
    extends EventType
{
    ...
    protected List<ClockTimeTableEntryType> entry;
    /**
     ...
     */
    public List<ClockTimeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
