...
/**
 * Table of {{def(EventEnum:WAIT_STATE)}} When {{block(Execution)}}
 *         {{property(result)}} is not `WAIT`, the
 *         {{property(Observation::isUnavailable)}} property of
 *         {{block(WaitState)}} **MUST** be `true`.
 * 
 * <p>Java class for WaitStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WaitStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}WaitStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WaitStateTableType")
@XmlType(name = "WaitStateTableType", propOrder = {
    "entry"
})
public class WaitStateTableType
    extends EventType
{
    ...
    protected List<WaitStateTableEntryType> entry;
    /**
     ...
     */
    public List<WaitStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
