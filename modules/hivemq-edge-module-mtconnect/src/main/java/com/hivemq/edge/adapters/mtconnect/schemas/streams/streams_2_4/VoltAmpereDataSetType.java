 ...
 * 
 * <p>Java class for VoltAmpereDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VoltAmpereDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}VoltAmpereEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VoltAmpereDataSetType")
@XmlType(name = "VoltAmpereDataSetType", propOrder = {
    "entry"
})
public class VoltAmpereDataSetType
    extends EventType
{
    ...
    protected List<VoltAmpereEntryType> entry;
    /**
     ...
     */
    public List<VoltAmpereEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
