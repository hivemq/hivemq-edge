 ...
 * 
 * <p>Java class for OperatorIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OperatorIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}OperatorIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OperatorIdDataSetType")
@XmlType(name = "OperatorIdDataSetType", propOrder = {
    "entry"
})
public class OperatorIdDataSetType
    extends EventType
{
    ...
    protected List<OperatorIdEntryType> entry;
    /**
     ...
     */
    public List<OperatorIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
