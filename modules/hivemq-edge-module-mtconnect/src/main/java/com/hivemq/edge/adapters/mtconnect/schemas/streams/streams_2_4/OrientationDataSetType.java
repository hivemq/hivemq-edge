 ...
 * 
 * <p>Java class for OrientationDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OrientationDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}OrientationEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OrientationDataSetType")
@XmlType(name = "OrientationDataSetType", propOrder = {
    "entry"
})
public class OrientationDataSetType
    extends EventType
{
    ...
    protected List<OrientationEntryType> entry;
    /**
     ...
     */
    public List<OrientationEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
