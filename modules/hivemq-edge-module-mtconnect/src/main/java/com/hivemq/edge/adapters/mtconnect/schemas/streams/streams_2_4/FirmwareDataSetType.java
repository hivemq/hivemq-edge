 ...
 * 
 * <p>Java class for FirmwareDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FirmwareDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}FirmwareEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FirmwareDataSetType")
@XmlType(name = "FirmwareDataSetType", propOrder = {
    "entry"
})
public class FirmwareDataSetType
    extends EventType
{
    ...
    protected List<FirmwareEntryType> entry;
    /**
     ...
     */
    public List<FirmwareEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
