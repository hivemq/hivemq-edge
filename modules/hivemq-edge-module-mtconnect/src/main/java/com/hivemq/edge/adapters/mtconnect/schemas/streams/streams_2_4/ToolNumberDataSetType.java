 ...
 * 
 * <p>Java class for ToolNumberDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolNumberDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ToolNumberEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolNumberDataSetType")
@XmlType(name = "ToolNumberDataSetType", propOrder = {
    "entry"
})
public class ToolNumberDataSetType
    extends EventType
{
    ...
    protected List<ToolNumberEntryType> entry;
    /**
     ...
     */
    public List<ToolNumberEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
