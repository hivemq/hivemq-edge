 ...
 * 
 * <p>Java class for BatteryStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BatteryStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}BatteryStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BatteryStateDataSetType")
@XmlType(name = "BatteryStateDataSetType", propOrder = {
    "entry"
})
public class BatteryStateDataSetType
    extends EventType
{
    ...
    protected List<BatteryStateEntryType> entry;
    /**
     ...
     */
    public List<BatteryStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
