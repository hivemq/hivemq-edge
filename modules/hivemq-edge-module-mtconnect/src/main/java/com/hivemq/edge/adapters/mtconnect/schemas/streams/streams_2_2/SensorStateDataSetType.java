 ...
 * 
 * <p>Java class for SensorStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SensorStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}SensorStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SensorStateDataSetType")
@XmlType(name = "SensorStateDataSetType", propOrder = {
    "entry"
})
public class SensorStateDataSetType
    extends EventType
{
    ...
    protected List<SensorStateEntryType> entry;
    /**
     ...
     */
    public List<SensorStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
