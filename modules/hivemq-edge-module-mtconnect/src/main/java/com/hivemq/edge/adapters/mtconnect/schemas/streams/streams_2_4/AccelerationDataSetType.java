 ...
 * 
 * <p>Java class for AccelerationDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AccelerationDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AccelerationEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AccelerationDataSetType")
@XmlType(name = "AccelerationDataSetType", propOrder = {
    "entry"
})
public class AccelerationDataSetType
    extends EventType
{
    ...
    protected List<AccelerationEntryType> entry;
    /**
     ...
     */
    public List<AccelerationEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
