 ...
 * 
 * <p>Java class for ControlLimitsTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ControlLimitsTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ControlLimitsTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ControlLimitsTableType")
@XmlType(name = "ControlLimitsTableType", propOrder = {
    "entry"
})
public class ControlLimitsTableType
    extends EventType
{
    ...
    protected List<ControlLimitsTableEntryType> entry;
    /**
     ...
     * {@link ControlLimitsTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ControlLimitsTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
