 ...
 * 
 * <p>Java class for MaterialRetractTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialRetractTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}MaterialRetractTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialRetractTableType")
@XmlType(name = "MaterialRetractTableType", propOrder = {
    "entry"
})
public class MaterialRetractTableType
    extends EventType
{
    ...
    protected List<MaterialRetractTableEntryType> entry;
    /**
     ...
     * {@link MaterialRetractTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MaterialRetractTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
