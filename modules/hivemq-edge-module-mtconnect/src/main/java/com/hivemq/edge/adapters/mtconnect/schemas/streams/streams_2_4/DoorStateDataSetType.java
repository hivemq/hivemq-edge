 ...
 * 
 * <p>Java class for DoorStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DoorStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}DoorStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DoorStateDataSetType")
@XmlType(name = "DoorStateDataSetType", propOrder = {
    "entry"
})
public class DoorStateDataSetType
    extends EventType
{
    ...
    protected List<DoorStateEntryType> entry;
    /**
     ...
     */
    public List<DoorStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
