 ...
 * 
 * <p>Java class for AvailabilityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AvailabilityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AvailabilityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AvailabilityDataSetType")
@XmlType(name = "AvailabilityDataSetType", propOrder = {
    "entry"
})
public class AvailabilityDataSetType
    extends EventType
{
    ...
    protected List<AvailabilityEntryType> entry;
    /**
     ...
     */
    public List<AvailabilityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
