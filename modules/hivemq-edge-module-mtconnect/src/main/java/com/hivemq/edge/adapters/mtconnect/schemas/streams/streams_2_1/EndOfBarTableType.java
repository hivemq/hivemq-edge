 ...
 * 
 * <p>Java class for EndOfBarTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EndOfBarTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}EndOfBarTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EndOfBarTableType")
@XmlType(name = "EndOfBarTableType", propOrder = {
    "entry"
})
public class EndOfBarTableType
    extends EventType
{
    ...
    protected List<EndOfBarTableEntryType> entry;
    /**
     ...
     */
    public List<EndOfBarTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
