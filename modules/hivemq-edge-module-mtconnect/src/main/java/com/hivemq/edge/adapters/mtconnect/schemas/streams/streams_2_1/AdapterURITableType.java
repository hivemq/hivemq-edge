 ...
 * 
 * <p>Java class for AdapterURITableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AdapterURITableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AdapterURITableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AdapterURITableType")
@XmlType(name = "AdapterURITableType", propOrder = {
    "entry"
})
public class AdapterURITableType
    extends EventType
{
    ...
    protected List<AdapterURITableEntryType> entry;
    /**
     ...
     */
    public List<AdapterURITableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
