 ...
 * 
 * <p>Java class for AmperageDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AmperageDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AmperageEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AmperageDataSetType")
@XmlType(name = "AmperageDataSetType", propOrder = {
    "entry"
})
public class AmperageDataSetType
    extends EventType
{
    ...
    protected List<AmperageEntryType> entry;
    /**
     ...
     */
    public List<AmperageEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
