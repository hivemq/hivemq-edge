 ...
 * 
 * <p>Java class for LeakDetectTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LeakDetectTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}LeakDetectTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LeakDetectTableType")
@XmlType(name = "LeakDetectTableType", propOrder = {
    "entry"
})
public class LeakDetectTableType
    extends EventType
{
    ...
    protected List<LeakDetectTableEntryType> entry;
    /**
     ...
     */
    public List<LeakDetectTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
