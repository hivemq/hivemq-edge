 ...
 * 
 * <p>Java class for DoorStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DoorStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}DoorStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DoorStateTableType")
@XmlType(name = "DoorStateTableType", propOrder = {
    "entry"
})
public class DoorStateTableType
    extends EventType
{
    ...
    protected List<DoorStateTableEntryType> entry;
    /**
     ...
     */
    public List<DoorStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
