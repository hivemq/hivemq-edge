 ...
 * 
 * <p>Java class for RotaryModeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RotaryModeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}RotaryModeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "RotaryModeTableType")
@XmlType(name = "RotaryModeTableType", propOrder = {
    "entry"
})
public class RotaryModeTableType
    extends EventType
{
    ...
    protected List<RotaryModeTableEntryType> entry;
    /**
     ...
     */
    public List<RotaryModeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
