 ...
 * 
 * <p>Java class for VoltageACDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VoltageACDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}VoltageACEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VoltageACDataSetType")
@XmlType(name = "VoltageACDataSetType", propOrder = {
    "entry"
})
public class VoltageACDataSetType
    extends EventType
{
    ...
    protected List<VoltageACEntryType> entry;
    /**
     ...
     */
    public List<VoltageACEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
