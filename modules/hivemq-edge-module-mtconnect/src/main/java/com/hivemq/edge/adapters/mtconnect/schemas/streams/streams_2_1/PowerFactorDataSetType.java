 ...
 * 
 * <p>Java class for PowerFactorDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PowerFactorDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}PowerFactorEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PowerFactorDataSetType")
@XmlType(name = "PowerFactorDataSetType", propOrder = {
    "entry"
})
public class PowerFactorDataSetType
    extends EventType
{
    ...
    protected List<PowerFactorEntryType> entry;
    /**
     ...
     */
    public List<PowerFactorEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
