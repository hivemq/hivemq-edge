 ...
 * 
 * <p>Java class for LineNumberTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LineNumberTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}LineNumberTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LineNumberTableType")
@XmlType(name = "LineNumberTableType", propOrder = {
    "entry"
})
public class LineNumberTableType
    extends EventType
{
    ...
    protected List<LineNumberTableEntryType> entry;
    /**
     ...
     */
    public List<LineNumberTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
