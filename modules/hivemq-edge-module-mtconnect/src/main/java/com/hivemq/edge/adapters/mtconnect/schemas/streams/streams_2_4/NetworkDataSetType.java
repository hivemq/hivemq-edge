 ...
 * 
 * <p>Java class for NetworkDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="NetworkDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}NetworkEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "NetworkDataSetType")
@XmlType(name = "NetworkDataSetType", propOrder = {
    "entry"
})
public class NetworkDataSetType
    extends EventType
{
    ...
    protected List<NetworkEntryType> entry;
    /**
     ...
     */
    public List<NetworkEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
