 ...
 * 
 * <p>Java class for MessageDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MessageDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}MessageEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MessageDataSetType")
@XmlType(name = "MessageDataSetType", propOrder = {
    "entry"
})
public class MessageDataSetType
    extends EventType
{
    ...
    protected List<MessageEntryType> entry;
    /**
     ...
     */
    public List<MessageEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
