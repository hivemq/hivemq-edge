 ...
 * 
 * <p>Java class for OpennessDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OpennessDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}OpennessEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OpennessDataSetType")
@XmlType(name = "OpennessDataSetType", propOrder = {
    "entry"
})
public class OpennessDataSetType
    extends EventType
{
    ...
    protected List<OpennessEntryType> entry;
    /**
     ...
     */
    public List<OpennessEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
