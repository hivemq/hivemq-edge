 ...
 * 
 * <p>Java class for PowerStatusDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PowerStatusDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}PowerStatusEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PowerStatusDataSetType")
@XmlType(name = "PowerStatusDataSetType", propOrder = {
    "entry"
})
public class PowerStatusDataSetType
    extends EventType
{
    ...
    protected List<PowerStatusEntryType> entry;
    /**
     ...
     */
    public List<PowerStatusEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
