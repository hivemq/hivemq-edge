 ...
 * 
 * <p>Java class for MeasurementTypeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MeasurementTypeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}MeasurementTypeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MeasurementTypeTableType")
@XmlType(name = "MeasurementTypeTableType", propOrder = {
    "entry"
})
public class MeasurementTypeTableType
    extends EventType
{
    ...
    protected List<MeasurementTypeTableEntryType> entry;
    /**
     ...
     * {@link MeasurementTypeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MeasurementTypeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
