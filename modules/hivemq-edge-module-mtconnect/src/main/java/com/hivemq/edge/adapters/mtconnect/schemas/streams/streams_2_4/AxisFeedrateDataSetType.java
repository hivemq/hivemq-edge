 ...
 * 
 * <p>Java class for AxisFeedrateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AxisFeedrateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AxisFeedrateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AxisFeedrateDataSetType")
@XmlType(name = "AxisFeedrateDataSetType", propOrder = {
    "entry"
})
public class AxisFeedrateDataSetType
    extends EventType
{
    ...
    protected List<AxisFeedrateEntryType> entry;
    /**
     ...
     */
    public List<AxisFeedrateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
