 ...
 * 
 * <p>Java class for CuttingSpeedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CuttingSpeedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}CuttingSpeedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CuttingSpeedTableType")
@XmlType(name = "CuttingSpeedTableType", propOrder = {
    "entry"
})
public class CuttingSpeedTableType
    extends EventType
{
    ...
    protected List<CuttingSpeedTableEntryType> entry;
    /**
     ...
     * {@link CuttingSpeedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<CuttingSpeedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
