 ...
 * 
 * <p>Java class for VolumeFluidTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VolumeFluidTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}VolumeFluidTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VolumeFluidTableType")
@XmlType(name = "VolumeFluidTableType", propOrder = {
    "entry"
})
public class VolumeFluidTableType
    extends EventType
{
    ...
    protected List<VolumeFluidTableEntryType> entry;
    /**
     ...
     * {@link VolumeFluidTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<VolumeFluidTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
