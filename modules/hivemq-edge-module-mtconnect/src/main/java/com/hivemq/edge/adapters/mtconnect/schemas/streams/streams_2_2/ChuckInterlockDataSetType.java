 ...
 * 
 * <p>Java class for ChuckInterlockDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ChuckInterlockDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ChuckInterlockEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ChuckInterlockDataSetType")
@XmlType(name = "ChuckInterlockDataSetType", propOrder = {
    "entry"
})
public class ChuckInterlockDataSetType
    extends EventType
{
    ...
    protected List<ChuckInterlockEntryType> entry;
    /**
     ...
     */
    public List<ChuckInterlockEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
