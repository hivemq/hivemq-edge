 ...
 * 
 * <p>Java class for ProcessStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProcessStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ProcessStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProcessStateTableType")
@XmlType(name = "ProcessStateTableType", propOrder = {
    "entry"
})
public class ProcessStateTableType
    extends EventType
{
    ...
    protected List<ProcessStateTableEntryType> entry;
    /**
     ...
     * {@link ProcessStateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProcessStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
