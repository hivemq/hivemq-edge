 ...
 * 
 * <p>Java class for LengthDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LengthDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}LengthEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LengthDataSetType")
@XmlType(name = "LengthDataSetType", propOrder = {
    "entry"
})
public class LengthDataSetType
    extends EventType
{
    ...
    protected List<LengthEntryType> entry;
    /**
     ...
     */
    public List<LengthEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
