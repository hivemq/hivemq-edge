...
public enum DataItemEnumEnum {
    ...
    /**
     * measured or calculated position of a control point associated with a
     *             {{block(Controller)}} entity, or {{block(Path)}} entity if provided,
    ...
    /**
     * measured or calculated position of a {{block(Component)}} element as
    ...
    /**
     * measured or calculated orientation of a plane or vector relative to
     ...
     *             tool associated with a {{block(Path)}} in a {{block(Controller)}}
     *             type component.
     * 
     */
    TOOL_OFFSET,
    ...
    /**
     * offset variables for a work piece or part associated with a
