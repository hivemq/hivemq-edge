 ...
 * 
 * <p>Java class for SerialNumberTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SerialNumberTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}SerialNumberTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SerialNumberTableType")
@XmlType(name = "SerialNumberTableType", propOrder = {
    "entry"
})
public class SerialNumberTableType
    extends EventType
{
    ...
    protected List<SerialNumberTableEntryType> entry;
    /**
     ...
     * {@link SerialNumberTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<SerialNumberTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
