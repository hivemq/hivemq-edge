 ...
 * 
 * <p>Java class for LineNumberDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LineNumberDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}LineNumberEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LineNumberDataSetType")
@XmlType(name = "LineNumberDataSetType", propOrder = {
    "entry"
})
public class LineNumberDataSetType
    extends EventType
{
    ...
    protected List<LineNumberEntryType> entry;
    /**
     ...
     */
    public List<LineNumberEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
