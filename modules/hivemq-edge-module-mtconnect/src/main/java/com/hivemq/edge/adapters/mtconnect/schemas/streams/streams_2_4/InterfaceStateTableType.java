 ...
 * 
 * <p>Java class for InterfaceStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="InterfaceStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}InterfaceStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "InterfaceStateTableType")
@XmlType(name = "InterfaceStateTableType", propOrder = {
    "entry"
})
public class InterfaceStateTableType
    extends EventType
{
    ...
    protected List<InterfaceStateTableEntryType> entry;
    /**
     ...
     * {@link InterfaceStateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<InterfaceStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
