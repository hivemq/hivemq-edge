 ...
 * 
 * <p>Java class for HardnessDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HardnessDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}HardnessEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "HardnessDataSetType")
@XmlType(name = "HardnessDataSetType", propOrder = {
    "entry"
})
public class HardnessDataSetType
    extends EventType
{
    ...
    protected List<HardnessEntryType> entry;
    /**
     ...
     */
    public List<HardnessEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
