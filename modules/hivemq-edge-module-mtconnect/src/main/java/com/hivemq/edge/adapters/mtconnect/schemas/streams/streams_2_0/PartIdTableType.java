 ...
 * 
 * <p>Java class for PartIdTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartIdTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}PartIdTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartIdTableType")
@XmlType(name = "PartIdTableType", propOrder = {
    "entry"
})
public class PartIdTableType
    extends EventType
{
    ...
    protected List<PartIdTableEntryType> entry;
    /**
     ...
     */
    public List<PartIdTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
