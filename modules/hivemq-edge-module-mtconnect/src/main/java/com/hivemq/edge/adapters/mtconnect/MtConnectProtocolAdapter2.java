...
/**
 * {@link com.hivemq.adapter.sdk.api.ProtocolAdapter2 ProtocolAdapter2} implementation for the MTConnect adapter.
 * Northbound only (read from device, publish to MQTT).
 */
public class MtConnectProtocolAdapter2 extends ProtocolAdapter2Bridge {

    public MtConnectProtocolAdapter2(
