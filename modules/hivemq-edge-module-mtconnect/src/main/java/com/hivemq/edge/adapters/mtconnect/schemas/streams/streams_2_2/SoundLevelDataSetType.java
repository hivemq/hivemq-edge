 ...
 * 
 * <p>Java class for SoundLevelDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SoundLevelDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}SoundLevelEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SoundLevelDataSetType")
@XmlType(name = "SoundLevelDataSetType", propOrder = {
    "entry"
})
public class SoundLevelDataSetType
    extends EventType
{
    ...
    protected List<SoundLevelEntryType> entry;
    /**
     ...
     */
    public List<SoundLevelEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
