 ...
 * 
 * <p>Java class for WattageDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WattageDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}WattageEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WattageDataSetType")
@XmlType(name = "WattageDataSetType", propOrder = {
    "entry"
})
public class WattageDataSetType
    extends EventType
{
    ...
    protected List<WattageEntryType> entry;
    /**
     ...
     */
    public List<WattageEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
