 ...
 * 
 * <p>Java class for AxisInterlockTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AxisInterlockTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}AxisInterlockTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AxisInterlockTableType")
@XmlType(name = "AxisInterlockTableType", propOrder = {
    "entry"
})
public class AxisInterlockTableType
    extends EventType
{
    ...
    protected List<AxisInterlockTableEntryType> entry;
    /**
     ...
     * {@link AxisInterlockTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AxisInterlockTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
