 ...
 * 
 * <p>Java class for DeviceAddedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceAddedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}DeviceAddedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceAddedDataSetType")
@XmlType(name = "DeviceAddedDataSetType", propOrder = {
    "entry"
})
public class DeviceAddedDataSetType
    extends EventType
{
    ...
    protected List<DeviceAddedEntryType> entry;
    /**
     ...
     */
    public List<DeviceAddedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
