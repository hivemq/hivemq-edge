 ...
 * 
 * <p>Java class for EquipmentModeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EquipmentModeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}EquipmentModeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EquipmentModeDataSetType")
@XmlType(name = "EquipmentModeDataSetType", propOrder = {
    "entry"
})
public class EquipmentModeDataSetType
    extends EventType
{
    ...
    protected List<EquipmentModeEntryType> entry;
    /**
     ...
     */
    public List<EquipmentModeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
