 ...
 * 
 * <p>Java class for DateCodeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DateCodeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}DateCodeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DateCodeDataSetType")
@XmlType(name = "DateCodeDataSetType", propOrder = {
    "entry"
})
public class DateCodeDataSetType
    extends EventType
{
    ...
    protected List<DateCodeEntryType> entry;
    /**
     ...
     */
    public List<DateCodeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
