 ...
 * 
 * <p>Java class for ToolOffsetsTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolOffsetsTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ToolOffsetsTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolOffsetsTableType")
@XmlType(name = "ToolOffsetsTableType", propOrder = {
    "entry"
})
public class ToolOffsetsTableType
    extends EventType
{
    ...
    protected List<ToolOffsetsTableEntryType> entry;
    /**
     ...
     * {@link ToolOffsetsTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ToolOffsetsTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
