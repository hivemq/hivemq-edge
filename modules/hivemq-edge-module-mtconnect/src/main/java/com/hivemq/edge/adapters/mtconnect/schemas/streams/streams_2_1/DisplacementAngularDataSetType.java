 ...
 *         {{block(component)}}.
 * 
 * <p>Java class for DisplacementAngularDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DisplacementAngularDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}DisplacementAngularEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DisplacementAngularDataSetType")
@XmlType(name = "DisplacementAngularDataSetType", propOrder = {
    "entry"
})
public class DisplacementAngularDataSetType
    extends EventType
{
    ...
    protected List<DisplacementAngularEntryType> entry;
    /**
     ...
     * {@link DisplacementAngularEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DisplacementAngularEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
