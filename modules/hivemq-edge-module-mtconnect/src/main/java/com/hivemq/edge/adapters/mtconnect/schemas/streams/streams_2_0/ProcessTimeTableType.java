 ...
 * 
 * <p>Java class for ProcessTimeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProcessTimeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ProcessTimeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProcessTimeTableType")
@XmlType(name = "ProcessTimeTableType", propOrder = {
    "entry"
})
public class ProcessTimeTableType
    extends EventType
{
    ...
    protected List<ProcessTimeTableEntryType> entry;
    /**
     ...
     * {@link ProcessTimeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProcessTimeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
