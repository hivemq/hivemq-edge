 ...
 * 
 * <p>Java class for ToolAssetIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolAssetIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}ToolAssetIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolAssetIdDataSetType")
@XmlType(name = "ToolAssetIdDataSetType", propOrder = {
    "entry"
})
public class ToolAssetIdDataSetType
    extends EventType
{
    ...
    protected List<ToolAssetIdEntryType> entry;
    /**
     ...
     */
    public List<ToolAssetIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
