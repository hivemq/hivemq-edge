 ...
 * 
 * <p>Java class for VariableTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VariableTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}VariableTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VariableTableType")
@XmlType(name = "VariableTableType", propOrder = {
    "entry"
})
public class VariableTableType
    extends EventType
{
    ...
    protected List<VariableTableEntryType> entry;
    /**
     ...
     */
    public List<VariableTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
