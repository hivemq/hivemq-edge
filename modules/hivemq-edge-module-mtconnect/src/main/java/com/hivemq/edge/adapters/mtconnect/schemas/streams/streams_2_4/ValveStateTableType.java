 ...
 * 
 * <p>Java class for ValveStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ValveStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ValveStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ValveStateTableType")
@XmlType(name = "ValveStateTableType", propOrder = {
    "entry"
})
public class ValveStateTableType
    extends EventType
{
    ...
    protected List<ValveStateTableEntryType> entry;
    /**
     ...
     */
    public List<ValveStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
