 ...
 * 
 * <p>Java class for MaterialLoadDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialLoadDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}MaterialLoadEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialLoadDataSetType")
@XmlType(name = "MaterialLoadDataSetType", propOrder = {
    "entry"
})
public class MaterialLoadDataSetType
    extends EventType
{
    ...
    protected List<MaterialLoadEntryType> entry;
    /**
     ...
     */
    public List<MaterialLoadEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
