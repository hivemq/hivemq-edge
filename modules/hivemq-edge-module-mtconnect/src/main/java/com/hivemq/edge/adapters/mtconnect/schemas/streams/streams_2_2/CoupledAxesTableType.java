 ...
 * 
 * <p>Java class for CoupledAxesTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CoupledAxesTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}CoupledAxesTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CoupledAxesTableType")
@XmlType(name = "CoupledAxesTableType", propOrder = {
    "entry"
})
public class CoupledAxesTableType
    extends EventType
{
    ...
    protected List<CoupledAxesTableEntryType> entry;
    /**
     ...
     * {@link CoupledAxesTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<CoupledAxesTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
