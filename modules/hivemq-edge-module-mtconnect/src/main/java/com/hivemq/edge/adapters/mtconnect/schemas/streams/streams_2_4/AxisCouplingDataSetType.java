 ...
 * 
 * <p>Java class for AxisCouplingDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AxisCouplingDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AxisCouplingEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AxisCouplingDataSetType")
@XmlType(name = "AxisCouplingDataSetType", propOrder = {
    "entry"
})
public class AxisCouplingDataSetType
    extends EventType
{
    ...
    protected List<AxisCouplingEntryType> entry;
    /**
     ...
     */
    public List<AxisCouplingEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
