 ...
 * 
 * <p>Java class for FixtureIdTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FixtureIdTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}FixtureIdTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FixtureIdTableType")
@XmlType(name = "FixtureIdTableType", propOrder = {
    "entry"
})
public class FixtureIdTableType
    extends EventType
{
    ...
    protected List<FixtureIdTableEntryType> entry;
    /**
     ...
     */
    public List<FixtureIdTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
