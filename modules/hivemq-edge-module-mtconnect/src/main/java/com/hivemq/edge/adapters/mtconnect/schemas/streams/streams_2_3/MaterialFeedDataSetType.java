 ...
 * 
 * <p>Java class for MaterialFeedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialFeedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}MaterialFeedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialFeedDataSetType")
@XmlType(name = "MaterialFeedDataSetType", propOrder = {
    "entry"
})
public class MaterialFeedDataSetType
    extends EventType
{
    ...
    protected List<MaterialFeedEntryType> entry;
    /**
     ...
     */
    public List<MaterialFeedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
