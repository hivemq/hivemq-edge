 ...
 * 
 * <p>Java class for LeakDetectDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LeakDetectDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}LeakDetectEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LeakDetectDataSetType")
@XmlType(name = "LeakDetectDataSetType", propOrder = {
    "entry"
})
public class LeakDetectDataSetType
    extends EventType
{
    ...
    protected List<LeakDetectEntryType> entry;
    /**
     ...
     */
    public List<LeakDetectEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
