 ...
 * 
 * <p>Java class for PowerStatusTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PowerStatusTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}PowerStatusTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PowerStatusTableType")
@XmlType(name = "PowerStatusTableType", propOrder = {
    "entry"
})
public class PowerStatusTableType
    extends EventType
{
    ...
    protected List<PowerStatusTableEntryType> entry;
    /**
     ...
     * {@link PowerStatusTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<PowerStatusTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
