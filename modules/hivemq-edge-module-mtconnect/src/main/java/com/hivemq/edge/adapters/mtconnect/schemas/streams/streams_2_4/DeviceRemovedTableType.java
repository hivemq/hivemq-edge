 ...
 * 
 * <p>Java class for DeviceRemovedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceRemovedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}DeviceRemovedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceRemovedTableType")
@XmlType(name = "DeviceRemovedTableType", propOrder = {
    "entry"
})
public class DeviceRemovedTableType
    extends EventType
{
    ...
    protected List<DeviceRemovedTableEntryType> entry;
    /**
     ...
     * {@link DeviceRemovedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DeviceRemovedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
