 ...
 * 
 * <p>Java class for PathFeedrateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PathFeedrateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}PathFeedrateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PathFeedrateTableType")
@XmlType(name = "PathFeedrateTableType", propOrder = {
    "entry"
})
public class PathFeedrateTableType
    extends EventType
{
    ...
    protected List<PathFeedrateTableEntryType> entry;
    /**
     ...
     * {@link PathFeedrateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<PathFeedrateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
