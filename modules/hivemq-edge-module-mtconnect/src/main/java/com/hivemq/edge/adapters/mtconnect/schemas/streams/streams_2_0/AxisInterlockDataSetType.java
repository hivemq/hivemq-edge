 ...
 * 
 * <p>Java class for AxisInterlockDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AxisInterlockDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}AxisInterlockEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AxisInterlockDataSetType")
@XmlType(name = "AxisInterlockDataSetType", propOrder = {
    "entry"
})
public class AxisInterlockDataSetType
    extends EventType
{
    ...
    protected List<AxisInterlockEntryType> entry;
    /**
     ...
     */
    public List<AxisInterlockEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
