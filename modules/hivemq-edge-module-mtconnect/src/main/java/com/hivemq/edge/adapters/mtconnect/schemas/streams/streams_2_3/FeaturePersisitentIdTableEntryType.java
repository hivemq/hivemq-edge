 ...
 *       <sequence>
 *         <element name="Cell" type="{urn:mtconnect.org:MTConnectStreams:2.3}FeaturePersisitentIdCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FeaturePersisitentIdTableEntryType", propOrder = {
    "cell"
})
    ...
    extends EntryType
{
    ...
    protected List<FeaturePersisitentIdCellType> cell;
     ...
     * {@link FeaturePersisitentIdCellType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<FeaturePersisitentIdCellType> getCell() {
        if (cell == null) {
            cell = new ArrayList<>();
        }
        return this.cell;
