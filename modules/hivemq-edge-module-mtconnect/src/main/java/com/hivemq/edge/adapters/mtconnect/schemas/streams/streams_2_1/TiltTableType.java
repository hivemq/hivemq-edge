 ...
 * 
 * <p>Java class for TiltTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TiltTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}TiltTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TiltTableType")
@XmlType(name = "TiltTableType", propOrder = {
    "entry"
})
public class TiltTableType
    extends EventType
{
    ...
    protected List<TiltTableEntryType> entry;
    /**
     ...
     */
    public List<TiltTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
