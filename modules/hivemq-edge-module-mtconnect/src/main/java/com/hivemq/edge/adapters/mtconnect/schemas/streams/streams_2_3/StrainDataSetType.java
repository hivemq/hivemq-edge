 ...
 * 
 * <p>Java class for StrainDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="StrainDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}StrainEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "StrainDataSetType")
@XmlType(name = "StrainDataSetType", propOrder = {
    "entry"
})
public class StrainDataSetType
    extends EventType
{
    ...
    protected List<StrainEntryType> entry;
    /**
     ...
     */
    public List<StrainEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
