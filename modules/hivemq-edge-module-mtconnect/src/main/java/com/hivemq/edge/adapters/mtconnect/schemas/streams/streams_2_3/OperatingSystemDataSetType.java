 ...
 * 
 * <p>Java class for OperatingSystemDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OperatingSystemDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}OperatingSystemEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OperatingSystemDataSetType")
@XmlType(name = "OperatingSystemDataSetType", propOrder = {
    "entry"
})
public class OperatingSystemDataSetType
    extends EventType
{
    ...
    protected List<OperatingSystemEntryType> entry;
    /**
     ...
     */
    public List<OperatingSystemEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
