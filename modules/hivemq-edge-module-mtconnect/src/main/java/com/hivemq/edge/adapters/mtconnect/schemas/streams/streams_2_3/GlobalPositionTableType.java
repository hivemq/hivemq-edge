 ...
 * 
 * <p>Java class for GlobalPositionTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GlobalPositionTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}GlobalPositionTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "GlobalPositionTableType")
@XmlType(name = "GlobalPositionTableType", propOrder = {
    "entry"
})
public class GlobalPositionTableType
    extends EventType
{
    ...
    protected List<GlobalPositionTableEntryType> entry;
    /**
     ...
     * {@link GlobalPositionTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<GlobalPositionTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
