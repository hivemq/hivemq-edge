 ...
 * 
 * <p>Java class for AssetChangedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AssetChangedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AssetChangedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AssetChangedDataSetType")
@XmlType(name = "AssetChangedDataSetType", propOrder = {
    "entry"
})
public class AssetChangedDataSetType
    extends EventType
{
    ...
    protected List<AssetChangedEntryType> entry;
    /**
     ...
     */
    public List<AssetChangedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
