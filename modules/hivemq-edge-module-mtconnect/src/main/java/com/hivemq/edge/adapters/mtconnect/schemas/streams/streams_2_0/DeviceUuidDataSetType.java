 ...
 * 
 * <p>Java class for DeviceUuidDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceUuidDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}DeviceUuidEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceUuidDataSetType")
@XmlType(name = "DeviceUuidDataSetType", propOrder = {
    "entry"
})
public class DeviceUuidDataSetType
    extends EventType
{
    ...
    protected List<DeviceUuidEntryType> entry;
    /**
     ...
     */
    public List<DeviceUuidEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
