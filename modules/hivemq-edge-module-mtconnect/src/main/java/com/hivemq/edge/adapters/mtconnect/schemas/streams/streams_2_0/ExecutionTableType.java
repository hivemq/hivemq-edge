 ...
 * 
 * <p>Java class for ExecutionTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ExecutionTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ExecutionTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ExecutionTableType")
@XmlType(name = "ExecutionTableType", propOrder = {
    "entry"
})
public class ExecutionTableType
    extends EventType
{
    ...
    protected List<ExecutionTableEntryType> entry;
    /**
     ...
     */
    public List<ExecutionTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
