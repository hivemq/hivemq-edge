 ...
 * 
 * <p>Java class for DensityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DensityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}DensityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DensityDataSetType")
@XmlType(name = "DensityDataSetType", propOrder = {
    "entry"
})
public class DensityDataSetType
    extends EventType
{
    ...
    protected List<DensityEntryType> entry;
    /**
     ...
     */
    public List<DensityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
