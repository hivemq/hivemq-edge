 ...
 * 
 * <p>Java class for MaterialLayerTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialLayerTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}MaterialLayerTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialLayerTableType")
@XmlType(name = "MaterialLayerTableType", propOrder = {
    "entry"
})
public class MaterialLayerTableType
    extends EventType
{
    ...
    protected List<MaterialLayerTableEntryType> entry;
    /**
     ...
     * {@link MaterialLayerTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MaterialLayerTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
