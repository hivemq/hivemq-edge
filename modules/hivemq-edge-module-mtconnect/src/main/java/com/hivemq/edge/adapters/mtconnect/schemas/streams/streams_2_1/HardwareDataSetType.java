 ...
 * 
 * <p>Java class for HardwareDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HardwareDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}HardwareEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "HardwareDataSetType")
@XmlType(name = "HardwareDataSetType", propOrder = {
    "entry"
})
public class HardwareDataSetType
    extends EventType
{
    ...
    protected List<HardwareEntryType> entry;
    /**
     ...
     */
    public List<HardwareEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
