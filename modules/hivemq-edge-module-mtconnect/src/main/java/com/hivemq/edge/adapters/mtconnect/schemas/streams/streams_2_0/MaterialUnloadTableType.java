 ...
 * 
 * <p>Java class for MaterialUnloadTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialUnloadTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}MaterialUnloadTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialUnloadTableType")
@XmlType(name = "MaterialUnloadTableType", propOrder = {
    "entry"
})
public class MaterialUnloadTableType
    extends EventType
{
    ...
    protected List<MaterialUnloadTableEntryType> entry;
    /**
     ...
     * {@link MaterialUnloadTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MaterialUnloadTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
