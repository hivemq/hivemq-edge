 ...
 * 
 * <p>Java class for SoundLevelTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SoundLevelTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}SoundLevelTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SoundLevelTableType")
@XmlType(name = "SoundLevelTableType", propOrder = {
    "entry"
})
public class SoundLevelTableType
    extends EventType
{
    ...
    protected List<SoundLevelTableEntryType> entry;
    /**
     ...
     */
    public List<SoundLevelTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
