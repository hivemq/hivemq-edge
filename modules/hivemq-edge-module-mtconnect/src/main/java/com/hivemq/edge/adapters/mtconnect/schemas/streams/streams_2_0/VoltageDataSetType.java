 ...
 * 
 * <p>Java class for VoltageDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VoltageDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}VoltageEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VoltageDataSetType")
@XmlType(name = "VoltageDataSetType", propOrder = {
    "entry"
})
public class VoltageDataSetType
    extends EventType
{
    ...
    protected List<VoltageEntryType> entry;
    /**
     ...
     */
    public List<VoltageEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
