 ...
 * 
 * <p>Java class for AmperageDCDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AmperageDCDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AmperageDCEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AmperageDCDataSetType")
@XmlType(name = "AmperageDCDataSetType", propOrder = {
    "entry"
})
public class AmperageDCDataSetType
    extends EventType
{
    ...
    protected List<AmperageDCEntryType> entry;
    /**
     ...
     */
    public List<AmperageDCEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
