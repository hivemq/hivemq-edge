 ...
 * 
 * <p>Java class for DeviceAddedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceAddedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}DeviceAddedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceAddedTableType")
@XmlType(name = "DeviceAddedTableType", propOrder = {
    "entry"
})
public class DeviceAddedTableType
    extends EventType
{
    ...
    protected List<DeviceAddedTableEntryType> entry;
    /**
     ...
     * {@link DeviceAddedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DeviceAddedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
