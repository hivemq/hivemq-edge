 ...
 * 
 * <p>Java class for ProgramCommentTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramCommentTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ProgramCommentTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramCommentTableType")
@XmlType(name = "ProgramCommentTableType", propOrder = {
    "entry"
})
public class ProgramCommentTableType
    extends EventType
{
    ...
    protected List<ProgramCommentTableEntryType> entry;
    /**
     ...
     * {@link ProgramCommentTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProgramCommentTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
