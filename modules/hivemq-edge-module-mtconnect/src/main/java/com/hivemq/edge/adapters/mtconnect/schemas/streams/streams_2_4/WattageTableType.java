 ...
 * 
 * <p>Java class for WattageTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WattageTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}WattageTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WattageTableType")
@XmlType(name = "WattageTableType", propOrder = {
    "entry"
})
public class WattageTableType
    extends EventType
{
    ...
    protected List<WattageTableEntryType> entry;
    /**
     ...
     */
    public List<WattageTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
