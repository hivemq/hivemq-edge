 ...
 * 
 * <p>Java class for AlarmLimitsTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AlarmLimitsTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AlarmLimitsTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AlarmLimitsTableType")
@XmlType(name = "AlarmLimitsTableType", propOrder = {
    "entry"
})
public class AlarmLimitsTableType
    extends EventType
{
    ...
    protected List<AlarmLimitsTableEntryType> entry;
    /**
     ...
     * {@link AlarmLimitsTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AlarmLimitsTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
