 ...
 * 
 * <p>Java class for MaterialChangeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialChangeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}MaterialChangeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialChangeTableType")
@XmlType(name = "MaterialChangeTableType", propOrder = {
    "entry"
})
public class MaterialChangeTableType
    extends EventType
{
    ...
    protected List<MaterialChangeTableEntryType> entry;
    /**
     ...
     * {@link MaterialChangeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MaterialChangeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
