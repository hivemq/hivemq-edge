 ...
 * 
 * <p>Java class for ConductivityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ConductivityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ConductivityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ConductivityDataSetType")
@XmlType(name = "ConductivityDataSetType", propOrder = {
    "entry"
})
public class ConductivityDataSetType
    extends EventType
{
    ...
    protected List<ConductivityEntryType> entry;
    /**
     ...
     */
    public List<ConductivityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
