 ...
 * 
 * <p>Java class for TemperatureTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TemperatureTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}TemperatureTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TemperatureTableType")
@XmlType(name = "TemperatureTableType", propOrder = {
    "entry"
})
public class TemperatureTableType
    extends EventType
{
    ...
    protected List<TemperatureTableEntryType> entry;
    /**
     ...
     * {@link TemperatureTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<TemperatureTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
