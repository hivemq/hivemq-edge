 ...
 * 
 * <p>Java class for FillLevelTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FillLevelTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}FillLevelTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FillLevelTableType")
@XmlType(name = "FillLevelTableType", propOrder = {
    "entry"
})
public class FillLevelTableType
    extends EventType
{
    ...
    protected List<FillLevelTableEntryType> entry;
    /**
     ...
     */
    public List<FillLevelTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
