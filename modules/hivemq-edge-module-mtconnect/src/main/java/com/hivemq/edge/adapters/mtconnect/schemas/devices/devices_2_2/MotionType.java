 ...
 *       <sequence>
 *         <element name="Description" type="{urn:mtconnect.org:MTConnectDevices:2.2}MotionDescriptionType" minOccurs="0"/>
 *         <choice minOccurs="0">
 *           <element name="Origin" type="{urn:mtconnect.org:MTConnectDevices:2.2}OriginType"/>
 *           <element name="Transformation" type="{urn:mtconnect.org:MTConnectDevices:2.2}TransformationType"/>
 *         </choice>
 *         <element name="Axis" type="{urn:mtconnect.org:MTConnectDevices:2.2}MotionAxisType"/>
 *       </sequence>
 *       <attribute name="id" use="required" type="{urn:mtconnect.org:MTConnectDevices:2.2}IDType" />
 *       <attribute name="parentIdRef" type="{urn:mtconnect.org:MTConnectDevices:2.2}IdRefType" />
 *       <attribute name="coordinateSystemIdRef" use="required" type="{urn:mtconnect.org:MTConnectDevices:2.2}CoordinateSystemIdRefType" />
 *       <attribute name="type" use="required" type="{urn:mtconnect.org:MTConnectDevices:2.2}MotionTypeEnumType" />
 *       <attribute name="actuation" use="required" type="{urn:mtconnect.org:MTConnectDevices:2.2}ActuationTypeEnumType" />
 *     </extension>
 *   </complexContent>
 * </complexType>
 * }</pre>
...
public class MotionType {
     ...
     */
    @XmlElementRefs({
        @XmlElementRef(name = "Description", namespace = "urn:mtconnect.org:MTConnectDevices:2.2", type = JAXBElement.class),
        @XmlElementRef(name = "Origin", namespace = "urn:mtconnect.org:MTConnectDevices:2.2", type = JAXBElement.class),
        @XmlElementRef(name = "Transformation", namespace = "urn:mtconnect.org:MTConnectDevices:2.2", type = JAXBElement.class),
        @XmlElementRef(name = "Axis", namespace = "urn:mtconnect.org:MTConnectDevices:2.2", type = JAXBElement.class)
    })
    @XmlMixed
