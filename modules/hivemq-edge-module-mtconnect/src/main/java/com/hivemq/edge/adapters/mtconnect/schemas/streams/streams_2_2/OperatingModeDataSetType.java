 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}OperatingModeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@XmlType(name = "OperatingModeDataSetType", propOrder = {
    "entry"
})
    ...
    extends EventType
{
    ...
    protected List<OperatingModeEntryType> entry;
    /**
     ...
     */
    public List<OperatingModeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
