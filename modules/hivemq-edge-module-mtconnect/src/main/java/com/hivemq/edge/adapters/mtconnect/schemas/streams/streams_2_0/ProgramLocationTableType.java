 ...
 * 
 * <p>Java class for ProgramLocationTableType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ProgramLocationTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramLocationTableType")
    ...
    extends EventType
{
    ...
    protected List<ProgramLocationTableEntryType> entry;
    /**
     ...
     * {@link ProgramLocationTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProgramLocationTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
