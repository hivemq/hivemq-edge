 ...
 * 
 * <p>Java class for ProgramDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}ProgramEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramDataSetType")
@XmlType(name = "ProgramDataSetType", propOrder = {
    "entry"
})
public class ProgramDataSetType
    extends EventType
{
    ...
    protected List<ProgramEntryType> entry;
    /**
     ...
     */
    public List<ProgramEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
