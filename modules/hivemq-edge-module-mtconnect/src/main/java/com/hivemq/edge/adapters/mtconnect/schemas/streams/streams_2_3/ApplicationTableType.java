 ...
 * 
 * <p>Java class for ApplicationTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ApplicationTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ApplicationTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ApplicationTableType")
@XmlType(name = "ApplicationTableType", propOrder = {
    "entry"
})
public class ApplicationTableType
    extends EventType
{
    ...
    protected List<ApplicationTableEntryType> entry;
    /**
     ...
     * {@link ApplicationTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ApplicationTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
