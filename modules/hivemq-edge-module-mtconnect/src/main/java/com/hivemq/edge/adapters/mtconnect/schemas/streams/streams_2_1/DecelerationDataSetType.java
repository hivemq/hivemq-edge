 ...
 * 
 * <p>Java class for DecelerationDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DecelerationDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}DecelerationEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DecelerationDataSetType")
@XmlType(name = "DecelerationDataSetType", propOrder = {
    "entry"
})
public class DecelerationDataSetType
    extends EventType
{
    ...
    protected List<DecelerationEntryType> entry;
    /**
     ...
     */
    public List<DecelerationEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
