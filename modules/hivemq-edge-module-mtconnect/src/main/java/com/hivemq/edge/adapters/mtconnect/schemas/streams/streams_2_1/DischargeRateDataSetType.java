 ...
 * 
 * <p>Java class for DischargeRateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DischargeRateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}DischargeRateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DischargeRateDataSetType")
@XmlType(name = "DischargeRateDataSetType", propOrder = {
    "entry"
})
public class DischargeRateDataSetType
    extends EventType
{
    ...
    protected List<DischargeRateEntryType> entry;
    /**
     ...
     */
    public List<DischargeRateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
