 ...
 * 
 * <p>Java class for DisplacementDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DisplacementDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}DisplacementEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DisplacementDataSetType")
@XmlType(name = "DisplacementDataSetType", propOrder = {
    "entry"
})
public class DisplacementDataSetType
    extends EventType
{
    ...
    protected List<DisplacementEntryType> entry;
    /**
     ...
     */
    public List<DisplacementEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
