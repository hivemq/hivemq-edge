 ...
 * 
 * <p>Java class for ToolNumberTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolNumberTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ToolNumberTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolNumberTableType")
@XmlType(name = "ToolNumberTableType", propOrder = {
    "entry"
})
public class ToolNumberTableType
    extends EventType
{
    ...
    protected List<ToolNumberTableEntryType> entry;
    /**
     ...
     */
    public List<ToolNumberTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
