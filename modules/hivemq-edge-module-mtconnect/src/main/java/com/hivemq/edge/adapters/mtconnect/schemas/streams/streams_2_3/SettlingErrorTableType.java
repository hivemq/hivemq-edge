 ...
 * 
 * <p>Java class for SettlingErrorTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SettlingErrorTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}SettlingErrorTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SettlingErrorTableType")
@XmlType(name = "SettlingErrorTableType", propOrder = {
    "entry"
})
public class SettlingErrorTableType
    extends EventType
{
    ...
    protected List<SettlingErrorTableEntryType> entry;
    /**
     ...
     * {@link SettlingErrorTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<SettlingErrorTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
