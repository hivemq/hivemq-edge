 ...
 * 
 * <p>Java class for ProcessKindIdTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProcessKindIdTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ProcessKindIdTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProcessKindIdTableType")
@XmlType(name = "ProcessKindIdTableType", propOrder = {
    "entry"
})
public class ProcessKindIdTableType
    extends EventType
{
    ...
    protected List<ProcessKindIdTableEntryType> entry;
    /**
     ...
     * {@link ProcessKindIdTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProcessKindIdTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
