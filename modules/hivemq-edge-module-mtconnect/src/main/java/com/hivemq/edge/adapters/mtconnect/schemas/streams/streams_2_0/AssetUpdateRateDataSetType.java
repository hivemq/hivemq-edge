 ...
 * 
 * <p>Java class for AssetUpdateRateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AssetUpdateRateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}AssetUpdateRateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AssetUpdateRateDataSetType")
@XmlType(name = "AssetUpdateRateDataSetType", propOrder = {
    "entry"
})
public class AssetUpdateRateDataSetType
    extends EventType
{
    ...
    protected List<AssetUpdateRateEntryType> entry;
    /**
     ...
     */
    public List<AssetUpdateRateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
