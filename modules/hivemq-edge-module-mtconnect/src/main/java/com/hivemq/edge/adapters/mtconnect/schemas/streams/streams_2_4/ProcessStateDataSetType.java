 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ProcessStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@XmlType(name = "ProcessStateDataSetType", propOrder = {
    "entry"
})
    ...
    extends EventType
{
    ...
    protected List<ProcessStateEntryType> entry;
    /**
     ...
     */
    public List<ProcessStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
