 ...
 * 
 * <p>Java class for UncertaintyTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="UncertaintyTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}UncertaintyTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "UncertaintyTableType")
@XmlType(name = "UncertaintyTableType", propOrder = {
    "entry"
})
public class UncertaintyTableType
    extends EventType
{
    ...
    protected List<UncertaintyTableEntryType> entry;
    /**
     ...
     * {@link UncertaintyTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<UncertaintyTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
