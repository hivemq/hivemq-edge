 ...
 * 
 * <p>Java class for DewPointTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DewPointTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}DewPointTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DewPointTableType")
@XmlType(name = "DewPointTableType", propOrder = {
    "entry"
})
public class DewPointTableType
    extends EventType
{
    ...
    protected List<DewPointTableEntryType> entry;
    /**
     ...
     */
    public List<DewPointTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
