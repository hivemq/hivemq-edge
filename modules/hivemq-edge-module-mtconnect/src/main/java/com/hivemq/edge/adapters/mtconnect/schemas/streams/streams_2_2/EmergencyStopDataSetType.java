 ...
 * 
 * <p>Java class for EmergencyStopDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EmergencyStopDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}EmergencyStopEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EmergencyStopDataSetType")
@XmlType(name = "EmergencyStopDataSetType", propOrder = {
    "entry"
})
public class EmergencyStopDataSetType
    extends EventType
{
    ...
    protected List<EmergencyStopEntryType> entry;
    /**
     ...
     */
    public List<EmergencyStopEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
