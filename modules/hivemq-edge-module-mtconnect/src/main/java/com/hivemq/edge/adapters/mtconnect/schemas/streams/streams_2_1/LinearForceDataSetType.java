 ...
 * 
 * <p>Java class for LinearForceDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LinearForceDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}LinearForceEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LinearForceDataSetType")
@XmlType(name = "LinearForceDataSetType", propOrder = {
    "entry"
})
public class LinearForceDataSetType
    extends EventType
{
    ...
    protected List<LinearForceEntryType> entry;
    /**
     ...
     */
    public List<LinearForceEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
