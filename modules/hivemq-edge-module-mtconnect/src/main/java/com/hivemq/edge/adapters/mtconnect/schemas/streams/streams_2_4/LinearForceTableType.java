 ...
 * 
 * <p>Java class for LinearForceTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LinearForceTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}LinearForceTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LinearForceTableType")
@XmlType(name = "LinearForceTableType", propOrder = {
    "entry"
})
public class LinearForceTableType
    extends EventType
{
    ...
    protected List<LinearForceTableEntryType> entry;
    /**
     ...
     * {@link LinearForceTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<LinearForceTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
