 ...
 * 
 * <p>Java class for RotaryVelocityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RotaryVelocityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}RotaryVelocityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "RotaryVelocityDataSetType")
@XmlType(name = "RotaryVelocityDataSetType", propOrder = {
    "entry"
})
public class RotaryVelocityDataSetType
    extends EventType
{
    ...
    protected List<RotaryVelocityEntryType> entry;
    /**
     ...
     */
    public List<RotaryVelocityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
