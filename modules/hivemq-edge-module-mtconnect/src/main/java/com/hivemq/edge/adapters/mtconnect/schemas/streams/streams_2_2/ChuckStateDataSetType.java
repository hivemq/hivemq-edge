 ...
 * 
 * <p>Java class for ChuckStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ChuckStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ChuckStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ChuckStateDataSetType")
@XmlType(name = "ChuckStateDataSetType", propOrder = {
    "entry"
})
public class ChuckStateDataSetType
    extends EventType
{
    ...
    protected List<ChuckStateEntryType> entry;
    /**
     ...
     */
    public List<ChuckStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
