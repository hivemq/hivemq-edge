 ...
 * 
 * <p>Java class for ClockTimeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ClockTimeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ClockTimeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ClockTimeDataSetType")
@XmlType(name = "ClockTimeDataSetType", propOrder = {
    "entry"
})
public class ClockTimeDataSetType
    extends EventType
{
    ...
    protected List<ClockTimeEntryType> entry;
    /**
     ...
     */
    public List<ClockTimeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
