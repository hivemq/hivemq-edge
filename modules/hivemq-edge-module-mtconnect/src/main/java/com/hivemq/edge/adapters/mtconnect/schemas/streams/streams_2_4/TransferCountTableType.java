 ...
 * 
 * <p>Java class for TransferCountTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TransferCountTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}TransferCountTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TransferCountTableType")
@XmlType(name = "TransferCountTableType", propOrder = {
    "entry"
})
public class TransferCountTableType
    extends EventType
{
    ...
    protected List<TransferCountTableEntryType> entry;
    /**
     ...
     * {@link TransferCountTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<TransferCountTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
