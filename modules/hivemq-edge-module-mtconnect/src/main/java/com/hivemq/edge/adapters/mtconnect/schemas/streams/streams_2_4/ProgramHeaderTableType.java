 ...
 * 
 * <p>Java class for ProgramHeaderTableType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ProgramHeaderTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramHeaderTableType")
@XmlType(name = "ProgramHeaderTableType", propOrder = {
    "entry"
})
public class ProgramHeaderTableType
    extends EventType
{
    ...
    protected List<ProgramHeaderTableEntryType> entry;
    /**
     ...
     * {@link ProgramHeaderTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProgramHeaderTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
