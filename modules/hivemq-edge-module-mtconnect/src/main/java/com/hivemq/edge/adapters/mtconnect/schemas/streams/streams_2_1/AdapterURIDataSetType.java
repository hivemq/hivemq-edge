 ...
 * 
 * <p>Java class for AdapterURIDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AdapterURIDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AdapterURIEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AdapterURIDataSetType")
@XmlType(name = "AdapterURIDataSetType", propOrder = {
    "entry"
})
public class AdapterURIDataSetType
    extends EventType
{
    ...
    protected List<AdapterURIEntryType> entry;
    /**
     ...
     */
    public List<AdapterURIEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
