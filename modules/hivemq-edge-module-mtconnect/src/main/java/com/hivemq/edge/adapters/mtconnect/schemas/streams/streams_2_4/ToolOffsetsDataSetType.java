 ...
 * 
 * <p>Java class for ToolOffsetsDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolOffsetsDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ToolOffsetsEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolOffsetsDataSetType")
@XmlType(name = "ToolOffsetsDataSetType", propOrder = {
    "entry"
})
public class ToolOffsetsDataSetType
    extends EventType
{
    ...
    protected List<ToolOffsetsEntryType> entry;
    /**
     ...
     */
    public List<ToolOffsetsEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
