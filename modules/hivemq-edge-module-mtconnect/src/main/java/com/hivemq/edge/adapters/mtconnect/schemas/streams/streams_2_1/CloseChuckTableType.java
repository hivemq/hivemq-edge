 ...
 * 
 * <p>Java class for CloseChuckTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CloseChuckTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}CloseChuckTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CloseChuckTableType")
@XmlType(name = "CloseChuckTableType", propOrder = {
    "entry"
})
public class CloseChuckTableType
    extends EventType
{
    ...
    protected List<CloseChuckTableEntryType> entry;
    /**
     ...
     */
    public List<CloseChuckTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
