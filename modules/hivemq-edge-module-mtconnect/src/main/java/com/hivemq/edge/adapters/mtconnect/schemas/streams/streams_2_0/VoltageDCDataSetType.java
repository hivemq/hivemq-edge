 ...
 * 
 * <p>Java class for VoltageDCDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VoltageDCDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}VoltageDCEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VoltageDCDataSetType")
@XmlType(name = "VoltageDCDataSetType", propOrder = {
    "entry"
})
public class VoltageDCDataSetType
    extends EventType
{
    ...
    protected List<VoltageDCEntryType> entry;
    /**
     ...
     */
    public List<VoltageDCEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
