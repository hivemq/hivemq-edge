 ...
 * 
 * <p>Java class for PartChangeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartChangeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}PartChangeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartChangeTableType")
@XmlType(name = "PartChangeTableType", propOrder = {
    "entry"
})
public class PartChangeTableType
    extends EventType
{
    ...
    protected List<PartChangeTableEntryType> entry;
    /**
     ...
     */
    public List<PartChangeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
