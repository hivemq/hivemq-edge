 ...
 * 
 * <p>Java class for PositionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PositionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}PositionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PositionDataSetType")
@XmlType(name = "PositionDataSetType", propOrder = {
    "entry"
})
public class PositionDataSetType
    extends EventType
{
    ...
    protected List<PositionEntryType> entry;
    /**
     ...
     */
    public List<PositionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
