 ...
 * 
 * <p>Java class for ToolCuttingItemDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolCuttingItemDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ToolCuttingItemEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolCuttingItemDataSetType")
@XmlType(name = "ToolCuttingItemDataSetType", propOrder = {
    "entry"
})
public class ToolCuttingItemDataSetType
    extends EventType
{
    ...
    protected List<ToolCuttingItemEntryType> entry;
    /**
     ...
     */
    public List<ToolCuttingItemEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
