 ...
 * 
 * <p>Java class for BatteryCapacityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BatteryCapacityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}BatteryCapacityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BatteryCapacityDataSetType")
@XmlType(name = "BatteryCapacityDataSetType", propOrder = {
    "entry"
})
public class BatteryCapacityDataSetType
    extends EventType
{
    ...
    protected List<BatteryCapacityEntryType> entry;
    /**
     ...
     */
    public List<BatteryCapacityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
