 ...
 * 
 * <p>Java class for DewPointDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DewPointDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}DewPointEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DewPointDataSetType")
@XmlType(name = "DewPointDataSetType", propOrder = {
    "entry"
})
public class DewPointDataSetType
    extends EventType
{
    ...
    protected List<DewPointEntryType> entry;
    /**
     ...
     */
    public List<DewPointEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
