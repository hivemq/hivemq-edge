 ...
 * 
 * <p>Java class for HardnessTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HardnessTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}HardnessTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "HardnessTableType")
@XmlType(name = "HardnessTableType", propOrder = {
    "entry"
})
public class HardnessTableType
    extends EventType
{
    ...
    protected List<HardnessTableEntryType> entry;
    /**
     ...
     */
    public List<HardnessTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
