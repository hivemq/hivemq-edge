 ...
 * 
 * <p>Java class for ExecutionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ExecutionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}ExecutionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ExecutionDataSetType")
@XmlType(name = "ExecutionDataSetType", propOrder = {
    "entry"
})
public class ExecutionDataSetType
    extends EventType
{
    ...
    protected List<ExecutionEntryType> entry;
    /**
     ...
     */
    public List<ExecutionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
