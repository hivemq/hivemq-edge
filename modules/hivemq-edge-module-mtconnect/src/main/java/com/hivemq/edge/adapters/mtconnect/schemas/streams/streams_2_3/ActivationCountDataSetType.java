 ...
 * 
 * <p>Java class for ActivationCountDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ActivationCountDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ActivationCountEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ActivationCountDataSetType")
@XmlType(name = "ActivationCountDataSetType", propOrder = {
    "entry"
})
public class ActivationCountDataSetType
    extends EventType
{
    ...
    protected List<ActivationCountEntryType> entry;
    /**
     ...
     */
    public List<ActivationCountEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
