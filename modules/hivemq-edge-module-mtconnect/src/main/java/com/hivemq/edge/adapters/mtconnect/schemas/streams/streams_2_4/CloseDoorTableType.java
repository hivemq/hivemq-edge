 ...
 * 
 * <p>Java class for CloseDoorTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CloseDoorTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}CloseDoorTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CloseDoorTableType")
@XmlType(name = "CloseDoorTableType", propOrder = {
    "entry"
})
public class CloseDoorTableType
    extends EventType
{
    ...
    protected List<CloseDoorTableEntryType> entry;
    /**
     ...
     */
    public List<CloseDoorTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
