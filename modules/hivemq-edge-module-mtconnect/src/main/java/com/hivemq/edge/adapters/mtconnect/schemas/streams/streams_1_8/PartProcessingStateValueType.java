...
public enum PartProcessingStateValueType {
    ...
    /**
     * The part occurrence is not actively being processed, but the
     *             processing has not ended. Processing requirements exist that have
     *             not yet been fulfilled. This is the default entry state when the
     *             part occurrence is originally received. In some cases, the part
     *             occurrence may return to this state while it waits for additional
    ...
    /**
     * The part occurrence is no longer being processed. A general state
     *             when the reason for termination is unknown.
     * 
     */
    PROCESSING_ENDED,
    ...
    /**
     * The process has been stopped during the processing. The part
     *             occurrence will require special treatment.
     * 
     */
    ...
    /**
     * The terminal state when the part occurrence has been removed from
     *             the equipment by an external entity and it no longer exists at the
     *             equipment.
     * 
     */
    ...
    /**
     * The part occurrence has been skipped for processing on the piece of
     *             equipment.
     * 
     */
    ...
    /**
     * The part occurrence has been processed completely; however, the
    ...
    /**
     * The part occurrence is waiting for transit.
     * 
     */
    WAITING_FOR_TRANSIT,

    /**
     * The part occurrence is being transported to its destination.
     * 
     */
    IN_TRANSIT,

    /**
     * The part occurrence has been placed at its designated destination.
     * 
     */
    TRANSIT_COMPLETE,
