 ...
 * 
 * <p>Java class for TorqueTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TorqueTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}TorqueTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TorqueTableType")
@XmlType(name = "TorqueTableType", propOrder = {
    "entry"
})
public class TorqueTableType
    extends EventType
{
    ...
    protected List<TorqueTableEntryType> entry;
    /**
     ...
     */
    public List<TorqueTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
