 ...
 * 
 * <p>Java class for ConcentrationTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ConcentrationTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ConcentrationTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ConcentrationTableType")
@XmlType(name = "ConcentrationTableType", propOrder = {
    "entry"
})
public class ConcentrationTableType
    extends EventType
{
    ...
    protected List<ConcentrationTableEntryType> entry;
    /**
     ...
     * {@link ConcentrationTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ConcentrationTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
