 ...
 * 
 * <p>Java class for VoltageACTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VoltageACTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}VoltageACTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VoltageACTableType")
@XmlType(name = "VoltageACTableType", propOrder = {
    "entry"
})
public class VoltageACTableType
    extends EventType
{
    ...
    protected List<VoltageACTableEntryType> entry;
    /**
     ...
     */
    public List<VoltageACTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
