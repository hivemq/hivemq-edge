 ...
 * 
 * <p>Java class for LibraryTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LibraryTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}LibraryTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LibraryTableType")
@XmlType(name = "LibraryTableType", propOrder = {
    "entry"
})
public class LibraryTableType
    extends EventType
{
    ...
    protected List<LibraryTableEntryType> entry;
    /**
     ...
     */
    public List<LibraryTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
