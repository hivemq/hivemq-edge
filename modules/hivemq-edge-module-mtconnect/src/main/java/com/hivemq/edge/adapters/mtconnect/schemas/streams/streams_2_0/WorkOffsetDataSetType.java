 ...
 * 
 * <p>Java class for WorkOffsetDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WorkOffsetDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}WorkOffsetEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WorkOffsetDataSetType")
@XmlType(name = "WorkOffsetDataSetType", propOrder = {
    "entry"
})
public class WorkOffsetDataSetType
    extends EventType
{
    ...
    protected List<WorkOffsetEntryType> entry;
    /**
     ...
     */
    public List<WorkOffsetEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
