 ...
 * 
 * <p>Java class for GlobalPositionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="GlobalPositionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}GlobalPositionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "GlobalPositionDataSetType")
@XmlType(name = "GlobalPositionDataSetType", propOrder = {
    "entry"
})
public class GlobalPositionDataSetType
    extends EventType
{
    ...
    protected List<GlobalPositionEntryType> entry;
    /**
     ...
     */
    public List<GlobalPositionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
