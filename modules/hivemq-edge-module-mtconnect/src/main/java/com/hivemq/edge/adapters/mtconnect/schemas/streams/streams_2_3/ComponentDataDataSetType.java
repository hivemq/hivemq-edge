 ...
 *         {{block(Definition)}}.
 * 
 * <p>Java class for ComponentDataDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ComponentDataDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ComponentDataEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ComponentDataDataSetType")
@XmlType(name = "ComponentDataDataSetType", propOrder = {
    "entry"
})
public class ComponentDataDataSetType
    extends EventType
{
    ...
    protected List<ComponentDataEntryType> entry;
    /**
     ...
     */
    public List<ComponentDataEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
