 ...
 *         {{block(Component)}}.
 * 
 * <p>Java class for DisplacementAngularTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DisplacementAngularTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}DisplacementAngularTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DisplacementAngularTableType")
@XmlType(name = "DisplacementAngularTableType", propOrder = {
    "entry"
})
public class DisplacementAngularTableType
    extends EventType
{
    ...
    protected List<DisplacementAngularTableEntryType> entry;
    /**
     ...
     * {@link DisplacementAngularTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DisplacementAngularTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
