...
/**
 * Table of {{def(EventEnum:MAINTENANCE_LIST)}} If the
 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}MaintenanceListTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@XmlType(name = "MaintenanceListTableType", propOrder = {
    "entry"
})
    ...
    extends EventType
{
    ...
    protected List<MaintenanceListTableEntryType> entry;
    /**
     ...
     * {@link MaintenanceListTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MaintenanceListTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
