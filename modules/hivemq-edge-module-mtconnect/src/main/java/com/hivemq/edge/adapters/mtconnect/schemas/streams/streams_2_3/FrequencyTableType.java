 ...
 * 
 * <p>Java class for FrequencyTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FrequencyTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}FrequencyTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FrequencyTableType")
@XmlType(name = "FrequencyTableType", propOrder = {
    "entry"
})
public class FrequencyTableType
    extends EventType
{
    ...
    protected List<FrequencyTableEntryType> entry;
    /**
     ...
     */
    public List<FrequencyTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
