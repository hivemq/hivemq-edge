 ...
 * 
 * <p>Java class for LineLabelTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LineLabelTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}LineLabelTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LineLabelTableType")
@XmlType(name = "LineLabelTableType", propOrder = {
    "entry"
})
public class LineLabelTableType
    extends EventType
{
    ...
    protected List<LineLabelTableEntryType> entry;
    /**
     ...
     */
    public List<LineLabelTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
