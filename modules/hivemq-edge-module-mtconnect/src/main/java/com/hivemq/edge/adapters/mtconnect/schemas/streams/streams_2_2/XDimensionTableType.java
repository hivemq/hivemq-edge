 ...
 * 
 * <p>Java class for XDimensionTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="XDimensionTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}XDimensionTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "XDimensionTableType")
@XmlType(name = "XDimensionTableType", propOrder = {
    "entry"
})
public class XDimensionTableType
    extends EventType
{
    ...
    protected List<XDimensionTableEntryType> entry;
    /**
     ...
     */
    public List<XDimensionTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
