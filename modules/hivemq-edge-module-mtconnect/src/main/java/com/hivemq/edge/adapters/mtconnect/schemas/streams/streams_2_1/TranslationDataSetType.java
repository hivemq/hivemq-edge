 ...
 * 
 * <p>Java class for TranslationDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TranslationDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}TranslationEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TranslationDataSetType")
@XmlType(name = "TranslationDataSetType", propOrder = {
    "entry"
})
public class TranslationDataSetType
    extends EventType
{
    ...
    protected List<TranslationEntryType> entry;
    /**
     ...
     */
    public List<TranslationEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
