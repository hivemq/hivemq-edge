 ...
 * 
 * <p>Java class for VoltAmpereTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VoltAmpereTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}VoltAmpereTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VoltAmpereTableType")
@XmlType(name = "VoltAmpereTableType", propOrder = {
    "entry"
})
public class VoltAmpereTableType
    extends EventType
{
    ...
    protected List<VoltAmpereTableEntryType> entry;
    /**
     ...
     */
    public List<VoltAmpereTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
