 ...
 * 
 * <p>Java class for WorkholdingIdTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WorkholdingIdTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}WorkholdingIdTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WorkholdingIdTableType")
@XmlType(name = "WorkholdingIdTableType", propOrder = {
    "entry"
})
public class WorkholdingIdTableType
    extends EventType
{
    ...
    protected List<WorkholdingIdTableEntryType> entry;
    /**
     ...
     * {@link WorkholdingIdTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<WorkholdingIdTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
