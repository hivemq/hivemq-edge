 ...
 * 
 * <p>Java class for EndOfBarDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EndOfBarDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}EndOfBarEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EndOfBarDataSetType")
@XmlType(name = "EndOfBarDataSetType", propOrder = {
    "entry"
})
public class EndOfBarDataSetType
    extends EventType
{
    ...
    protected List<EndOfBarEntryType> entry;
    /**
     ...
     */
    public List<EndOfBarEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
