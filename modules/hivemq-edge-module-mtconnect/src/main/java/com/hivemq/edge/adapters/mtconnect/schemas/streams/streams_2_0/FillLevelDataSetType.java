 ...
 * 
 * <p>Java class for FillLevelDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FillLevelDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}FillLevelEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FillLevelDataSetType")
@XmlType(name = "FillLevelDataSetType", propOrder = {
    "entry"
})
public class FillLevelDataSetType
    extends EventType
{
    ...
    protected List<FillLevelEntryType> entry;
    /**
     ...
     */
    public List<FillLevelEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
