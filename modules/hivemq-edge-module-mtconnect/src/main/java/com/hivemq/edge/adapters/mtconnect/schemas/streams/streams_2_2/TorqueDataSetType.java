 ...
 * 
 * <p>Java class for TorqueDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TorqueDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}TorqueEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TorqueDataSetType")
@XmlType(name = "TorqueDataSetType", propOrder = {
    "entry"
})
public class TorqueDataSetType
    extends EventType
{
    ...
    protected List<TorqueEntryType> entry;
    /**
     ...
     */
    public List<TorqueEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
