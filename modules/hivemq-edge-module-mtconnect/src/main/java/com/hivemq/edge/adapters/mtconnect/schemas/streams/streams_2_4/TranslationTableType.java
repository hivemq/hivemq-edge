 ...
 * 
 * <p>Java class for TranslationTableType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}TranslationTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TranslationTableType")
    ...
    extends EventType
{
    ...
    protected List<TranslationTableEntryType> entry;
    /**
     ...
     * {@link TranslationTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<TranslationTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
