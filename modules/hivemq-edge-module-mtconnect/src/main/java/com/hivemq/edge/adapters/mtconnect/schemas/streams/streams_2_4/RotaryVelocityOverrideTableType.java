 ...
 * 
 * <p>Java class for RotaryVelocityOverrideTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RotaryVelocityOverrideTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}RotaryVelocityOverrideTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "RotaryVelocityOverrideTableType")
@XmlType(name = "RotaryVelocityOverrideTableType", propOrder = {
    "entry"
})
public class RotaryVelocityOverrideTableType
    extends EventType
{
    ...
    protected List<RotaryVelocityOverrideTableEntryType> entry;
    /**
     ...
     * {@link RotaryVelocityOverrideTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<RotaryVelocityOverrideTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
