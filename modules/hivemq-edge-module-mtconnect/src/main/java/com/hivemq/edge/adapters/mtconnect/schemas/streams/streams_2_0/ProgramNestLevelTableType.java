 ...
 * 
 * <p>Java class for ProgramNestLevelTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramNestLevelTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ProgramNestLevelTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramNestLevelTableType")
@XmlType(name = "ProgramNestLevelTableType", propOrder = {
    "entry"
})
public class ProgramNestLevelTableType
    extends EventType
{
    ...
    protected List<ProgramNestLevelTableEntryType> entry;
    /**
     ...
     * {@link ProgramNestLevelTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProgramNestLevelTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
