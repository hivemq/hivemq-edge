 ...
 * 
 * <p>Java class for ConductivityTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ConductivityTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ConductivityTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ConductivityTableType")
@XmlType(name = "ConductivityTableType", propOrder = {
    "entry"
})
public class ConductivityTableType
    extends EventType
{
    ...
    protected List<ConductivityTableEntryType> entry;
    /**
     ...
     * {@link ConductivityTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ConductivityTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
