 ...
 * 
 * <p>Java class for ValveStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ValveStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ValveStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ValveStateDataSetType")
@XmlType(name = "ValveStateDataSetType", propOrder = {
    "entry"
})
public class ValveStateDataSetType
    extends EventType
{
    ...
    protected List<ValveStateEntryType> entry;
    /**
     ...
     */
    public List<ValveStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
