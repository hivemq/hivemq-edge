 ...
 * generated in the com.hivemq.edge.adapters.mtconnect.schemas.devices.devices_1_3 package. 
...
public class ObjectFactory {
    ...
    private static final QName _MTConnectDevices_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "MTConnectDevices");
    private static final QName _Component_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Component");
    private static final QName _AbstractConfiguration_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "AbstractConfiguration");
    private static final QName _CommonComponent_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "CommonComponent");
    private static final QName _Device_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Device");
    private static final QName _Controller_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Controller");
    private static final QName _Power_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Power");
    private static final QName _Sensor_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Sensor");
    private static final QName _Path_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Path");
    private static final QName _Actuator_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Actuator");
    private static final QName _Door_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Door");
    private static final QName _SensorConfiguration_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "SensorConfiguration");
    private static final QName _Axes_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Axes");
    private static final QName _Axis_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Axis");
    private static final QName _Linear_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Linear");
    private static final QName _Rotary_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Rotary");
    private static final QName _Spindle_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Spindle");
    private static final QName _Systems_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Systems");
    private static final QName _System_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "System");
    private static final QName _Pneumatic_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Pneumatic");
    private static final QName _Hydraulic_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Hydraulic");
    private static final QName _Lubrication_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Lubrication");
    private static final QName _Coolant_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Coolant");
    private static final QName _Electric_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Electric");
    private static final QName _Interfaces_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Interfaces");
    private static final QName _Interface_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "Interface");
    private static final QName _BarFeeder_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "BarFeeder");
    private static final QName _MaterialHandler_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "MaterialHandler");
    private static final QName _DoorInterface_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "DoorInterface");
    private static final QName _ChuckInterface_QNAME = new QName("urn:mtconnect.org:MTConnectDevices:1.3", "ChuckInterface");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hivemq.edge.adapters.mtconnect.schemas.devices.devices_1_3
     * 
     */
     ...
     * 
     * @return
     *     the new instance of {@link MaterialHandlerType }
     */
     ...
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link MaterialHandlerType }{@code >}
     */
    ...
    public JAXBElement<MaterialHandlerType> createMaterialHandler(MaterialHandlerType value) {
        return new JAXBElement<>(_MaterialHandler_QNAME, MaterialHandlerType.class, null, value);
    }
