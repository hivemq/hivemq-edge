 ...
 * 
 * <p>Java class for XDimensionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="XDimensionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}XDimensionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "XDimensionDataSetType")
@XmlType(name = "XDimensionDataSetType", propOrder = {
    "entry"
})
public class XDimensionDataSetType
    extends EventType
{
    ...
    protected List<XDimensionEntryType> entry;
    /**
     ...
     */
    public List<XDimensionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
