 ...
 *       <sequence>
 *         <element name="Cell" type="{urn:mtconnect.org:MTConnectStreams:2.1}MaterialUnloadCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "MaterialUnloadTableEntryType", propOrder = {
    "cell"
})
    ...
    extends EntryType
{
    ...
    protected List<MaterialUnloadCellType> cell;
     ...
     */
    public List<MaterialUnloadCellType> getCell() {
        if (cell == null) {
            cell = new ArrayList<>();
        }
        return this.cell;
