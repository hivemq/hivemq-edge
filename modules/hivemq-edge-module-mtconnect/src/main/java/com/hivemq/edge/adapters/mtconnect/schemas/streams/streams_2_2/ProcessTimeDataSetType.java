 ...
 * 
 * <p>Java class for ProcessTimeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProcessTimeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ProcessTimeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProcessTimeDataSetType")
@XmlType(name = "ProcessTimeDataSetType", propOrder = {
    "entry"
})
public class ProcessTimeDataSetType
    extends EventType
{
    ...
    protected List<ProcessTimeEntryType> entry;
    /**
     ...
     */
    public List<ProcessTimeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
