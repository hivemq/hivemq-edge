 ...
 *         group.
 * 
 * <p>Java class for PartStatusTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartStatusTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}PartStatusTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartStatusTableType")
@XmlType(name = "PartStatusTableType", propOrder = {
    "entry"
})
public class PartStatusTableType
    extends EventType
{
    ...
    protected List<PartStatusTableEntryType> entry;
    /**
     ...
     */
    public List<PartStatusTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
