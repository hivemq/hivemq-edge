 ...
 * 
 * <p>Java class for MeasurementTypeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MeasurementTypeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}MeasurementTypeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MeasurementTypeDataSetType")
@XmlType(name = "MeasurementTypeDataSetType", propOrder = {
    "entry"
})
public class MeasurementTypeDataSetType
    extends EventType
{
    ...
    protected List<MeasurementTypeEntryType> entry;
    /**
     ...
     */
    public List<MeasurementTypeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
