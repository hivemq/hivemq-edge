 ...
 * 
 * <p>Java class for AvailabilityTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AvailabilityTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AvailabilityTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AvailabilityTableType")
@XmlType(name = "AvailabilityTableType", propOrder = {
    "entry"
})
public class AvailabilityTableType
    extends EventType
{
    ...
    protected List<AvailabilityTableEntryType> entry;
    /**
     ...
     * {@link AvailabilityTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AvailabilityTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
