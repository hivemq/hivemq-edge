 ...
 * 
 * <p>Java class for DepositionMassDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DepositionMassDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}DepositionMassEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DepositionMassDataSetType")
@XmlType(name = "DepositionMassDataSetType", propOrder = {
    "entry"
})
public class DepositionMassDataSetType
    extends EventType
{
    ...
    protected List<DepositionMassEntryType> entry;
    /**
     ...
     */
    public List<DepositionMassEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
