 ...
 *       <sequence>
 *         <element name="Cell" type="{urn:mtconnect.org:MTConnectStreams:2.2}AvailabilityCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "AvailabilityTableEntryType", propOrder = {
    "cell"
})
    ...
    extends EntryType
{
    ...
    protected List<AvailabilityCellType> cell;
     ...
     */
    public List<AvailabilityCellType> getCell() {
        if (cell == null) {
            cell = new ArrayList<>();
        }
        return this.cell;
