...
/**
 * Table of {{block(Composition)}} composed of a string like piece or
 *         filament of relatively rigid or flexible material provided in a variety
 *         of diameters.
 * 
 * <p>Java class for WireTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WireTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}WireTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WireTableType")
@XmlType(name = "WireTableType", propOrder = {
    "entry"
})
public class WireTableType
    extends EventType
{
    ...
    protected List<WireTableEntryType> entry;
    /**
     ...
     */
    public List<WireTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
