 ...
 * 
 * <p>Java class for ProgramEditDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramEditDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}ProgramEditEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramEditDataSetType")
@XmlType(name = "ProgramEditDataSetType", propOrder = {
    "entry"
})
public class ProgramEditDataSetType
    extends EventType
{
    ...
    protected List<ProgramEditEntryType> entry;
    /**
     ...
     */
    public List<ProgramEditEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
