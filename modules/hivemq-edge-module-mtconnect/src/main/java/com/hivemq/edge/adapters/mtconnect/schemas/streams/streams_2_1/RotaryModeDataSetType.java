 ...
 * 
 * <p>Java class for RotaryModeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RotaryModeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}RotaryModeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "RotaryModeDataSetType")
@XmlType(name = "RotaryModeDataSetType", propOrder = {
    "entry"
})
public class RotaryModeDataSetType
    extends EventType
{
    ...
    protected List<RotaryModeEntryType> entry;
    /**
     ...
     */
    public List<RotaryModeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
