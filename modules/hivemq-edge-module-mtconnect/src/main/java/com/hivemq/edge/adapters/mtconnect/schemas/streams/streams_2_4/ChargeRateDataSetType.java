 ...
 * 
 * <p>Java class for ChargeRateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ChargeRateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ChargeRateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ChargeRateDataSetType")
@XmlType(name = "ChargeRateDataSetType", propOrder = {
    "entry"
})
public class ChargeRateDataSetType
    extends EventType
{
    ...
    protected List<ChargeRateEntryType> entry;
    /**
     ...
     */
    public List<ChargeRateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
