 ...
 * 
 * <p>Java class for ProgramNestLevelDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramNestLevelDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ProgramNestLevelEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramNestLevelDataSetType")
@XmlType(name = "ProgramNestLevelDataSetType", propOrder = {
    "entry"
})
public class ProgramNestLevelDataSetType
    extends EventType
{
    ...
    protected List<ProgramNestLevelEntryType> entry;
    /**
     ...
     * {@link ProgramNestLevelEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProgramNestLevelEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
