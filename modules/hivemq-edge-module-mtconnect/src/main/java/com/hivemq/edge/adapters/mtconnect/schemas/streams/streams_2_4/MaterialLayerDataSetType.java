 ...
 * 
 * <p>Java class for MaterialLayerDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialLayerDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}MaterialLayerEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialLayerDataSetType")
@XmlType(name = "MaterialLayerDataSetType", propOrder = {
    "entry"
})
public class MaterialLayerDataSetType
    extends EventType
{
    ...
    protected List<MaterialLayerEntryType> entry;
    /**
     ...
     */
    public List<MaterialLayerEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
