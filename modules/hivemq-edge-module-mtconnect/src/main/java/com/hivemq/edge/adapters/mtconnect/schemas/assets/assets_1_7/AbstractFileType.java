...
/**
 * An {{block(AbstractFile)}} is an abstract {{block(Asset)}} type model
 *         that contains the common properties of the {{block(File)}} and
 *         {{block(FileArchetype)}} types.
 * 
 * <p>Java class for AbstractFileType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AbstractFileType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectAssets:1.7}AssetType">
 *       <all>
 *         <element name="FileProperties" type="{urn:mtconnect.org:MTConnectAssets:1.7}FilePropertiesType" minOccurs="0"/>
 *         <element name="FileComments" type="{urn:mtconnect.org:MTConnectAssets:1.7}FileCommentsType" minOccurs="0"/>
 *       </all>
 *       <attribute name="name" use="required" type="{urn:mtconnect.org:MTConnectAssets:1.7}FileNameType" />
 *       <attribute name="mediaType" use="required" type="{urn:mtconnect.org:MTConnectAssets:1.7}FileMimeTypeType" />
 *       <attribute name="applicationCategory" use="required" type="{urn:mtconnect.org:MTConnectAssets:1.7}ApplicationCategoryType" />
 *       <attribute name="applicationType" use="required" type="{urn:mtconnect.org:MTConnectAssets:1.7}ApplicationTypeType" />
 *     </extension>
 *   </complexContent>
 * </complexType>
 * }</pre>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AbstractFileType")
@XmlType(name = "AbstractFileType", propOrder = {
    "fileProperties",
    "fileComments"
})
@XmlSeeAlso({
    ...
    extends AssetType
{
    ...
    /**
     * `FileComments` {{termplural(organize)}} one or more
     *                 {{block(FileComment)}} entities for {{block(File)}}s.
     * 
     */
