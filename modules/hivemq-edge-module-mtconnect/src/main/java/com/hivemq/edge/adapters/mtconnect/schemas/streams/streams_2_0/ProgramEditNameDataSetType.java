 ...
 * 
 * <p>Java class for ProgramEditNameDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramEditNameDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ProgramEditNameEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramEditNameDataSetType")
@XmlType(name = "ProgramEditNameDataSetType", propOrder = {
    "entry"
})
public class ProgramEditNameDataSetType
    extends EventType
{
    ...
    protected List<ProgramEditNameEntryType> entry;
    /**
     ...
     */
    public List<ProgramEditNameEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
