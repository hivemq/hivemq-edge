 ...
 * 
 * <p>Java class for MaterialRetractDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialRetractDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}MaterialRetractEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialRetractDataSetType")
@XmlType(name = "MaterialRetractDataSetType", propOrder = {
    "entry"
})
public class MaterialRetractDataSetType
    extends EventType
{
    ...
    protected List<MaterialRetractEntryType> entry;
    /**
     ...
     */
    public List<MaterialRetractEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
