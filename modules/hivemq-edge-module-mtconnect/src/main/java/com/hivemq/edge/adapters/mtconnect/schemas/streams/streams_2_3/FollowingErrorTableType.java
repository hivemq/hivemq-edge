 ...
 * 
 * <p>Java class for FollowingErrorTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FollowingErrorTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}FollowingErrorTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FollowingErrorTableType")
@XmlType(name = "FollowingErrorTableType", propOrder = {
    "entry"
})
public class FollowingErrorTableType
    extends EventType
{
    ...
    protected List<FollowingErrorTableEntryType> entry;
    /**
     ...
     * {@link FollowingErrorTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<FollowingErrorTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
