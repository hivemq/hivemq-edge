 ...
 * 
 * <p>Java class for BlockCountDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BlockCountDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}BlockCountEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BlockCountDataSetType")
@XmlType(name = "BlockCountDataSetType", propOrder = {
    "entry"
})
public class BlockCountDataSetType
    extends EventType
{
    ...
    protected List<BlockCountEntryType> entry;
    /**
     ...
     */
    public List<BlockCountEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
