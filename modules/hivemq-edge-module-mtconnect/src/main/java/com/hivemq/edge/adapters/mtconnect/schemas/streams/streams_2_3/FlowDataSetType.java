 ...
 * 
 * <p>Java class for FlowDataSetType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}FlowEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FlowDataSetType")
    ...
    extends EventType
{
    ...
    protected List<FlowEntryType> entry;
    /**
     ...
     */
    public List<FlowEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
