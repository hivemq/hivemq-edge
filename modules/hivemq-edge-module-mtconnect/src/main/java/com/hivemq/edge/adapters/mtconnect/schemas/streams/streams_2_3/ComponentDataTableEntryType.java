 ...
 *       <sequence>
 *         <element name="Cell" type="{urn:mtconnect.org:MTConnectStreams:2.3}ComponentDataCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ComponentDataTableEntryType", propOrder = {
    "cell"
})
    ...
    extends EntryType
{
    ...
    protected List<ComponentDataCellType> cell;
     ...
     */
    public List<ComponentDataCellType> getCell() {
        if (cell == null) {
            cell = new ArrayList<>();
        }
        return this.cell;
