 ...
 * 
 * <p>Java class for VoltageDCTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VoltageDCTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}VoltageDCTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VoltageDCTableType")
@XmlType(name = "VoltageDCTableType", propOrder = {
    "entry"
})
public class VoltageDCTableType
    extends EventType
{
    ...
    protected List<VoltageDCTableEntryType> entry;
    /**
     ...
     */
    public List<VoltageDCTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
