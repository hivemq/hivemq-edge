 ...
 * 
 * <p>Java class for ProcessKindIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProcessKindIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ProcessKindIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProcessKindIdDataSetType")
@XmlType(name = "ProcessKindIdDataSetType", propOrder = {
    "entry"
})
public class ProcessKindIdDataSetType
    extends EventType
{
    ...
    protected List<ProcessKindIdEntryType> entry;
    /**
     ...
     */
    public List<ProcessKindIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
