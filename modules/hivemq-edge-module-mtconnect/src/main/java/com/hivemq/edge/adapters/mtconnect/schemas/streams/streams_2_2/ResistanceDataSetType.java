 ...
 * 
 * <p>Java class for ResistanceDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ResistanceDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ResistanceEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ResistanceDataSetType")
@XmlType(name = "ResistanceDataSetType", propOrder = {
    "entry"
})
public class ResistanceDataSetType
    extends EventType
{
    ...
    protected List<ResistanceEntryType> entry;
    /**
     ...
     */
    public List<ResistanceEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
