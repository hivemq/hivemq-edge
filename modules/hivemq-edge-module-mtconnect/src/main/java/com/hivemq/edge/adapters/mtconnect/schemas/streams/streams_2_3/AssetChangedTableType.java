 ...
 * 
 * <p>Java class for AssetChangedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AssetChangedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}AssetChangedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AssetChangedTableType")
@XmlType(name = "AssetChangedTableType", propOrder = {
    "entry"
})
public class AssetChangedTableType
    extends EventType
{
    ...
    protected List<AssetChangedTableEntryType> entry;
    /**
     ...
     * {@link AssetChangedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AssetChangedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
