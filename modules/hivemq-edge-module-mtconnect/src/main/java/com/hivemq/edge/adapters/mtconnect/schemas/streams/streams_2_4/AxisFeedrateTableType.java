 ...
 * 
 * <p>Java class for AxisFeedrateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AxisFeedrateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AxisFeedrateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AxisFeedrateTableType")
@XmlType(name = "AxisFeedrateTableType", propOrder = {
    "entry"
})
public class AxisFeedrateTableType
    extends EventType
{
    ...
    protected List<AxisFeedrateTableEntryType> entry;
    /**
     ...
     * {@link AxisFeedrateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AxisFeedrateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
