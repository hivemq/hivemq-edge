 ...
 * 
 * <p>Java class for ProcessTimerDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProcessTimerDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ProcessTimerEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProcessTimerDataSetType")
@XmlType(name = "ProcessTimerDataSetType", propOrder = {
    "entry"
})
public class ProcessTimerDataSetType
    extends EventType
{
    ...
    protected List<ProcessTimerEntryType> entry;
    /**
     ...
     */
    public List<ProcessTimerEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
