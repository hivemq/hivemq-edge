 ...
 *       <all>
 *         <element name="Source" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemSourceType" minOccurs="0"/>
 *         <element name="Constraints" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemConstraintsType" minOccurs="0"/>
 *         <element name="Filters" type="{urn:mtconnect.org:MTConnectDevices:1.8}FiltersType" minOccurs="0"/>
 *         <element name="InitialValue" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemNumericValueType" minOccurs="0"/>
 *         <element name="ResetTrigger" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemResetValueType" minOccurs="0"/>
 *         <element name="Definition" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemDefinitionType" minOccurs="0"/>
 *         <element name="Relationships" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemRelationshipsType" minOccurs="0"/>
 *       </all>
 ...
 *       <attribute name="type" use="required" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemEnumType" />
 *       <attribute name="subType" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemSubEnumType" />
 *       <attribute name="statistic" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemStatisticsType" />
 *       <attribute name="units" type="{urn:mtconnect.org:MTConnectDevices:1.8}UnitsType" />
 *       <attribute name="nativeUnits" type="{urn:mtconnect.org:MTConnectDevices:1.8}NativeUnitsType" />
 *       <attribute name="nativeScale" type="{urn:mtconnect.org:MTConnectDevices:1.8}NativeScaleType" />
 *       <attribute name="category" use="required" type="{urn:mtconnect.org:MTConnectDevices:1.8}CategoryType" />
 *       <attribute name="coordinateSystem" type="{urn:mtconnect.org:MTConnectDevices:1.8}CoordinateSystemEnumType" />
 *       <attribute name="coordinateSystemIdRef" type="{urn:mtconnect.org:MTConnectDevices:1.8}CoordinateSystemIdRefType" />
 *       <attribute name="compositionId" type="{urn:mtconnect.org:MTConnectDevices:1.8}CompositionIdType" />
 *       <attribute name="sampleRate" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemSampleRateType" />
 *       <attribute name="representation" type="{urn:mtconnect.org:MTConnectDevices:1.8}RepresentationType" default="VALUE" />
 *       <attribute name="significantDigits" type="{urn:mtconnect.org:MTConnectDevices:1.8}SignificantDigitsValueType" />
 *       <attribute name="discrete" type="{urn:mtconnect.org:MTConnectDevices:1.8}DiscreteType" default="false" />
 *     </restriction>
 *   </complexContent>
 * </complexType>
 * }</pre>
