 ...
 * 
 * <p>Java class for DiameterTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DiameterTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}DiameterTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DiameterTableType")
@XmlType(name = "DiameterTableType", propOrder = {
    "entry"
})
public class DiameterTableType
    extends EventType
{
    ...
    protected List<DiameterTableEntryType> entry;
    /**
     ...
     */
    public List<DiameterTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
