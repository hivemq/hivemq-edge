 ...
 * 
 * <p>Java class for DirectionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DirectionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}DirectionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DirectionDataSetType")
@XmlType(name = "DirectionDataSetType", propOrder = {
    "entry"
})
public class DirectionDataSetType
    extends EventType
{
    ...
    protected List<DirectionEntryType> entry;
    /**
     ...
     */
    public List<DirectionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
