 ...
 * 
 * <p>Java class for CloseChuckDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CloseChuckDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}CloseChuckEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CloseChuckDataSetType")
@XmlType(name = "CloseChuckDataSetType", propOrder = {
    "entry"
})
public class CloseChuckDataSetType
    extends EventType
{
    ...
    protected List<CloseChuckEntryType> entry;
    /**
     ...
     */
    public List<CloseChuckEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
