 ...
 * 
 * <p>Java class for ApplicationDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ApplicationDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ApplicationEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ApplicationDataSetType")
@XmlType(name = "ApplicationDataSetType", propOrder = {
    "entry"
})
public class ApplicationDataSetType
    extends EventType
{
    ...
    protected List<ApplicationEntryType> entry;
    /**
     ...
     */
    public List<ApplicationEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
