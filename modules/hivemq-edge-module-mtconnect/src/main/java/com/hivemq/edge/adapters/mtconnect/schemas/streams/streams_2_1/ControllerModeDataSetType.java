 ...
 * 
 * <p>Java class for ControllerModeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ControllerModeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}ControllerModeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ControllerModeDataSetType")
@XmlType(name = "ControllerModeDataSetType", propOrder = {
    "entry"
})
public class ControllerModeDataSetType
    extends EventType
{
    ...
    protected List<ControllerModeEntryType> entry;
    /**
     ...
     */
    public List<ControllerModeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
