 ...
 * 
 * <p>Java class for AccelerationTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AccelerationTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}AccelerationTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AccelerationTableType")
@XmlType(name = "AccelerationTableType", propOrder = {
    "entry"
})
public class AccelerationTableType
    extends EventType
{
    ...
    protected List<AccelerationTableEntryType> entry;
    /**
     ...
     * {@link AccelerationTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AccelerationTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
