 ...
 * 
 * <p>Java class for VolumeSpatialTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VolumeSpatialTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}VolumeSpatialTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VolumeSpatialTableType")
@XmlType(name = "VolumeSpatialTableType", propOrder = {
    "entry"
})
public class VolumeSpatialTableType
    extends EventType
{
    ...
    protected List<VolumeSpatialTableEntryType> entry;
    /**
     ...
     * {@link VolumeSpatialTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<VolumeSpatialTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
