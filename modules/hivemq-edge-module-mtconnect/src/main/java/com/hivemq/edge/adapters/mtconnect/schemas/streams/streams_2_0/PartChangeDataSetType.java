 ...
 * 
 * <p>Java class for PartChangeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartChangeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}PartChangeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartChangeDataSetType")
@XmlType(name = "PartChangeDataSetType", propOrder = {
    "entry"
})
public class PartChangeDataSetType
    extends EventType
{
    ...
    protected List<PartChangeEntryType> entry;
    /**
     ...
     */
    public List<PartChangeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
