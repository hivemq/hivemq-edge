 ...
 * 
 * <p>Java class for EquipmentTimerDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EquipmentTimerDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}EquipmentTimerEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EquipmentTimerDataSetType")
@XmlType(name = "EquipmentTimerDataSetType", propOrder = {
    "entry"
})
public class EquipmentTimerDataSetType
    extends EventType
{
    ...
    protected List<EquipmentTimerEntryType> entry;
    /**
     ...
     */
    public List<EquipmentTimerEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
