 ...
 * 
 * <p>Java class for VolumeFluidDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VolumeFluidDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}VolumeFluidEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VolumeFluidDataSetType")
@XmlType(name = "VolumeFluidDataSetType", propOrder = {
    "entry"
})
public class VolumeFluidDataSetType
    extends EventType
{
    ...
    protected List<VolumeFluidEntryType> entry;
    /**
     ...
     */
    public List<VolumeFluidEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
