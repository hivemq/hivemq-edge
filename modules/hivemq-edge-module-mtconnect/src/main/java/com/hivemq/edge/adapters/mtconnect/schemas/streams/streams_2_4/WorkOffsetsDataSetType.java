 ...
 * 
 * <p>Java class for WorkOffsetsDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WorkOffsetsDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}WorkOffsetsEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WorkOffsetsDataSetType")
@XmlType(name = "WorkOffsetsDataSetType", propOrder = {
    "entry"
})
public class WorkOffsetsDataSetType
    extends EventType
{
    ...
    protected List<WorkOffsetsEntryType> entry;
    /**
     ...
     */
    public List<WorkOffsetsEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
