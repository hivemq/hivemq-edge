 ...
 * 
 * <p>Java class for LibraryDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LibraryDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}LibraryEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LibraryDataSetType")
@XmlType(name = "LibraryDataSetType", propOrder = {
    "entry"
})
public class LibraryDataSetType
    extends EventType
{
    ...
    protected List<LibraryEntryType> entry;
    /**
     ...
     */
    public List<LibraryEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
