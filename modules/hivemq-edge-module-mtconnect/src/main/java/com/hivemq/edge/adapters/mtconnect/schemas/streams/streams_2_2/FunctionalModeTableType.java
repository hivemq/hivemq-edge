 ...
 * 
 * <p>Java class for FunctionalModeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FunctionalModeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}FunctionalModeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FunctionalModeTableType")
@XmlType(name = "FunctionalModeTableType", propOrder = {
    "entry"
})
public class FunctionalModeTableType
    extends EventType
{
    ...
    protected List<FunctionalModeTableEntryType> entry;
    /**
     ...
     * {@link FunctionalModeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<FunctionalModeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
