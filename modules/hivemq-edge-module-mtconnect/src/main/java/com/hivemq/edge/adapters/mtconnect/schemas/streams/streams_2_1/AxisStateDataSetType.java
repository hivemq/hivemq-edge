 ...
 * 
 * <p>Java class for AxisStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AxisStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AxisStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AxisStateDataSetType")
@XmlType(name = "AxisStateDataSetType", propOrder = {
    "entry"
})
public class AxisStateDataSetType
    extends EventType
{
    ...
    protected List<AxisStateEntryType> entry;
    /**
     ...
     */
    public List<AxisStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
