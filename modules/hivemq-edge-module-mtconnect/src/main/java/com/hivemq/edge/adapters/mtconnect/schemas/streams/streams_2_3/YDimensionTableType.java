 ...
 * 
 * <p>Java class for YDimensionTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="YDimensionTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}YDimensionTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "YDimensionTableType")
@XmlType(name = "YDimensionTableType", propOrder = {
    "entry"
})
public class YDimensionTableType
    extends EventType
{
    ...
    protected List<YDimensionTableEntryType> entry;
    /**
     ...
     */
    public List<YDimensionTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
