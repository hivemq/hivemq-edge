 ...
 * 
 * <p>Java class for MaterialLoadTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialLoadTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}MaterialLoadTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialLoadTableType")
@XmlType(name = "MaterialLoadTableType", propOrder = {
    "entry"
})
public class MaterialLoadTableType
    extends EventType
{
    ...
    protected List<MaterialLoadTableEntryType> entry;
    /**
     ...
     * {@link MaterialLoadTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MaterialLoadTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
