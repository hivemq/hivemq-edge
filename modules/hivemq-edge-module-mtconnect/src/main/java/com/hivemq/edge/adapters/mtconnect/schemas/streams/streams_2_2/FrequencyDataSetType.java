 ...
 * 
 * <p>Java class for FrequencyDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FrequencyDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}FrequencyEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FrequencyDataSetType")
@XmlType(name = "FrequencyDataSetType", propOrder = {
    "entry"
})
public class FrequencyDataSetType
    extends EventType
{
    ...
    protected List<FrequencyEntryType> entry;
    /**
     ...
     */
    public List<FrequencyEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
