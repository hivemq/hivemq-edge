 ...
 * 
 * <p>Java class for ConcentrationDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ConcentrationDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ConcentrationEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ConcentrationDataSetType")
@XmlType(name = "ConcentrationDataSetType", propOrder = {
    "entry"
})
public class ConcentrationDataSetType
    extends EventType
{
    ...
    protected List<ConcentrationEntryType> entry;
    /**
     ...
     */
    public List<ConcentrationEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
