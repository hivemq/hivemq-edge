 ...
 * 
 * <p>Java class for SettlingErrorDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SettlingErrorDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}SettlingErrorEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SettlingErrorDataSetType")
@XmlType(name = "SettlingErrorDataSetType", propOrder = {
    "entry"
})
public class SettlingErrorDataSetType
    extends EventType
{
    ...
    protected List<SettlingErrorEntryType> entry;
    /**
     ...
     */
    public List<SettlingErrorEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
