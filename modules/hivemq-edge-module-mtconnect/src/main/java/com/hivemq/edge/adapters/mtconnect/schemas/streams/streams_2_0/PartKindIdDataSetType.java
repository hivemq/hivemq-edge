 ...
 * 
 * <p>Java class for PartKindIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartKindIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}PartKindIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartKindIdDataSetType")
@XmlType(name = "PartKindIdDataSetType", propOrder = {
    "entry"
})
public class PartKindIdDataSetType
    extends EventType
{
    ...
    protected List<PartKindIdEntryType> entry;
    /**
     ...
     */
    public List<PartKindIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
