 ...
 * 
 * <p>Java class for PartCountTypeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartCountTypeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}PartCountTypeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartCountTypeDataSetType")
@XmlType(name = "PartCountTypeDataSetType", propOrder = {
    "entry"
})
public class PartCountTypeDataSetType
    extends EventType
{
    ...
    protected List<PartCountTypeEntryType> entry;
    /**
     ...
     */
    public List<PartCountTypeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
