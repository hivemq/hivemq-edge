 ...
 * 
 * <p>Java class for DeviceRemovedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceRemovedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}DeviceRemovedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceRemovedDataSetType")
@XmlType(name = "DeviceRemovedDataSetType", propOrder = {
    "entry"
})
public class DeviceRemovedDataSetType
    extends EventType
{
    ...
    protected List<DeviceRemovedEntryType> entry;
    /**
     ...
     */
    public List<DeviceRemovedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
