...
/**
 * {{block(Parts)}} {{termplural(organize)}} information for
 *         {{termplural(Part)}} being processed by a piece of equipment.
 * 
 * <p>Java class for PartsType complex type</p>.
 * 
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartsType")
@XmlType(name = "PartsType")
