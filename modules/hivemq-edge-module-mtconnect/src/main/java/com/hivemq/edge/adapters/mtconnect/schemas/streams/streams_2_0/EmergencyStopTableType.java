 ...
 * 
 * <p>Java class for EmergencyStopTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EmergencyStopTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}EmergencyStopTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EmergencyStopTableType")
@XmlType(name = "EmergencyStopTableType", propOrder = {
    "entry"
})
public class EmergencyStopTableType
    extends EventType
{
    ...
    protected List<EmergencyStopTableEntryType> entry;
    /**
     ...
     * {@link EmergencyStopTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<EmergencyStopTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
