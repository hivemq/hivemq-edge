 ...
 * 
 * <p>Java class for BatteryChargeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BatteryChargeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}BatteryChargeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BatteryChargeDataSetType")
@XmlType(name = "BatteryChargeDataSetType", propOrder = {
    "entry"
})
public class BatteryChargeDataSetType
    extends EventType
{
    ...
    protected List<BatteryChargeEntryType> entry;
    /**
     ...
     */
    public List<BatteryChargeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
