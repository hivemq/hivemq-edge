 ...
 * 
 * <p>Java class for ControlLimitDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ControlLimitDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ControlLimitEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ControlLimitDataSetType")
@XmlType(name = "ControlLimitDataSetType", propOrder = {
    "entry"
})
public class ControlLimitDataSetType
    extends EventType
{
    ...
    protected List<ControlLimitEntryType> entry;
    /**
     ...
     */
    public List<ControlLimitEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
