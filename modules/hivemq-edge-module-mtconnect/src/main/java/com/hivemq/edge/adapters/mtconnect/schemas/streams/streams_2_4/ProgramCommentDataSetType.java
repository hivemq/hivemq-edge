 ...
 * 
 * <p>Java class for ProgramCommentDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramCommentDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ProgramCommentEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramCommentDataSetType")
@XmlType(name = "ProgramCommentDataSetType", propOrder = {
    "entry"
})
public class ProgramCommentDataSetType
    extends EventType
{
    ...
    protected List<ProgramCommentEntryType> entry;
    /**
     ...
     */
    public List<ProgramCommentEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
