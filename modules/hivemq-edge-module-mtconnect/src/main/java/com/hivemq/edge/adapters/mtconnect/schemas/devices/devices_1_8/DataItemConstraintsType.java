 ...
 *         <choice minOccurs="0">
 *           <sequence>
 *             <element name="Value" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemValueElementType" maxOccurs="unbounded"/>
 *           </sequence>
 *           <sequence>
 *             <element name="Minimum" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemNumericValueType" minOccurs="0"/>
 *             <element name="Maximum" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemNumericValueType" minOccurs="0"/>
 *             <element name="Nominal" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemNumericValueType" minOccurs="0"/>
 *           </sequence>
 *         </choice>
 *         <element name="Filter" type="{urn:mtconnect.org:MTConnectDevices:1.8}DataItemFilterType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class DataItemConstraintsType {
    ...
    /**
     * {{property(Value)}} represents a single data value that is
     *                 expected to be reported for a {{block(DataItem)}} element.
     *                 {{property(Value)}} **MUST NOT** be used in conjunction with any
     *                 other {{block(Constraint)}} elements.
     * 
     */
