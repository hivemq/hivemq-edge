 ...
 * 
 * <p>Java class for AssetCountDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AssetCountDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}AssetCountEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AssetCountDataSetType")
@XmlType(name = "AssetCountDataSetType", propOrder = {
    "entry"
})
public class AssetCountDataSetType
    extends EventType
{
    ...
    protected List<AssetCountEntryType> entry;
    /**
     ...
     */
    public List<AssetCountEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
