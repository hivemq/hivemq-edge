 ...
 * 
 * <p>Java class for DeviceUuidTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceUuidTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}DeviceUuidTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceUuidTableType")
@XmlType(name = "DeviceUuidTableType", propOrder = {
    "entry"
})
public class DeviceUuidTableType
    extends EventType
{
    ...
    protected List<DeviceUuidTableEntryType> entry;
    /**
     ...
     */
    public List<DeviceUuidTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
