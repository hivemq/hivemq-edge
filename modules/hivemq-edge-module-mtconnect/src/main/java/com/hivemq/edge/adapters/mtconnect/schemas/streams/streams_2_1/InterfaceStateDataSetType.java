 ...
 * 
 * <p>Java class for InterfaceStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="InterfaceStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}InterfaceStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "InterfaceStateDataSetType")
@XmlType(name = "InterfaceStateDataSetType", propOrder = {
    "entry"
})
public class InterfaceStateDataSetType
    extends EventType
{
    ...
    protected List<InterfaceStateEntryType> entry;
    /**
     ...
     */
    public List<InterfaceStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
