 ...
 * 
 * <p>Java class for OpenChuckTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OpenChuckTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}OpenChuckTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OpenChuckTableType")
@XmlType(name = "OpenChuckTableType", propOrder = {
    "entry"
})
public class OpenChuckTableType
    extends EventType
{
    ...
    protected List<OpenChuckTableEntryType> entry;
    /**
     ...
     */
    public List<OpenChuckTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
