 ...
 *       <attribute name="key" use="required" type="{urn:mtconnect.org:MTConnectStreams:2.4}KeyType" />
 *       <attribute name="removed" type="{urn:mtconnect.org:MTConnectStreams:2.4}RemovedType" />
 *     </restriction>
 *   </complexContent>
 * </complexType>
 * }</pre>
...
@XmlSeeAlso({
    ...
    AlarmLimitsEntryType.class,
    ControlLimitsEntryType.class,
    SpecificationLimitsEntryType.class,
    ToolCuttingItemEntryType.class,
    LocationAddressEntryType.class,
    ActivePowerSourceEntryType.class,
    LocationNarrativeEntryType.class,
    ThicknessEntryType.class,
    LocationSpatialGeographicEntryType.class,
    ...
    AlarmLimitsTableEntryType.class,
    ControlLimitsTableEntryType.class,
    SpecificationLimitsTableEntryType.class,
    ToolCuttingItemTableEntryType.class,
    LocationAddressTableEntryType.class,
    ActivePowerSourceTableEntryType.class,
    LocationNarrativeTableEntryType.class,
    ThicknessTableEntryType.class,
    LocationSpatialGeographicTableEntryType.class,
