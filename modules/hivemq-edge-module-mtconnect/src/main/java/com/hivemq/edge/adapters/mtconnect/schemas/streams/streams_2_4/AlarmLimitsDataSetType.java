 ...
 * 
 * <p>Java class for AlarmLimitsDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AlarmLimitsDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AlarmLimitsEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AlarmLimitsDataSetType")
@XmlType(name = "AlarmLimitsDataSetType", propOrder = {
    "entry"
})
public class AlarmLimitsDataSetType
    extends EventType
{
    ...
    protected List<AlarmLimitsEntryType> entry;
    /**
     ...
     */
    public List<AlarmLimitsEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
