 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}RotaryVelocityOverrideEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@XmlType(name = "RotaryVelocityOverrideDataSetType", propOrder = {
    "entry"
})
    ...
    extends EventType
{
    ...
    protected List<RotaryVelocityOverrideEntryType> entry;
    /**
     ...
     * {@link RotaryVelocityOverrideEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<RotaryVelocityOverrideEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
