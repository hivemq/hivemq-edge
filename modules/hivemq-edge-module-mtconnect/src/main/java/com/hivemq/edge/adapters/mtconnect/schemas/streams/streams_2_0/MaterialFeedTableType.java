 ...
 * 
 * <p>Java class for MaterialFeedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialFeedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}MaterialFeedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialFeedTableType")
@XmlType(name = "MaterialFeedTableType", propOrder = {
    "entry"
})
public class MaterialFeedTableType
    extends EventType
{
    ...
    protected List<MaterialFeedTableEntryType> entry;
    /**
     ...
     * {@link MaterialFeedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<MaterialFeedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
