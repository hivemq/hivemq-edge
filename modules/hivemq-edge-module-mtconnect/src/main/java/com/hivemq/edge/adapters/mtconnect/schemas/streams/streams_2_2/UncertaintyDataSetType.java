 ...
 * 
 * <p>Java class for UncertaintyDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="UncertaintyDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}UncertaintyEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "UncertaintyDataSetType")
@XmlType(name = "UncertaintyDataSetType", propOrder = {
    "entry"
})
public class UncertaintyDataSetType
    extends EventType
{
    ...
    protected List<UncertaintyEntryType> entry;
    /**
     ...
     */
    public List<UncertaintyEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
