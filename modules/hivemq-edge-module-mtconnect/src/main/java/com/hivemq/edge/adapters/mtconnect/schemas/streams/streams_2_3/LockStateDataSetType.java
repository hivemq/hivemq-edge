 ...
 * 
 * <p>Java class for LockStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LockStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}LockStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LockStateDataSetType")
@XmlType(name = "LockStateDataSetType", propOrder = {
    "entry"
})
public class LockStateDataSetType
    extends EventType
{
    ...
    protected List<LockStateEntryType> entry;
    /**
     ...
     */
    public List<LockStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
