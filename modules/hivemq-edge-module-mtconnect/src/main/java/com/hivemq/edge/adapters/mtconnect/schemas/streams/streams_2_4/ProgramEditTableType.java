 ...
 * 
 * <p>Java class for ProgramEditTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramEditTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ProgramEditTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramEditTableType")
@XmlType(name = "ProgramEditTableType", propOrder = {
    "entry"
})
public class ProgramEditTableType
    extends EventType
{
    ...
    protected List<ProgramEditTableEntryType> entry;
    /**
     ...
     * {@link ProgramEditTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProgramEditTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
