 ...
 * 
 * <p>Java class for LocationAddressDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LocationAddressDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}LocationAddressEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LocationAddressDataSetType")
@XmlType(name = "LocationAddressDataSetType", propOrder = {
    "entry"
})
public class LocationAddressDataSetType
    extends EventType
{
    ...
    protected List<LocationAddressEntryType> entry;
    /**
     ...
     */
    public List<LocationAddressEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
