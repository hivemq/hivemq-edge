 ...
 *       <all>
 *         <element name="Destination" type="{urn:mtconnect.org:MTConnectAssets:1.8}FileDestinationType" maxOccurs="unbounded"/>
 *       </all>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class FileDestinationsType {
    ...
    /**
     * The {{block(Destination)}} is a reference to the target
     *             {{block(Device)}} for this {{block(File)}}.
     * 
     */
