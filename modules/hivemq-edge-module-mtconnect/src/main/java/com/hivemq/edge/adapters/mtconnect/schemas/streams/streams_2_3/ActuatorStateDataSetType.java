 ...
 * 
 * <p>Java class for ActuatorStateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ActuatorStateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ActuatorStateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ActuatorStateDataSetType")
@XmlType(name = "ActuatorStateDataSetType", propOrder = {
    "entry"
})
public class ActuatorStateDataSetType
    extends EventType
{
    ...
    protected List<ActuatorStateEntryType> entry;
    /**
     ...
     */
    public List<ActuatorStateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
