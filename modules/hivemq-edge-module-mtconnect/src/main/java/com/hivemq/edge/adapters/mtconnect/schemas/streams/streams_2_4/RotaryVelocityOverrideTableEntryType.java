 ...
 *       <sequence>
 *         <element name="Cell" type="{urn:mtconnect.org:MTConnectStreams:2.4}RotaryVelocityOverrideCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "RotaryVelocityOverrideTableEntryType", propOrder = {
    "cell"
})
    ...
    extends EntryType
{
    ...
    protected List<RotaryVelocityOverrideCellType> cell;
     ...
     * {@link RotaryVelocityOverrideCellType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<RotaryVelocityOverrideCellType> getCell() {
        if (cell == null) {
            cell = new ArrayList<>();
        }
        return this.cell;
