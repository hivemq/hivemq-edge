 ...
 * 
 * <p>Java class for ToolOffsetDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolOffsetDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ToolOffsetEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolOffsetDataSetType")
@XmlType(name = "ToolOffsetDataSetType", propOrder = {
    "entry"
})
public class ToolOffsetDataSetType
    extends EventType
{
    ...
    protected List<ToolOffsetEntryType> entry;
    /**
     ...
     */
    public List<ToolOffsetEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
