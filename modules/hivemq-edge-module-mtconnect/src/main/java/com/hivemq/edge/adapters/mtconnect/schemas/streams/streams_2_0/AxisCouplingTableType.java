 ...
 * 
 * <p>Java class for AxisCouplingTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AxisCouplingTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}AxisCouplingTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AxisCouplingTableType")
@XmlType(name = "AxisCouplingTableType", propOrder = {
    "entry"
})
public class AxisCouplingTableType
    extends EventType
{
    ...
    protected List<AxisCouplingTableEntryType> entry;
    /**
     ...
     * {@link AxisCouplingTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AxisCouplingTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
