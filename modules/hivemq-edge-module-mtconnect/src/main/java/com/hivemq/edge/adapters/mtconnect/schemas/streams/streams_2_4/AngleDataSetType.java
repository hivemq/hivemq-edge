 ...
 * 
 * <p>Java class for AngleDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AngleDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AngleEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AngleDataSetType")
@XmlType(name = "AngleDataSetType", propOrder = {
    "entry"
})
public class AngleDataSetType
    extends EventType
{
    ...
    protected List<AngleEntryType> entry;
    /**
     ...
     */
    public List<AngleEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
