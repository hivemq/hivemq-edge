 ...
 * 
 * <p>Java class for FixtureIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FixtureIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}FixtureIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FixtureIdDataSetType")
@XmlType(name = "FixtureIdDataSetType", propOrder = {
    "entry"
})
public class FixtureIdDataSetType
    extends EventType
{
    ...
    protected List<FixtureIdEntryType> entry;
    /**
     ...
     */
    public List<FixtureIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
