 ...
 * 
 * <p>Java class for AmperageACDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AmperageACDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}AmperageACEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AmperageACDataSetType")
@XmlType(name = "AmperageACDataSetType", propOrder = {
    "entry"
})
public class AmperageACDataSetType
    extends EventType
{
    ...
    protected List<AmperageACEntryType> entry;
    /**
     ...
     */
    public List<AmperageACEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
