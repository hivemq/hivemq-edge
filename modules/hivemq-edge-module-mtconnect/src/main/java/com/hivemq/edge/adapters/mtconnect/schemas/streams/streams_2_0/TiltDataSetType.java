 ...
 * 
 * <p>Java class for TiltDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TiltDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}TiltEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TiltDataSetType")
@XmlType(name = "TiltDataSetType", propOrder = {
    "entry"
})
public class TiltDataSetType
    extends EventType
{
    ...
    protected List<TiltEntryType> entry;
    /**
     ...
     */
    public List<TiltEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
