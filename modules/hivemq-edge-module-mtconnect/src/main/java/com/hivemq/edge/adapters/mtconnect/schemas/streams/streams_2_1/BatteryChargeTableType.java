 ...
 * 
 * <p>Java class for BatteryChargeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BatteryChargeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}BatteryChargeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BatteryChargeTableType")
@XmlType(name = "BatteryChargeTableType", propOrder = {
    "entry"
})
public class BatteryChargeTableType
    extends EventType
{
    ...
    protected List<BatteryChargeTableEntryType> entry;
    /**
     ...
     * {@link BatteryChargeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<BatteryChargeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
