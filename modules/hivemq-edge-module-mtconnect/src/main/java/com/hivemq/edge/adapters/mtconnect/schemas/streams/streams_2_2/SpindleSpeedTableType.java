 ...
 * 
 * <p>Java class for SpindleSpeedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SpindleSpeedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}SpindleSpeedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SpindleSpeedTableType")
@XmlType(name = "SpindleSpeedTableType", propOrder = {
    "entry"
})
public class SpindleSpeedTableType
    extends EventType
{
    ...
    protected List<SpindleSpeedTableEntryType> entry;
    /**
     ...
     * {@link SpindleSpeedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<SpindleSpeedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
