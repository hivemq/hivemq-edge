 ...
 * 
 * <p>Java class for ZDimensionTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ZDimensionTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ZDimensionTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ZDimensionTableType")
@XmlType(name = "ZDimensionTableType", propOrder = {
    "entry"
})
public class ZDimensionTableType
    extends EventType
{
    ...
    protected List<ZDimensionTableEntryType> entry;
    /**
     ...
     */
    public List<ZDimensionTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
