 ...
 * 
 * <p>Java class for ChargeRateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ChargeRateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}ChargeRateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ChargeRateTableType")
@XmlType(name = "ChargeRateTableType", propOrder = {
    "entry"
})
public class ChargeRateTableType
    extends EventType
{
    ...
    protected List<ChargeRateTableEntryType> entry;
    /**
     ...
     */
    public List<ChargeRateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
