 ...
 * 
 * <p>Java class for TensionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TensionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}TensionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TensionDataSetType")
@XmlType(name = "TensionDataSetType", propOrder = {
    "entry"
})
public class TensionDataSetType
    extends EventType
{
    ...
    protected List<TensionEntryType> entry;
    /**
     ...
     */
    public List<TensionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
