 ...
 * 
 * <p>Java class for CoupledAxesDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CoupledAxesDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}CoupledAxesEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CoupledAxesDataSetType")
@XmlType(name = "CoupledAxesDataSetType", propOrder = {
    "entry"
})
public class CoupledAxesDataSetType
    extends EventType
{
    ...
    protected List<CoupledAxesEntryType> entry;
    /**
     ...
     */
    public List<CoupledAxesEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
