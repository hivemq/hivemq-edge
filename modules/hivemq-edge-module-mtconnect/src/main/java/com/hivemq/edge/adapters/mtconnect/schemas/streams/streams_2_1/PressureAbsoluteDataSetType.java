 ...
 * 
 * <p>Java class for PressureAbsoluteDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PressureAbsoluteDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}PressureAbsoluteEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PressureAbsoluteDataSetType")
@XmlType(name = "PressureAbsoluteDataSetType", propOrder = {
    "entry"
})
public class PressureAbsoluteDataSetType
    extends EventType
{
    ...
    protected List<PressureAbsoluteEntryType> entry;
    /**
     ...
     * {@link PressureAbsoluteEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<PressureAbsoluteEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
