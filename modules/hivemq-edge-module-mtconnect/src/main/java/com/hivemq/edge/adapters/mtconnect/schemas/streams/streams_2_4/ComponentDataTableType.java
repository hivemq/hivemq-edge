 ...
 *         {{block(Definition)}}.
 * 
 * <p>Java class for ComponentDataTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ComponentDataTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ComponentDataTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ComponentDataTableType")
@XmlType(name = "ComponentDataTableType", propOrder = {
    "entry"
})
public class ComponentDataTableType
    extends EventType
{
    ...
    protected List<ComponentDataTableEntryType> entry;
    /**
     ...
     * {@link ComponentDataTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ComponentDataTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
