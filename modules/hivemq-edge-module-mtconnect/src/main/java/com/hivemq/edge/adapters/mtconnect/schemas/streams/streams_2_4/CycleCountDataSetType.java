 ...
 * 
 * <p>Java class for CycleCountDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CycleCountDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}CycleCountEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CycleCountDataSetType")
@XmlType(name = "CycleCountDataSetType", propOrder = {
    "entry"
})
public class CycleCountDataSetType
    extends EventType
{
    ...
    protected List<CycleCountEntryType> entry;
    /**
     ...
     */
    public List<CycleCountEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
