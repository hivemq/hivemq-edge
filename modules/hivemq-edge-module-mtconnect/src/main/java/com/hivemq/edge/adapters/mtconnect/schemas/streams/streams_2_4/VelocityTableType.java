 ...
 * 
 * <p>Java class for VelocityTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VelocityTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}VelocityTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VelocityTableType")
@XmlType(name = "VelocityTableType", propOrder = {
    "entry"
})
public class VelocityTableType
    extends EventType
{
    ...
    protected List<VelocityTableEntryType> entry;
    /**
     ...
     */
    public List<VelocityTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
