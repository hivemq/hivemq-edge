 ...
 * 
 * <p>Java class for VolumeSpatialDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VolumeSpatialDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}VolumeSpatialEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VolumeSpatialDataSetType")
@XmlType(name = "VolumeSpatialDataSetType", propOrder = {
    "entry"
})
public class VolumeSpatialDataSetType
    extends EventType
{
    ...
    protected List<VolumeSpatialEntryType> entry;
    /**
     ...
     */
    public List<VolumeSpatialEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
