 ...
 * 
 * <p>Java class for AssetRemovedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AssetRemovedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}AssetRemovedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AssetRemovedTableType")
@XmlType(name = "AssetRemovedTableType", propOrder = {
    "entry"
})
public class AssetRemovedTableType
    extends EventType
{
    ...
    protected List<AssetRemovedTableEntryType> entry;
    /**
     ...
     * {@link AssetRemovedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AssetRemovedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
