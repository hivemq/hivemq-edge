 ...
 * 
 * <p>Java class for LineLabelDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LineLabelDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}LineLabelEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LineLabelDataSetType")
@XmlType(name = "LineLabelDataSetType", propOrder = {
    "entry"
})
public class LineLabelDataSetType
    extends EventType
{
    ...
    protected List<LineLabelEntryType> entry;
    /**
     ...
     */
    public List<LineLabelEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
