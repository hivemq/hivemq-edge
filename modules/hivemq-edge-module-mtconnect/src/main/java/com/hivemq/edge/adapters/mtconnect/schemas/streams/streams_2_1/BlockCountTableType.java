 ...
 * 
 * <p>Java class for BlockCountTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BlockCountTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}BlockCountTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BlockCountTableType")
@XmlType(name = "BlockCountTableType", propOrder = {
    "entry"
})
public class BlockCountTableType
    extends EventType
{
    ...
    protected List<BlockCountTableEntryType> entry;
    /**
     ...
     */
    public List<BlockCountTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
