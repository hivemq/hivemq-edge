 ...
 * 
 * <p>Java class for TemperatureDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="TemperatureDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}TemperatureEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "TemperatureDataSetType")
@XmlType(name = "TemperatureDataSetType", propOrder = {
    "entry"
})
public class TemperatureDataSetType
    extends EventType
{
    ...
    protected List<TemperatureEntryType> entry;
    /**
     ...
     */
    public List<TemperatureEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
