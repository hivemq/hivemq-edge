 ...
 * 
 * <p>Java class for WorkOffsetsTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WorkOffsetsTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}WorkOffsetsTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WorkOffsetsTableType")
@XmlType(name = "WorkOffsetsTableType", propOrder = {
    "entry"
})
public class WorkOffsetsTableType
    extends EventType
{
    ...
    protected List<WorkOffsetsTableEntryType> entry;
    /**
     ...
     * {@link WorkOffsetsTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<WorkOffsetsTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
