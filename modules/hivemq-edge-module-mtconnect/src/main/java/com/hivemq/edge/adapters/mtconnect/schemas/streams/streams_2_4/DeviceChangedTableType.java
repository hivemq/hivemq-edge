 ...
 * 
 * <p>Java class for DeviceChangedTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceChangedTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}DeviceChangedTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceChangedTableType")
@XmlType(name = "DeviceChangedTableType", propOrder = {
    "entry"
})
public class DeviceChangedTableType
    extends EventType
{
    ...
    protected List<DeviceChangedTableEntryType> entry;
    /**
     ...
     * {@link DeviceChangedTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DeviceChangedTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
