 ...
 * 
 * <p>Java class for PathFeedrateDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PathFeedrateDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}PathFeedrateEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PathFeedrateDataSetType")
@XmlType(name = "PathFeedrateDataSetType", propOrder = {
    "entry"
})
public class PathFeedrateDataSetType
    extends EventType
{
    ...
    protected List<PathFeedrateEntryType> entry;
    /**
     ...
     */
    public List<PathFeedrateEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
