 ...
 * 
 * <p>Java class for ActuatorStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ActuatorStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ActuatorStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ActuatorStateTableType")
@XmlType(name = "ActuatorStateTableType", propOrder = {
    "entry"
})
public class ActuatorStateTableType
    extends EventType
{
    ...
    protected List<ActuatorStateTableEntryType> entry;
    /**
     ...
     * {@link ActuatorStateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ActuatorStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
