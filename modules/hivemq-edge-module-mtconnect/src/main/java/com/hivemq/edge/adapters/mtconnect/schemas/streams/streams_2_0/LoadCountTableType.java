 ...
 * 
 * <p>Java class for LoadCountTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LoadCountTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}LoadCountTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LoadCountTableType")
@XmlType(name = "LoadCountTableType", propOrder = {
    "entry"
})
public class LoadCountTableType
    extends EventType
{
    ...
    protected List<LoadCountTableEntryType> entry;
    /**
     ...
     */
    public List<LoadCountTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
