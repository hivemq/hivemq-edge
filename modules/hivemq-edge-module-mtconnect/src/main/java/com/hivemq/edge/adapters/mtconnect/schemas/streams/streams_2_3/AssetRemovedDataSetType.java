 ...
 * 
 * <p>Java class for AssetRemovedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AssetRemovedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}AssetRemovedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AssetRemovedDataSetType")
@XmlType(name = "AssetRemovedDataSetType", propOrder = {
    "entry"
})
public class AssetRemovedDataSetType
    extends EventType
{
    ...
    protected List<AssetRemovedEntryType> entry;
    /**
     ...
     */
    public List<AssetRemovedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
