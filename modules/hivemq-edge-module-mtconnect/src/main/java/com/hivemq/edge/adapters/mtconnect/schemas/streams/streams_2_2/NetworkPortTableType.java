 ...
 * 
 * <p>Java class for NetworkPortTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="NetworkPortTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}NetworkPortTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "NetworkPortTableType")
@XmlType(name = "NetworkPortTableType", propOrder = {
    "entry"
})
public class NetworkPortTableType
    extends EventType
{
    ...
    protected List<NetworkPortTableEntryType> entry;
    /**
     ...
     * {@link NetworkPortTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<NetworkPortTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
