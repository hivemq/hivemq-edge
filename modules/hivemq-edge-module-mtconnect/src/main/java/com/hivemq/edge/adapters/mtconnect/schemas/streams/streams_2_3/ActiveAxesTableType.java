 ...
 * 
 * <p>Java class for ActiveAxesTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ActiveAxesTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ActiveAxesTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ActiveAxesTableType")
@XmlType(name = "ActiveAxesTableType", propOrder = {
    "entry"
})
public class ActiveAxesTableType
    extends EventType
{
    ...
    protected List<ActiveAxesTableEntryType> entry;
    /**
     ...
     */
    public List<ActiveAxesTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
