 ...
 *       <all>
 *         <element name="FileProperties" type="{urn:mtconnect.org:MTConnectAssets:2.4}FilePropertiesType" minOccurs="0"/>
 *         <element name="FileComments" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileCommentsType" minOccurs="0"/>
 *         <element name="FileLocation" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileLocationType"/>
 *         <element name="Signature" type="{urn:mtconnect.org:MTConnectAssets:2.4}SignatureType" minOccurs="0"/>
 *         <element name="PublicKey" type="{urn:mtconnect.org:MTConnectAssets:2.4}PublicKeyType" minOccurs="0"/>
 *         <element name="Destinations" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileDestinationsType" minOccurs="0"/>
 *         <element name="CreationTime" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileTimeType"/>
 *         <element name="ModificationTime" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileTimeType" minOccurs="0"/>
 *       </all>
 *       <attribute name="name" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileNameType" />
 *       <attribute name="mediaType" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileMimeTypeType" />
 *       <attribute name="applicationCategory" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.4}ApplicationCategoryType" />
 *       <attribute name="applicationType" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.4}ApplicationTypeType" />
 *       <attribute name="size" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileSizeType" />
 *       <attribute name="versionId" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.4}VersionIdType" />
 *       <attribute name="state" use="required" type="{urn:mtconnect.org:MTConnectAssets:2.4}FileStateType" />
 *     </extension>
 *   </complexContent>
 * </complexType>
 * }</pre>
