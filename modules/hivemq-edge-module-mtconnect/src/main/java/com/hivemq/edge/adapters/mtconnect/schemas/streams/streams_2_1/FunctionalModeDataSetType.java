 ...
 * 
 * <p>Java class for FunctionalModeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FunctionalModeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}FunctionalModeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FunctionalModeDataSetType")
@XmlType(name = "FunctionalModeDataSetType", propOrder = {
    "entry"
})
public class FunctionalModeDataSetType
    extends EventType
{
    ...
    protected List<FunctionalModeEntryType> entry;
    /**
     ...
     */
    public List<FunctionalModeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
