...
/**
 * {{block(CuttingToolArchetypeReference)}} has reference information about
 *         the {{property(assetId)}} and/or the URL of the data source of
 *         {{block(CuttingToolArchetype)}}.
 * 
 ...
 *   <simpleContent>
 *     <extension base="<urn:mtconnect.org:MTConnectAssets:1.7>AssetIdType">
 *       <attribute name="source" type="{urn:mtconnect.org:MTConnectAssets:1.7}SourceType" />
 *     </extension>
 *   </simpleContent>
 * </complexType>
 * }</pre>
...
public class CuttingToolArchetypeReferenceType {
     ...
     *               {{block(DataItem)}}, or {{block(Composition)}} representing the
     *               area of the piece of equipment from which a measured value
     *               originates.
     * 
     */
