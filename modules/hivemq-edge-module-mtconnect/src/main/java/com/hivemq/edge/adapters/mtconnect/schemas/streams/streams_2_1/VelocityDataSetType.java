 ...
 * 
 * <p>Java class for VelocityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="VelocityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}VelocityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "VelocityDataSetType")
@XmlType(name = "VelocityDataSetType", propOrder = {
    "entry"
})
public class VelocityDataSetType
    extends EventType
{
    ...
    protected List<VelocityEntryType> entry;
    /**
     ...
     */
    public List<VelocityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
