 ...
 * 
 * <p>Java class for PartCountTypeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartCountTypeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}PartCountTypeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartCountTypeTableType")
@XmlType(name = "PartCountTypeTableType", propOrder = {
    "entry"
})
public class PartCountTypeTableType
    extends EventType
{
    ...
    protected List<PartCountTypeTableEntryType> entry;
    /**
     ...
     * {@link PartCountTypeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<PartCountTypeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
