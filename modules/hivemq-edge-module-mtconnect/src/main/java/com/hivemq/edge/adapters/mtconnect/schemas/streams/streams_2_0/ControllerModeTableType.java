 ...
 * 
 * <p>Java class for ControllerModeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ControllerModeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ControllerModeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ControllerModeTableType")
@XmlType(name = "ControllerModeTableType", propOrder = {
    "entry"
})
public class ControllerModeTableType
    extends EventType
{
    ...
    protected List<ControllerModeTableEntryType> entry;
    /**
     ...
     * {@link ControllerModeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ControllerModeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
