 ...
 * 
 * <p>Java class for PalletIdTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PalletIdTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}PalletIdTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PalletIdTableType")
@XmlType(name = "PalletIdTableType", propOrder = {
    "entry"
})
public class PalletIdTableType
    extends EventType
{
    ...
    protected List<PalletIdTableEntryType> entry;
    /**
     ...
     */
    public List<PalletIdTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
