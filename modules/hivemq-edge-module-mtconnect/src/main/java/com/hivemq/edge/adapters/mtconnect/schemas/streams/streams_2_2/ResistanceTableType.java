 ...
 * 
 * <p>Java class for ResistanceTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ResistanceTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ResistanceTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ResistanceTableType")
@XmlType(name = "ResistanceTableType", propOrder = {
    "entry"
})
public class ResistanceTableType
    extends EventType
{
    ...
    protected List<ResistanceTableEntryType> entry;
    /**
     ...
     */
    public List<ResistanceTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
