 ...
 * 
 * <p>Java class for PartCountTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartCountTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}PartCountTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartCountTableType")
@XmlType(name = "PartCountTableType", propOrder = {
    "entry"
})
public class PartCountTableType
    extends EventType
{
    ...
    protected List<PartCountTableEntryType> entry;
    /**
     ...
     */
    public List<PartCountTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
