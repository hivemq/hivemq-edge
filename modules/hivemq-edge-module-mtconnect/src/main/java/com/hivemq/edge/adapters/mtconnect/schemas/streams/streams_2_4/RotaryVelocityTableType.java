 ...
 * 
 * <p>Java class for RotaryVelocityTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RotaryVelocityTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}RotaryVelocityTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "RotaryVelocityTableType")
@XmlType(name = "RotaryVelocityTableType", propOrder = {
    "entry"
})
public class RotaryVelocityTableType
    extends EventType
{
    ...
    protected List<RotaryVelocityTableEntryType> entry;
    /**
     ...
     * {@link RotaryVelocityTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<RotaryVelocityTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
