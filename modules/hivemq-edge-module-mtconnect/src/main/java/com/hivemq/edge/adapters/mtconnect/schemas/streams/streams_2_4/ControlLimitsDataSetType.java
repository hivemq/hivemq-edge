 ...
 * 
 * <p>Java class for ControlLimitsDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ControlLimitsDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ControlLimitsEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ControlLimitsDataSetType")
@XmlType(name = "ControlLimitsDataSetType", propOrder = {
    "entry"
})
public class ControlLimitsDataSetType
    extends EventType
{
    ...
    protected List<ControlLimitsEntryType> entry;
    /**
     ...
     */
    public List<ControlLimitsEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
