 ...
 * 
 * <p>Java class for HardwareTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HardwareTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}HardwareTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "HardwareTableType")
@XmlType(name = "HardwareTableType", propOrder = {
    "entry"
})
public class HardwareTableType
    extends EventType
{
    ...
    protected List<HardwareTableEntryType> entry;
    /**
     ...
     */
    public List<HardwareTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
