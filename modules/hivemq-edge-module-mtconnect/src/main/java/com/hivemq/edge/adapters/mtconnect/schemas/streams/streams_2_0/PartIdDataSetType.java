 ...
 * 
 * <p>Java class for PartIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}PartIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartIdDataSetType")
@XmlType(name = "PartIdDataSetType", propOrder = {
    "entry"
})
public class PartIdDataSetType
    extends EventType
{
    ...
    protected List<PartIdEntryType> entry;
    /**
     ...
     */
    public List<PartIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
