 ...
 * 
 * <p>Java class for ProcessTimerTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProcessTimerTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ProcessTimerTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProcessTimerTableType")
@XmlType(name = "ProcessTimerTableType", propOrder = {
    "entry"
})
public class ProcessTimerTableType
    extends EventType
{
    ...
    protected List<ProcessTimerTableEntryType> entry;
    /**
     ...
     * {@link ProcessTimerTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ProcessTimerTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
