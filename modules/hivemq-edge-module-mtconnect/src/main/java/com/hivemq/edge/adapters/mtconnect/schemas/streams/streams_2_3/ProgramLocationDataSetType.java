 ...
 * 
 * <p>Java class for ProgramLocationDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramLocationDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ProgramLocationEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramLocationDataSetType")
@XmlType(name = "ProgramLocationDataSetType", propOrder = {
    "entry"
})
public class ProgramLocationDataSetType
    extends EventType
{
    ...
    protected List<ProgramLocationEntryType> entry;
    /**
     ...
     */
    public List<ProgramLocationEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
