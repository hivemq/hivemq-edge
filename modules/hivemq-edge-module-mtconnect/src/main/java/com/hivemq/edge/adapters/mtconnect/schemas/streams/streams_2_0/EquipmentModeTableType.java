 ...
 * 
 * <p>Java class for EquipmentModeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EquipmentModeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}EquipmentModeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "EquipmentModeTableType")
@XmlType(name = "EquipmentModeTableType", propOrder = {
    "entry"
})
public class EquipmentModeTableType
    extends EventType
{
    ...
    protected List<EquipmentModeTableEntryType> entry;
    /**
     ...
     * {@link EquipmentModeTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<EquipmentModeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
