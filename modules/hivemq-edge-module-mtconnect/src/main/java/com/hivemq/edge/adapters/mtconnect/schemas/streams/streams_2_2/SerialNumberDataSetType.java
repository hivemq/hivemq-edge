 ...
 * 
 * <p>Java class for SerialNumberDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="SerialNumberDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}SerialNumberEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "SerialNumberDataSetType")
@XmlType(name = "SerialNumberDataSetType", propOrder = {
    "entry"
})
public class SerialNumberDataSetType
    extends EventType
{
    ...
    protected List<SerialNumberEntryType> entry;
    /**
     ...
     */
    public List<SerialNumberEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
