 ...
 * 
 * <p>Java class for AmperageACTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AmperageACTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AmperageACTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AmperageACTableType")
@XmlType(name = "AmperageACTableType", propOrder = {
    "entry"
})
public class AmperageACTableType
    extends EventType
{
    ...
    protected List<AmperageACTableEntryType> entry;
    /**
     ...
     */
    public List<AmperageACTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
