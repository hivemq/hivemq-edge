...
/**
 * DataSet of {{block(Composition)}} composed of a string like piece or
 *         filament of relatively rigid or flexible material provided in a variety
 *         of diameters.
 * 
 * <p>Java class for WireDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="WireDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}WireEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "WireDataSetType")
@XmlType(name = "WireDataSetType", propOrder = {
    "entry"
})
public class WireDataSetType
    extends EventType
{
    ...
    protected List<WireEntryType> entry;
    /**
     ...
     */
    public List<WireEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
