 ...
 * 
 * <p>Java class for CuttingSpeedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CuttingSpeedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}CuttingSpeedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CuttingSpeedDataSetType")
@XmlType(name = "CuttingSpeedDataSetType", propOrder = {
    "entry"
})
public class CuttingSpeedDataSetType
    extends EventType
{
    ...
    protected List<CuttingSpeedEntryType> entry;
    /**
     ...
     */
    public List<CuttingSpeedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
