 ...
 * 
 * <p>Java class for CapacityFluidDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CapacityFluidDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}CapacityFluidEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CapacityFluidDataSetType")
@XmlType(name = "CapacityFluidDataSetType", propOrder = {
    "entry"
})
public class CapacityFluidDataSetType
    extends EventType
{
    ...
    protected List<CapacityFluidEntryType> entry;
    /**
     ...
     */
    public List<CapacityFluidEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
