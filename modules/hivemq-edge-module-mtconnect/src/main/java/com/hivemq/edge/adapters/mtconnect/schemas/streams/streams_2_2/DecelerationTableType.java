 ...
 * 
 * <p>Java class for DecelerationTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DecelerationTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}DecelerationTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DecelerationTableType")
@XmlType(name = "DecelerationTableType", propOrder = {
    "entry"
})
public class DecelerationTableType
    extends EventType
{
    ...
    protected List<DecelerationTableEntryType> entry;
    /**
     ...
     * {@link DecelerationTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DecelerationTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
