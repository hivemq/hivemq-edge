 ...
 * 
 * <p>Java class for YDimensionDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="YDimensionDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}YDimensionEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "YDimensionDataSetType")
@XmlType(name = "YDimensionDataSetType", propOrder = {
    "entry"
})
public class YDimensionDataSetType
    extends EventType
{
    ...
    protected List<YDimensionEntryType> entry;
    /**
     ...
     */
    public List<YDimensionEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
