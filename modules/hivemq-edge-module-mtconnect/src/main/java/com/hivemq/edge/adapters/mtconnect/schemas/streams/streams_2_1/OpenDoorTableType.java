 ...
 * 
 * <p>Java class for OpenDoorTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OpenDoorTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}OpenDoorTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OpenDoorTableType")
@XmlType(name = "OpenDoorTableType", propOrder = {
    "entry"
})
public class OpenDoorTableType
    extends EventType
{
    ...
    protected List<OpenDoorTableEntryType> entry;
    /**
     ...
     */
    public List<OpenDoorTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
