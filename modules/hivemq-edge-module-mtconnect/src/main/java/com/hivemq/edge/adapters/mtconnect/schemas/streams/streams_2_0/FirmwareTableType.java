 ...
 * 
 * <p>Java class for FirmwareTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FirmwareTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}FirmwareTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FirmwareTableType")
@XmlType(name = "FirmwareTableType", propOrder = {
    "entry"
})
public class FirmwareTableType
    extends EventType
{
    ...
    protected List<FirmwareTableEntryType> entry;
    /**
     ...
     */
    public List<FirmwareTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
