 ...
 * 
 * <p>Java class for FeatureMeasurementTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FeatureMeasurementTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}FeatureMeasurementTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FeatureMeasurementTableType")
@XmlType(name = "FeatureMeasurementTableType", propOrder = {
    "entry"
})
public class FeatureMeasurementTableType
    extends EventType
{
    ...
    protected List<FeatureMeasurementTableEntryType> entry;
    /**
     ...
     * {@link FeatureMeasurementTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<FeatureMeasurementTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
