 ...
 * 
 * <p>Java class for MassTableType complex type</p>.
 * 
 ...
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}MassTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MassTableType")
    ...
    extends EventType
{
    ...
    protected List<MassTableEntryType> entry;
    /**
     ...
     */
    public List<MassTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
