 ...
 * 
 * <p>Java class for BatteryStateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BatteryStateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}BatteryStateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "BatteryStateTableType")
@XmlType(name = "BatteryStateTableType", propOrder = {
    "entry"
})
public class BatteryStateTableType
    extends EventType
{
    ...
    protected List<BatteryStateTableEntryType> entry;
    /**
     ...
     * {@link BatteryStateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<BatteryStateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
