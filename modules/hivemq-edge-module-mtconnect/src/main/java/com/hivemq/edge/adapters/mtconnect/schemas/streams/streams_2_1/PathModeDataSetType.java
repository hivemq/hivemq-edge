 ...
 * 
 * <p>Java class for PathModeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PathModeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}PathModeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PathModeDataSetType")
@XmlType(name = "PathModeDataSetType", propOrder = {
    "entry"
})
public class PathModeDataSetType
    extends EventType
{
    ...
    protected List<PathModeEntryType> entry;
    /**
     ...
     */
    public List<PathModeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
