 ...
 * 
 * <p>Java class for PartNumberDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartNumberDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}PartNumberEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartNumberDataSetType")
@XmlType(name = "PartNumberDataSetType", propOrder = {
    "entry"
})
public class PartNumberDataSetType
    extends EventType
{
    ...
    protected List<PartNumberEntryType> entry;
    /**
     ...
     */
    public List<PartNumberEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
