 ...
 * 
 * <p>Java class for MaterialUnloadDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialUnloadDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}MaterialUnloadEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialUnloadDataSetType")
@XmlType(name = "MaterialUnloadDataSetType", propOrder = {
    "entry"
})
public class MaterialUnloadDataSetType
    extends EventType
{
    ...
    protected List<MaterialUnloadEntryType> entry;
    /**
     ...
     */
    public List<MaterialUnloadEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
