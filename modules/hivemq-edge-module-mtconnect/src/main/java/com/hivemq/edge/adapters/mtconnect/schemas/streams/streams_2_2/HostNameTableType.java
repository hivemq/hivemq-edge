 ...
 * 
 * <p>Java class for HostNameTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HostNameTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}HostNameTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "HostNameTableType")
@XmlType(name = "HostNameTableType", propOrder = {
    "entry"
})
public class HostNameTableType
    extends EventType
{
    ...
    protected List<HostNameTableEntryType> entry;
    /**
     ...
     */
    public List<HostNameTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
