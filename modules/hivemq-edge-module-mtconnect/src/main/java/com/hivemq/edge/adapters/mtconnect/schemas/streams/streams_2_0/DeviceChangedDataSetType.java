 ...
 * 
 * <p>Java class for DeviceChangedDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DeviceChangedDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}DeviceChangedEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DeviceChangedDataSetType")
@XmlType(name = "DeviceChangedDataSetType", propOrder = {
    "entry"
})
public class DeviceChangedDataSetType
    extends EventType
{
    ...
    protected List<DeviceChangedEntryType> entry;
    /**
     ...
     */
    public List<DeviceChangedEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
