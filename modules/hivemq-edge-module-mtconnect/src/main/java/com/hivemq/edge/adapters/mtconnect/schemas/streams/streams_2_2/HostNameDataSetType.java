 ...
 * 
 * <p>Java class for HostNameDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HostNameDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}HostNameEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "HostNameDataSetType")
@XmlType(name = "HostNameDataSetType", propOrder = {
    "entry"
})
public class HostNameDataSetType
    extends EventType
{
    ...
    protected List<HostNameEntryType> entry;
    /**
     ...
     */
    public List<HostNameEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
