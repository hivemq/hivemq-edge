 ...
 * 
 * <p>Java class for MaterialChangeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="MaterialChangeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}MaterialChangeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "MaterialChangeDataSetType")
@XmlType(name = "MaterialChangeDataSetType", propOrder = {
    "entry"
})
public class MaterialChangeDataSetType
    extends EventType
{
    ...
    protected List<MaterialChangeEntryType> entry;
    /**
     ...
     */
    public List<MaterialChangeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
