 ...
 * 
 * <p>Java class for PartDetectTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartDetectTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.1}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.1}PartDetectTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartDetectTableType")
@XmlType(name = "PartDetectTableType", propOrder = {
    "entry"
})
public class PartDetectTableType
    extends EventType
{
    ...
    protected List<PartDetectTableEntryType> entry;
    /**
     ...
     */
    public List<PartDetectTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
