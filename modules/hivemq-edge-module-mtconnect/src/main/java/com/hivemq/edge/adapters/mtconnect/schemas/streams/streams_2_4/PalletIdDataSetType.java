 ...
 * 
 * <p>Java class for PalletIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PalletIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}PalletIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PalletIdDataSetType")
@XmlType(name = "PalletIdDataSetType", propOrder = {
    "entry"
})
public class PalletIdDataSetType
    extends EventType
{
    ...
    protected List<PalletIdEntryType> entry;
    /**
     ...
     */
    public List<PalletIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
