 ...
 * 
 * <p>Java class for DischargeRateTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DischargeRateTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}DischargeRateTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DischargeRateTableType")
@XmlType(name = "DischargeRateTableType", propOrder = {
    "entry"
})
public class DischargeRateTableType
    extends EventType
{
    ...
    protected List<DischargeRateTableEntryType> entry;
    /**
     ...
     * {@link DischargeRateTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DischargeRateTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
