 ...
 * 
 * <p>Java class for CapacitySpatialDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CapacitySpatialDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}CapacitySpatialEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CapacitySpatialDataSetType")
@XmlType(name = "CapacitySpatialDataSetType", propOrder = {
    "entry"
})
public class CapacitySpatialDataSetType
    extends EventType
{
    ...
    protected List<CapacitySpatialEntryType> entry;
    /**
     ...
     */
    public List<CapacitySpatialEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
