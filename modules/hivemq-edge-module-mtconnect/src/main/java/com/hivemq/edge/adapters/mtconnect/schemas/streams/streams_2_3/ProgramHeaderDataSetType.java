 ...
 * 
 * <p>Java class for ProgramHeaderDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ProgramHeaderDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ProgramHeaderEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ProgramHeaderDataSetType")
@XmlType(name = "ProgramHeaderDataSetType", propOrder = {
    "entry"
})
public class ProgramHeaderDataSetType
    extends EventType
{
    ...
    protected List<ProgramHeaderEntryType> entry;
    /**
     ...
     */
    public List<ProgramHeaderEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
