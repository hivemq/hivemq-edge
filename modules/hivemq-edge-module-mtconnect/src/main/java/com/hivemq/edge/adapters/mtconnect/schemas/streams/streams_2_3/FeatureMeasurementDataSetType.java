 ...
 * 
 * <p>Java class for FeatureMeasurementDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="FeatureMeasurementDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}FeatureMeasurementEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "FeatureMeasurementDataSetType")
@XmlType(name = "FeatureMeasurementDataSetType", propOrder = {
    "entry"
})
public class FeatureMeasurementDataSetType
    extends EventType
{
    ...
    protected List<FeatureMeasurementEntryType> entry;
    /**
     ...
     * {@link FeatureMeasurementEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<FeatureMeasurementEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
