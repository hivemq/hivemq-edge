 ...
 * 
 * <p>Java class for LevelDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LevelDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}LevelEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LevelDataSetType")
@XmlType(name = "LevelDataSetType", propOrder = {
    "entry"
})
public class LevelDataSetType
    extends EventType
{
    ...
    protected List<LevelEntryType> entry;
    /**
     ...
     */
    public List<LevelEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
