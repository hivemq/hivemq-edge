 ...
 * 
 * <p>Java class for ToolGroupTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolGroupTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}ToolGroupTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolGroupTableType")
@XmlType(name = "ToolGroupTableType", propOrder = {
    "entry"
})
public class ToolGroupTableType
    extends EventType
{
    ...
    protected List<ToolGroupTableEntryType> entry;
    /**
     ...
     */
    public List<ToolGroupTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
