 ...
 * 
 * <p>Java class for PowerFactorTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PowerFactorTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}PowerFactorTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PowerFactorTableType")
@XmlType(name = "PowerFactorTableType", propOrder = {
    "entry"
})
public class PowerFactorTableType
    extends EventType
{
    ...
    protected List<PowerFactorTableEntryType> entry;
    /**
     ...
     * {@link PowerFactorTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<PowerFactorTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
