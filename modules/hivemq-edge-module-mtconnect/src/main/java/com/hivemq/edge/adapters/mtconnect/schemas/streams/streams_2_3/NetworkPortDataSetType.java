 ...
 * 
 * <p>Java class for NetworkPortDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="NetworkPortDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}NetworkPortEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "NetworkPortDataSetType")
@XmlType(name = "NetworkPortDataSetType", propOrder = {
    "entry"
})
public class NetworkPortDataSetType
    extends EventType
{
    ...
    protected List<NetworkPortEntryType> entry;
    /**
     ...
     */
    public List<NetworkPortEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
