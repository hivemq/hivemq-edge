...
@XmlSeeAlso({
    ...
    AlarmLimitsCellType.class,
    ControlLimitsCellType.class,
    SpecificationLimitsCellType.class,
    ToolCuttingItemCellType.class,
    LocationAddressCellType.class,
    ActivePowerSourceCellType.class,
    LocationNarrativeCellType.class,
    ThicknessCellType.class,
    LocationSpatialGeographicCellType.class,
