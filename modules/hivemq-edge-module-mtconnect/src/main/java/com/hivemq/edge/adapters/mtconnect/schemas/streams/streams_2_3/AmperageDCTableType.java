 ...
 * 
 * <p>Java class for AmperageDCTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AmperageDCTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}AmperageDCTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AmperageDCTableType")
@XmlType(name = "AmperageDCTableType", propOrder = {
    "entry"
})
public class AmperageDCTableType
    extends EventType
{
    ...
    protected List<AmperageDCTableEntryType> entry;
    /**
     ...
     */
    public List<AmperageDCTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
