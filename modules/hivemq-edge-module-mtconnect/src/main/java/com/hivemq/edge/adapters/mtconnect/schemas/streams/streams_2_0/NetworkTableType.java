 ...
 * 
 * <p>Java class for NetworkTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="NetworkTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}NetworkTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "NetworkTableType")
@XmlType(name = "NetworkTableType", propOrder = {
    "entry"
})
public class NetworkTableType
    extends EventType
{
    ...
    protected List<NetworkTableEntryType> entry;
    /**
     ...
     */
    public List<NetworkTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
