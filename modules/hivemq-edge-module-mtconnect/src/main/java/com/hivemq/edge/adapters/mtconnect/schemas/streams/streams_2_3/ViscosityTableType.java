 ...
 * 
 * <p>Java class for ViscosityTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ViscosityTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}ViscosityTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ViscosityTableType")
@XmlType(name = "ViscosityTableType", propOrder = {
    "entry"
})
public class ViscosityTableType
    extends EventType
{
    ...
    protected List<ViscosityTableEntryType> entry;
    /**
     ...
     */
    public List<ViscosityTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
