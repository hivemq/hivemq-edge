 ...
 * 
 * <p>Java class for UncertaintyTypeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="UncertaintyTypeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}UncertaintyTypeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "UncertaintyTypeDataSetType")
@XmlType(name = "UncertaintyTypeDataSetType", propOrder = {
    "entry"
})
public class UncertaintyTypeDataSetType
    extends EventType
{
    ...
    protected List<UncertaintyTypeEntryType> entry;
    /**
     ...
     */
    public List<UncertaintyTypeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
