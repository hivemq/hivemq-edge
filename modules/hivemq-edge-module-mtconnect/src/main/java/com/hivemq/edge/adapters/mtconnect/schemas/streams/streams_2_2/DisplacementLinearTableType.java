 ...
 *         {{block(Component)}}.
 * 
 * <p>Java class for DisplacementLinearTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DisplacementLinearTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}DisplacementLinearTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DisplacementLinearTableType")
@XmlType(name = "DisplacementLinearTableType", propOrder = {
    "entry"
})
public class DisplacementLinearTableType
    extends EventType
{
    ...
    protected List<DisplacementLinearTableEntryType> entry;
    /**
     ...
     * {@link DisplacementLinearTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<DisplacementLinearTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
