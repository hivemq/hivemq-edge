 ...
 * 
 * <p>Java class for ToolAssetIdTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolAssetIdTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ToolAssetIdTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolAssetIdTableType")
@XmlType(name = "ToolAssetIdTableType", propOrder = {
    "entry"
})
public class ToolAssetIdTableType
    extends EventType
{
    ...
    protected List<ToolAssetIdTableEntryType> entry;
    /**
     ...
     * {@link ToolAssetIdTableEntryType }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<ToolAssetIdTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
