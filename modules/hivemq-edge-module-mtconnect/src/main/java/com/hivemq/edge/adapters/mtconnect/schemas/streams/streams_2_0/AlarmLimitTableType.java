 ...
 * 
 * <p>Java class for AlarmLimitTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AlarmLimitTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}AlarmLimitTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AlarmLimitTableType")
@XmlType(name = "AlarmLimitTableType", propOrder = {
    "entry"
})
public class AlarmLimitTableType
    extends EventType
{
    ...
    protected List<AlarmLimitTableEntryType> entry;
    /**
     ...
     */
    public List<AlarmLimitTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
