 ...
 * 
 * <p>Java class for ViscosityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ViscosityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ViscosityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ViscosityDataSetType")
@XmlType(name = "ViscosityDataSetType", propOrder = {
    "entry"
})
public class ViscosityDataSetType
    extends EventType
{
    ...
    protected List<ViscosityEntryType> entry;
    /**
     ...
     */
    public List<ViscosityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
