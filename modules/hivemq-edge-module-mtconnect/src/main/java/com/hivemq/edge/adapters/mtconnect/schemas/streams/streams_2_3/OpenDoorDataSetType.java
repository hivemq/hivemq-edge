 ...
 * 
 * <p>Java class for OpenDoorDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OpenDoorDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}OpenDoorEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OpenDoorDataSetType")
@XmlType(name = "OpenDoorDataSetType", propOrder = {
    "entry"
})
public class OpenDoorDataSetType
    extends EventType
{
    ...
    protected List<OpenDoorEntryType> entry;
    /**
     ...
     */
    public List<OpenDoorEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
