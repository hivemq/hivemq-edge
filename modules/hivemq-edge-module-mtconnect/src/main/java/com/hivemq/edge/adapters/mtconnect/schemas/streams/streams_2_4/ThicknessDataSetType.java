 ...
 * 
 * <p>Java class for ThicknessDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ThicknessDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}ThicknessEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ThicknessDataSetType")
@XmlType(name = "ThicknessDataSetType", propOrder = {
    "entry"
})
public class ThicknessDataSetType
    extends EventType
{
    ...
    protected List<ThicknessEntryType> entry;
    /**
     ...
     */
    public List<ThicknessEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
