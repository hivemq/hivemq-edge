 ...
 * 
 * <p>Java class for LoadCountDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LoadCountDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}LoadCountEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "LoadCountDataSetType")
@XmlType(name = "LoadCountDataSetType", propOrder = {
    "entry"
})
public class LoadCountDataSetType
    extends EventType
{
    ...
    protected List<LoadCountEntryType> entry;
    /**
     ...
     */
    public List<LoadCountEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
