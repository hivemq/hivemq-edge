 ...
 * 
 * <p>Java class for AlarmLimitDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AlarmLimitDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}AlarmLimitEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AlarmLimitDataSetType")
@XmlType(name = "AlarmLimitDataSetType", propOrder = {
    "entry"
})
public class AlarmLimitDataSetType
    extends EventType
{
    ...
    protected List<AlarmLimitEntryType> entry;
    /**
     ...
     */
    public List<AlarmLimitEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
