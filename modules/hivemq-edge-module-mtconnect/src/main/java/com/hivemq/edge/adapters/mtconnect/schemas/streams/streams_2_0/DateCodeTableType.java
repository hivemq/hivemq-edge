 ...
 * 
 * <p>Java class for DateCodeTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="DateCodeTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}DateCodeTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "DateCodeTableType")
@XmlType(name = "DateCodeTableType", propOrder = {
    "entry"
})
public class DateCodeTableType
    extends EventType
{
    ...
    protected List<DateCodeTableEntryType> entry;
    /**
     ...
     */
    public List<DateCodeTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
