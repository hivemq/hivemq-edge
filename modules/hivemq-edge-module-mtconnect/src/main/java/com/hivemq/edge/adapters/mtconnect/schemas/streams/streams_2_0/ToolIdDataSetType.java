 ...
 * 
 * <p>Java class for ToolIdDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ToolIdDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}ToolIdEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "ToolIdDataSetType")
@XmlType(name = "ToolIdDataSetType", propOrder = {
    "entry"
})
public class ToolIdDataSetType
    extends EventType
{
    ...
    protected List<ToolIdEntryType> entry;
    /**
     ...
     */
    public List<ToolIdEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
