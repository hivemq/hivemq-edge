 ...
 * 
 * <p>Java class for CycleCountTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CycleCountTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}CycleCountTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "CycleCountTableType")
@XmlType(name = "CycleCountTableType", propOrder = {
    "entry"
})
public class CycleCountTableType
    extends EventType
{
    ...
    protected List<CycleCountTableEntryType> entry;
    /**
     ...
     */
    public List<CycleCountTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
