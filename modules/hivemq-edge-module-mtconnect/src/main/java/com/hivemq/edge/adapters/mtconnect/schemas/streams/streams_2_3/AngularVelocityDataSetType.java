 ...
 * 
 * <p>Java class for AngularVelocityDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AngularVelocityDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.3}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.3}AngularVelocityEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AngularVelocityDataSetType")
@XmlType(name = "AngularVelocityDataSetType", propOrder = {
    "entry"
})
public class AngularVelocityDataSetType
    extends EventType
{
    ...
    protected List<AngularVelocityEntryType> entry;
    /**
     ...
     */
    public List<AngularVelocityEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
