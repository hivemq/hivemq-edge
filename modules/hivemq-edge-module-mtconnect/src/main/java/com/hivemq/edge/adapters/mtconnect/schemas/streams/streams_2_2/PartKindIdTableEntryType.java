 ...
 *       <sequence>
 *         <element name="Cell" type="{urn:mtconnect.org:MTConnectStreams:2.2}PartKindIdCellType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </extension>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PartKindIdTableEntryType", propOrder = {
    "cell"
})
    ...
    extends EntryType
{
    ...
    protected List<PartKindIdCellType> cell;
     ...
     */
    public List<PartKindIdCellType> getCell() {
        if (cell == null) {
            cell = new ArrayList<>();
        }
        return this.cell;
