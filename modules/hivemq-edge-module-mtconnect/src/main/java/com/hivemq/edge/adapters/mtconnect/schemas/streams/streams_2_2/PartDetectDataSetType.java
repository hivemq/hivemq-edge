 ...
 * 
 * <p>Java class for PartDetectDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PartDetectDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.2}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.2}PartDetectEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "PartDetectDataSetType")
@XmlType(name = "PartDetectDataSetType", propOrder = {
    "entry"
})
public class PartDetectDataSetType
    extends EventType
{
    ...
    protected List<PartDetectEntryType> entry;
    /**
     ...
     */
    public List<PartDetectEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
