 ...
 * 
 * <p>Java class for AccumulatedTimeDataSetType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AccumulatedTimeDataSetType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.0}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.0}AccumulatedTimeEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "AccumulatedTimeDataSetType")
@XmlType(name = "AccumulatedTimeDataSetType", propOrder = {
    "entry"
})
public class AccumulatedTimeDataSetType
    extends EventType
{
    ...
    protected List<AccumulatedTimeEntryType> entry;
    /**
     ...
     */
    public List<AccumulatedTimeEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
