 ...
 * 
 * <p>Java class for OperatorIdTableType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="OperatorIdTableType">
 *   <complexContent>
 *     <extension base="{urn:mtconnect.org:MTConnectStreams:2.4}EventType">
 *       <sequence>
 *         <element name="Entry" type="{urn:mtconnect.org:MTConnectStreams:2.4}OperatorIdTableEntryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@com.fasterxml.jackson.annotation.JsonTypeName(value = "OperatorIdTableType")
@XmlType(name = "OperatorIdTableType", propOrder = {
    "entry"
})
public class OperatorIdTableType
    extends EventType
{
    ...
    protected List<OperatorIdTableEntryType> entry;
    /**
     ...
     */
    public List<OperatorIdTableEntryType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<>();
        }
        return this.entry;
