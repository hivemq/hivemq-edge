...
class LREALEncoder extends BaseStaticCipTagEncoder<Number> {

    @Override
    public void encodeSingle(final @NotNull CipTag cipTag, final @NotNull ByteBuffer buf, final @NotNull Number value) {
