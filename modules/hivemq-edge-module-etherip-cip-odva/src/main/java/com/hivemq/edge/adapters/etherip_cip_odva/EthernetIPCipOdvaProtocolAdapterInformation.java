...
public class EthernetIPCipOdvaProtocolAdapterInformation implements ProtocolAdapterInformation {

    public static final @NotNull ProtocolAdapterInformation INSTANCE =
            new EthernetIPCipOdvaProtocolAdapterInformation();
    private static final @NotNull Logger log =
            LoggerFactory.getLogger(EthernetIPCipOdvaProtocolAdapterInformation.class);
    public static final String PROTOCOL_ID = "etheripCipOdva";
    private static final int CURRENT_CONFIG_VERSION = 1;

    private EthernetIPCipOdvaProtocolAdapterInformation() {}
    ...
    public @NotNull String getUrl() {
        return "https://docs.hivemq.com/hivemq-edge/protocol-adapters.html#ethernetip-cip-odva";
    }
