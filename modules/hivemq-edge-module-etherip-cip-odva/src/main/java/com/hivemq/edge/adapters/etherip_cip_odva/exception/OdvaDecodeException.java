...
public class OdvaDecodeException extends OdvaException {
    @NotNull
    private final CipTag cipTag;

    public OdvaDecodeException(@NotNull CipTag cipTag, String msg) {
        super(msg);
        this.cipTag = cipTag;
    }

    public OdvaDecodeException(@NotNull CipTag cipTag, Exception e) {
        super(e);
        this.cipTag = cipTag;
    }
