...
/**
 * {@link com.hivemq.adapter.sdk.api.ProtocolAdapter2 ProtocolAdapter2} implementation for the HTTP adapter.
 * Northbound only (read from device, publish to MQTT).
 */
public class HttpProtocolAdapter2 extends ProtocolAdapter2Bridge {
