...
public class SnmpToMqttConfig {
    ...
    @ModuleConfigField(title = "Polling Interval",
    ...
    @ModuleConfigField(title = "Publish Changed Data Only",
    ...
    public SnmpToMqttConfig(
        ...
        this.maxPollingErrorsBeforeRemoval = Objects.requireNonNullElse(maxPollingErrorsBeforeRemoval, DEFAULT_MAX_POLLING_ERRORS_BEFORE_REMOVAL);
