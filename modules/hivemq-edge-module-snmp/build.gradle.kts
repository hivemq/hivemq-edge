...
dependencies {
    ...
    // SNMP4J is shaded into the fat JAR to avoid classpath conflicts
...
tasks.shadowJar {
    // Relocate SNMP4J to avoid conflicts with other SNMP users on the classpath
    relocate("org.snmp4j", "com.hivemq.edge.adapters.snmp.shaded.snmp4j")
}
