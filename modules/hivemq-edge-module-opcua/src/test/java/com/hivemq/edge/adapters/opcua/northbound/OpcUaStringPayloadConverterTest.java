...
class OpcUaStringPayloadConverterTest extends AbstractOpcUaPayloadConverterTest {
    ...
    private static @NotNull Stream<Arguments> provideBaseTypes() {
        return Stream.of(
                ...
                Arguments.of("Guid", NodeIds.Guid, java.util.UUID.fromString(TEST_UUID), TEST_UUID),
                ...
                Arguments.of("StringControl", NodeIds.String, " \" \\ \b \f \n \r \t ", " \" \\ \b \f \n \r \t "),
    ...
    public void whenTypeSubscriptionPresent_thenReceiveMsg(
        ...
        assertThat(received).extractingByKey(nodeId).satisfies(dataPoints -> {
            assertThat(dataPoints)
                    ...
                    .extracting(DataPointWithMetadata::getTagName, DataPointWithMetadata::getTagValue)
