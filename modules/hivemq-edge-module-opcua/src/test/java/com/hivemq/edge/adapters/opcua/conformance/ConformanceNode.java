...
/**
 * EDG-737 — a minimal {@link Node} whose identity is its parseable OPC-UA node id. Shared by the conformance
 * adapter (materialising browse results) and the conformance tests (seeding browse roots and declared nodes).
 */
final class ConformanceNode extends Node {

    private final @NotNull String parseableNodeId;

    ConformanceNode(final @NotNull String parseableNodeId) {
