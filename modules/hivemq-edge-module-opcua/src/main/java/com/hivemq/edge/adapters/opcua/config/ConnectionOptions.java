...
public record ConnectionOptions(
        ...
        @ModuleConfigField(
                title = "Session Timeout (milliseconds)",
        ...
        @ModuleConfigField(
                title = "Keep-Alive Failures Allowed",
        ...
        @ModuleConfigField(
                title = "Connection Timeout (milliseconds)",
        ...
        @ModuleConfigField(
                title = "Health Check Interval (milliseconds)",
        ...
        @ModuleConfigField(
                title = "Connection Retry Intervals (milliseconds)",
                description =
                        "Comma-separated list of backoff delays in milliseconds for connection retry attempts. The adapter will use these delays sequentially for each retry attempt, repeating the last value if attempts exceed the list length.",
        ...
        @ModuleConfigField(
                title = "Reconnect on Service Fault",
                description =
    ...
    public static ConnectionOptions defaultConnectionOptions() {
        return new ConnectionOptions(
                ...
                DEFAULT_KEEP_ALIVE_FAILURES_ALLOWED,
                DEFAULT_CONNECTION_TIMEOUT,
                DEFAULT_HEALTHCHECK_INTERVAL,
                DEFAULT_RETRY_INTERVALS,
                DEFAULT_AUTO_RECONNECT,
                DEFAULT_RECONNECT_ON_SERVICE_FAULT);
    }
}
