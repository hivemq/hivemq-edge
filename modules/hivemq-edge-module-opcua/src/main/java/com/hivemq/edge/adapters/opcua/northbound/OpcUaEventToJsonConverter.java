...
import com.hivemq.edge.adapters.opcua.condition.ConditionFields;
 ...
 * monitored item, so the values are matched against {@link ConditionFields#SELECTED} by index.
 * <p>
...
public final class OpcUaEventToJsonConverter {
     ...
     * @param values  the event field values, positionally matching {@link ConditionFields#SELECTED}.
    ...
    public static void convertPayload(
        ...
        final List<String> fields = ConditionFields.SELECTED;
