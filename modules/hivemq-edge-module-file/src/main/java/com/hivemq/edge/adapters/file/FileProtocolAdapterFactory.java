...
public class FileProtocolAdapterFactory implements ProtocolAdapterFactory<FileAdapterConfig> {
    ...
    @Override
    public @NotNull ProtocolAdapter createAdapter(final @NotNull ProtocolAdapterInformation adapterInformation, @NotNull final ProtocolAdapterInput<FileAdapterConfig> input) {
