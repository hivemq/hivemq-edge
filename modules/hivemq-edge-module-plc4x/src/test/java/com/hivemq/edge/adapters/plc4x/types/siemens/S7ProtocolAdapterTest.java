...
public class S7ProtocolAdapterTest {
    ...
    private static class TestS7ProtocolAdapter extends S7ProtocolAdapter {
        ...
        @Override
        public @NotNull String createTagAddressForSubscription(final @NotNull Plc4xAdapterConfig.AdapterSubscriptionImpl subscription) {
            return super.createTagAddressForSubscription(subscription);
        }
    }

    private static class S7TestSub extends Plc4xAdapterConfig.AdapterSubscriptionImpl {
