...
public class ABConfigConverter {

    public static @NotNull ABAdapterConfig convertConfig(final ObjectMapper objectMapper, final @NotNull Map<String, Object> config) {
        return objectMapper.convertValue(config, ABAdapterConfig.class);
    }
