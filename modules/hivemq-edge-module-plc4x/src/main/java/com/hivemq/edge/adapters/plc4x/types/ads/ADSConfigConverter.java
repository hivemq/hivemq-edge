...
public class ADSConfigConverter {
    ...
    public static @NotNull ADSAdapterConfig convertConfig(final ObjectMapper objectMapper, final @NotNull Map<String, Object> config) {
        return objectMapper.convertValue(config, ADSAdapterConfig.class);
    }
