...
public abstract class AbstractMqttPublishDecoder<T extends Message> extends AbstractMqttDecoder<T> {
     ...
     */
    protected int decodeQoS(final @NotNull ClientConnection clientConnection, final byte header) {
    ...
    protected @Nullable Boolean decodeDup(
            final @NotNull ClientConnection clientConnection, final byte header, final int qos) {
     ...
     */
    protected @Nullable Boolean decodeRetain(final @NotNull ClientConnection clientConnection, final byte header) {
     ...
     */
    protected int decodePacketIdentifier(final @NotNull ClientConnection clientConnection, final @NotNull ByteBuf buf) {
