...
public record ProtocolAdapterConnectionTransitionResponse(
        ProtocolAdapterConnectionState fromState,
    ...
    public static ProtocolAdapterConnectionTransitionResponse success(
        ...
        return new ProtocolAdapterConnectionTransitionResponse(
                ...
                I18nProtocolAdapterMessage.FSM_CONNECTION_TRANSITION_SUCCESS_TRANSITIONED_FROM_STATE_TO_STATE.get(
                        Map.of(FROM_STATE, fromState.name(), TO_STATE, toState.name())),
                null);
    }

    public static ProtocolAdapterConnectionTransitionResponse notChanged(
            final @NotNull ProtocolAdapterConnectionState state) {
        return new ProtocolAdapterConnectionTransitionResponse(
                state,
                state,
                ProtocolAdapterTransitionStatus.NotChanged,
                I18nProtocolAdapterMessage.FSM_CONNECTION_TRANSITION_SUCCESS_STATE_IS_UNCHANGED.get(
