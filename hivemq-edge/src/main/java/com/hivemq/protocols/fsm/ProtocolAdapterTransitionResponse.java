...
public record ProtocolAdapterTransitionResponse(
    ...
    public static ProtocolAdapterTransitionResponse success(
        ...
        return new ProtocolAdapterTransitionResponse(
                ...
                I18nProtocolAdapterMessage.FSM_TRANSITION_SUCCESS_TRANSITIONED_FROM_STATE_TO_STATE.get(
    ...
    public static ProtocolAdapterTransitionResponse notChanged(final @NotNull ProtocolAdapterRuntimeState state) {
        return new ProtocolAdapterTransitionResponse(
                ...
                I18nProtocolAdapterMessage.FSM_TRANSITION_SUCCESS_STATE_IS_UNCHANGED.get(Map.of(STATE, state.name())),
                null);
    }
    ...
    public static ProtocolAdapterTransitionResponse failure(
        ...
        return new ProtocolAdapterTransitionResponse(
                ...
                I18nProtocolAdapterMessage.FSM_TRANSITION_FAILURE_UNABLE_TO_TRANSITION_FROM_STATE_TO_STATE.get(
                        Map.of(FROM_STATE, fromState.name(), TO_STATE, toState.name())),
                null);
    }
}
