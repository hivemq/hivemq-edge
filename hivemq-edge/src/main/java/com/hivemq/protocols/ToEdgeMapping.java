...
public class ToEdgeMapping {
    ...
    public ToEdgeMapping(
            final @NotNull String tagName, final @NotNull String topicFilter, final int maxQoS) {
    ...
    public static @NotNull ToEdgeMapping fromEntity(
        ...
        return new ToEdgeMapping(toEdgeMappingEntity.getTagName(),
                toEdgeMappingEntity.getTopicFilter(), toEdgeMappingEntity.getMaxQos());
    }
    ...
    public static @NotNull ToEdgeMapping from(
            final @NotNull WritingContext writingContext) {
        return new ToEdgeMapping(writingContext.getTagName(),
                writingContext.getMqttTopicFilter(),
                writingContext.getMqttMaxQos());
