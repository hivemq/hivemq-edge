...
public class SubscriptionSampler implements ProtocolAdapterPollingSampler {
    ...
    private final @NotNull PollingProtocolAdapter protocolAdapter;
    ...
    public CompletableFuture<? extends ProtocolAdapterDataSample> execute() {
        ...
        pollFuture.thenApply((dataSample)->{
            return this.captureDataSample(dataSample);
        });
        return pollFuture;
    }
    ...
    public boolean equals(final @Nullable Object o) {
        ...
        final SubscriptionSampler that = (SubscriptionSampler) o;
