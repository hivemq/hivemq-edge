 ...
 * <b>gentlest correct transition</b> the manager applies on reload. The classes are ordered from
...
public enum ProtocolAdapterConfigStateTransition {
     ...
     * wrapper: no reconnect, no re-verification of unaffected aspects.
     */
    ACTIVATION_ONLY,
     ...
     * which diffs in place — never reconnects.
     */
    TAGS_ONLY,
     ...
     * discarded, and a fresh pair is created and started. The
