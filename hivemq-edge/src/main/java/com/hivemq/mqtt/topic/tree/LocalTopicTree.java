...
public class LocalTopicTree {
    ...
    public boolean addTopic(
        ...
        final SubscriberWithQoS entry = new SubscriberWithQoS(
                subscriber, topic.getQoS().getQosNumber(), flags, sharedName, topic.getSubscriptionIdentifier(), null);
            ...
            if (last != null) {
                ...
                if (!equalSubscription(current, last)) {
                    ...
                    if (current.getSubscriptionIdentifier() != null) {
                        ...
                        final ImmutableIntArray mergedSubscriptionIds = ImmutableIntArray.builder(
    ...
    ****************************************/
                ...
                if (node != null) {
                    ...
                    if (node.isNodeEmpty()) {
                        ...
                        if (childrenOfParent != null) {
                            ...
                            final TopicTreeNode childOfParent =
                                    parent.getChildrenMap().get(node.getTopicPart());
    ...
    private static void iterateChildNodesForSubscriberRemoval(
        ...
        // Note dobermai: We don't need to check for "+" subscribers explicitly, because unsubscribes are always
        // absolute
        ...
        public void acceptNonRootState(final @NotNull MatchingNodeSubscriptions matchingNodeSubscriptions) {
            ...
            if (nonSharedSubscriptions != null) {
                nonSharedSubscriptions
                        .filter(subscriberWithQoS ->
                                subscriberWithQoS.getSubscriber().equals(client))
