...
public class RetainedMessagesSender {
    ...
    /**
     * Writes out the retained message for a given topic to the given {@link Channel}
     * <p>
     *
    ...
    public @NotNull ListenableFuture<Void> writeRetainedMessages(
        ...
        Futures.addCallback(
                ...
                new SendRetainedMessageCallback(
                        subscribedTopics,
                        hiveMQId,
                    ...
                    new FutureCallback<>() {
                        ...
                        public void onSuccess(final @Nullable PublishStatus status) {
                            ...
                            if (qos0Publish.getPacketIdentifier() != 0) {
                                final FreePacketIdRanges messageIDPool = channel.attr(
                                                ClientConnection.CHANNEL_ATTRIBUTE_NAME)
                                        .get()
                                        .getMessageIDPool();
