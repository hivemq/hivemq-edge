...
public class FrontendResourceImpl extends AbstractApi implements FrontendApi {
    ...
    public @NotNull Response getConfiguration() {
        return Response.ok(new GatewayConfiguration(getEnvironmentProperties(),
                ...
                configurationService.apiConfiguration().getConfidentialityAgreement())).build();
    }
    ...
    private @NotNull ConfidentialityAgreement getConfidentialityAgreement() {
        return configurationService.apiConfiguration().getConfidentialityAgreement();
    }
