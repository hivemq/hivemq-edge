...
public class ChannelHandlerNames {
    ...
    public static final String MQTTSN_MESSAGE_DECODER = "mqttsn_message_decoder";
    ...
    public static final String MQTTSN_SLEEP_HANDLER = "mqttsn_sleep_handler";
    public static final String MQTTSN_AWAKE_HANDLER = "mqttsn_awake_handler";
    public static final String MQTTSN_CHANNEL_ADAPTER = "mqttsn_channel_adapter";
    ...
    public static final String MQTTSN_MESSAGE_ENCODER = "mqttsn_message_encoder";
