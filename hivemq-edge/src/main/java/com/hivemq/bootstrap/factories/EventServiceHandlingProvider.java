...
public class EventServiceHandlingProvider {
    ...
    @Inject
    public EventServiceHandlingProvider(
    ...
    public @Nullable EventServiceHandling get() {
        final EventServiceHandlingFactory factory = handlerService.getDataHubEventServiceHandlingFactory();
        if (factory == null) {
            return null;
        }
