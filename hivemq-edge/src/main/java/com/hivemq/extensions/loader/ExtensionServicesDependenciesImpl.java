...
public class ExtensionServicesDependenciesImpl implements ExtensionServicesDependencies {
    ...
    private final @NotNull EdgeInterceptorRegistry edgeInterceptorRegistry;
    ...
    public ExtensionServicesDependenciesImpl(
            ...
            final @NotNull EdgeInterceptorRegistry edgeInterceptorRegistry) {
        ...
        this.edgeInterceptorRegistry = edgeInterceptorRegistry;
    }
    ...
    @Override
    @NotNull
    public ImmutableMap<String, Object> getEdgeDependenciesMap(final @NotNull ClassLoader classLoader) {
        // classLoader is unused but prepared here for future use
        final ImmutableMap.Builder<String, Object> builder = ImmutableMap.builder();

        builder.put(EdgeInterceptorRegistry.class.getCanonicalName(), edgeInterceptorRegistry);
        return builder.build();
    }
