 ...
 */
public class PingRespOutboundOutputImpl extends AbstractAsyncOutput<PingRespOutboundOutput>
        implements PingRespOutboundOutput, Supplier<PingRespOutboundOutputImpl> {
