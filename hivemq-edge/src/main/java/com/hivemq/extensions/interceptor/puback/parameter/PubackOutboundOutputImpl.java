...
public class PubackOutboundOutputImpl extends AbstractSimpleAsyncOutput<PubackOutboundOutput>
        implements PubackOutboundOutput {
    ...
    public @NotNull PubackOutboundOutputImpl update(final @NotNull PubackOutboundInputImpl input) {
        return new PubackOutboundOutputImpl(asyncer, pubackPacket.update(input.getPubackPacket()));
    }
}
