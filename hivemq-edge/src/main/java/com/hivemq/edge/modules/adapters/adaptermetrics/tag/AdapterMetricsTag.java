...
public class AdapterMetricsTag implements Tag {
    ...
    @ModuleConfigField(title = "Definition", description = "The metric to observe", required = true)
    private final @NotNull AdapterMetricsTagDefinition definition;

    public AdapterMetricsTag(
            ...
            @JsonProperty(value = "definition", required = true)
                    final @NotNull AdapterMetricsTagDefinition definition) {
        this.name = name;
    ...
    @Override
    public @NotNull AdapterMetricsTagDefinition getDefinition() {
        return definition;
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AdapterMetricsTag that)) return false;
