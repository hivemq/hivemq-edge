...
public interface InstanceDataStorageFactory {
    CompletableFuture<ProtocolAdapterInstanceDataService> getOrCreate(final @NotNull String protocolId, final @NotNull String adapterId);
