...
public final class DataIdentifierReferenceTypeConverter implements
        EntityConverter<com.hivemq.edge.api.model.DataIdentifierReference.TypeEnum, DataIdentifierReference.Type> {
    public final static DataIdentifierReferenceTypeConverter INSTANCE = new DataIdentifierReferenceTypeConverter();

    private DataIdentifierReferenceTypeConverter() {
    }

    @Override
    public @NotNull DataIdentifierReference.Type toInternalEntity(final @NotNull com.hivemq.edge.api.model.DataIdentifierReference.TypeEnum entity) {
    ...
    @Override
    public @NotNull com.hivemq.edge.api.model.DataIdentifierReference.TypeEnum toRestEntity(final @NotNull DataIdentifierReference.Type entity) {
        return switch (entity) {
