...
public class ApiConfigurationServiceImpl implements ApiConfigurationService {
    ...
    private @NotNull ConfidentialityAgreement confidentialityAgreement = new ConfidentialityAgreement();
    ...
    @Override
    public void setConfidentialityAgreement(final @NotNull ConfidentialityAgreement confidentialityAgreement) {
