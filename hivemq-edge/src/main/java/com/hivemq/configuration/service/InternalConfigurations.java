...
public class InternalConfigurations {
    ...
    public static final int AVAILABLE_PROCESSORS_TIMES_TWO =
            Runtime.getRuntime().availableProcessors() * 2;
    private static final int AVAILABLE_PROCESSORS_TIMES_FOUR =
    ...
    public static final @NotNull AtomicInteger EXTENSION_SERVICE_CALL_RATE_LIMIT_PER_SEC =
            new AtomicInteger(0); // unlimited
