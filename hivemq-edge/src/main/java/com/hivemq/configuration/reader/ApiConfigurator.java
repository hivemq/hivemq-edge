...
import com.hivemq.configuration.entity.api.CAEntity;
...
public class ApiConfigurator implements Configurator<AdminApiEntity> {
    ...
    public @NotNull ConfigResult applyConfig(final @NotNull HiveMQConfigEntity config) {
        ...
        final CAEntity ca = entity.getConfidentialityAgreement();
        apiCfgService.setConfidentialityAgreement(new ConfidentialityAgreement(ca.isEnabled(), ca.getContent()));
