...
var load_theme_exports = {};
__export(load_theme_exports, {
  bundleConfigFile: () => bundleConfigFile,
  loadTheme: () => loadTheme
});
module.exports = __toCommonJS(load_theme_exports);
init_cjs_shims();
...
async function bundleRequire(filepath, cwd) {
  ...
  let dependencies;
  try {
    const realFileName = (0, import_fs_extra.realpathSync)(filePath);
...
function loadTheme(path2) {
  return bundleRequire(path2, process.cwd());
}
