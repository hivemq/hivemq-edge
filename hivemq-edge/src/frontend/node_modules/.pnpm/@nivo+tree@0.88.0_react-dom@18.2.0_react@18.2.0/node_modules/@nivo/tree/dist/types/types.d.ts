...
import { Box, Dimensions, MotionProps, Theme, PropertyAccessor, CompleteTheme, Margin } from '@nivo/core';
...
export type NodeCanvasRenderer<Datum> = (ctx: CanvasRenderingContext2D, props: NodeCanvasRendererProps<Datum>) => void;
...
export type LinkCanvasRenderer<Datum> = (ctx: CanvasRenderingContext2D, props: LinkCanvasRendererProps<Datum>) => void;
...
export type LabelCanvasRenderer<Datum> = (ctx: CanvasRenderingContext2D, props: LabelCanvasRendererProps<Datum>) => void;
...
export type CustomCanvasLayer<Datum> = (ctx: CanvasRenderingContext2D, props: CustomCanvasLayerProps<Datum>) => void;
...
export type TreeSvgProps<Datum> = TreeDataProps<Datum> & Dimensions & Partial<CommonProps<Datum>> & {
...
export type TreeCanvasProps<Datum> = TreeDataProps<Datum> & Dimensions & Partial<CommonProps<Datum>> & {
