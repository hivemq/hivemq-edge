...
define("vs/editor/editor.main.nls.ko", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"코드 작업 메뉴를 사용하지 않도록 설정합니다.",
		"커서가 코드가 있는 줄에 있을 때 코드 동작 메뉴를 표시합니다.",
		...
		"편집기에서 인라인 편집 내용을 표시할지 여부를 제어합니다.",
		"인라인 추천을 표시할 때마다 인라인 편집 도구 모음을 표시합니다.",
		"인라인 추천을 마우스로 가리키면 인라인 편집 도구 모음을 표시합니다.",
		"인라인 편집 도구 모음을 표시하지 않습니다.",
		"인라인 편집 도구 모음을 표시할 시기를 제어합니다.",
		"인라인 편집의 글꼴 패밀리를 제어합니다.",
		"인라인 편집의 배경에 색을 적용할지 여부를 제어합니다.",
		...
		"마우스 휠을 사용할 때 \'Cmd` 키를 누르고 있으면 편집기의 글꼴을 확대/축소합니다.",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"마우스를 사용할 때 항목 간에 항목을 이동할 때 목록/트리 끌어서 놓기 테두리 색입니다.",
