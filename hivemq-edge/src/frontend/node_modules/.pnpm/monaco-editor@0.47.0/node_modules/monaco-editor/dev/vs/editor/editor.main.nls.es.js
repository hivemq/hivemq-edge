...
define("vs/editor/editor.main.nls.es", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Deshabilite el menú de acción de código.",
		"Muestra el menú de acción del código cuando el cursor está en líneas con código.",
		"Muestra el menú de acción de código cuando el cursor está en líneas con código o en líneas vacías.",
		...
		"Controla si se van a mostrar las ediciones insertadas en el editor.",
		"Muestra la barra de herramientas de edición insertada cada vez que se muestra una sugerencia insertada.",
		"Mostrar la barra de herramientas de edición insertada al pasar el ratón por encima de una sugerencia insertada.",
		"No mostrar nunca la barra de herramientas de edición insertada.",
		"Controla cuándo mostrar la barra de herramientas de edición insertada.",
		"Controla la familia de fuentes de la edición insertada.",
		"Controla si se colorea el fondo de las ediciones insertadas.",
		...
		"Acercar la fuente del editor al usar la rueda del mouse y mantener pulsado \'Cmd\'.",
	...
	"vs/editor/contrib/folding/browser/foldingDecorations": [
		...
		"Haga clic para expandir el rango.",
		"Haga clic para contraer el intervalo.",
	],
	...
	"vs/editor/contrib/rename/browser/rename": [
		...
		"Enfocar la siguiente sugerencia de cambio de nombre",
		"Enfocar sugerencia de cambio de nombre anterior",
	],
	"vs/editor/contrib/rename/browser/renameInputField": [
		"Indica si el widget de cambio de nombre de entrada está visible.",
		"Si el widget de entrada de cambio de nombre está enfocado",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Fondo de lista/árbol al arrastrar y colocar cuando se mueven elementos sobre otros elementos al usar el mouse.",
		"Color del borde de lista o árbol al arrastrar y colocar cuando se mueven elementos entre otros elementos mediante el mouse.",
