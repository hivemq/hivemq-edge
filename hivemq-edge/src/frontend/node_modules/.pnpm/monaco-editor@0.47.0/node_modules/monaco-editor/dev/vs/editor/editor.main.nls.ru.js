...
define("vs/editor/editor.main.nls.ru", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Определяет время задержки в миллисекундах перед скрытием наведения. Требуется включить \"editor.hover.sticky\".",
		...
		"Включить прокрутку Sticky Scroll с помощью горизонтальной полосы прокрутки редактора.",
		...
		"При установке этого параметра горизонтальная полоса прокрутки не будет увеличивать размер содержимого редактора.",
		...
		"Определяет, отображаются ли встроенные правки в редакторе.",
		"Отображать встроенную панель инструментов редактирования при каждом отображении встроенного предложения.",
		"Отображать встроенную панель инструментов редактирования при наведении курсора на встроенное предложение.",
		"Никогда не отображать встроенную панель инструментов редактирования.",
		"Определяет, когда отображать встроенную панель инструментов редактирования.",
		"Управляет семейством шрифтов встроенного редактирования.",
		"Определяет, нужно ли закрашивать фон встроенных правок.",
		...
		"Использовать конфигурации языка для автоматического закрытия комментариев.",
		"Автоматически закрывать комментарии только в том случае, если курсор находится слева от пробела.",
		"Определяет, должен ли редактор автоматически закрывать комментарии при добавлении пользователем открывающего комментария.",
		...
		"Не выделяет вхождения.",
		"Выделяет вхождения только в текущем файле.",
		"Экспериментальная функция: выделяет вхождения во всех допустимых открытых файлах.",
		"Определяет, следует ли выделять вхождения в открытых файлах.",
		...
		"Определяет, следует ли предоставлять указание о специальных возможностях пользователям средства чтения с экрана при отображении встроенного завершения.",
	...
	"vs/editor/contrib/codeAction/browser/codeActionController": [
		"Контекст: {0} в строке {1} и столбце {2}.",
		"Скрыть отключенные",
	...
	"vs/editor/contrib/hover/browser/hover": [
		...
		"При наведении указатель мыши не будет автоматически фокусироваться.",
		"При наведении указателя мыши будет фокусировка произойдет только в том случае, если он уже виден.",
		"Когда он появится, при наведении указателя мыши произойдет автоматическая фокусировка.",
	...
	"vs/editor/contrib/inlineCompletions/browser/inlineCompletionsController": [
		"Проверить этот аспект в представлении с поддержкой специальных возможностей ({0})",
	],
	...
	"vs/platform/accessibilitySignal/browser/accessibilitySignalService": [
		...
		"Вложенные указания отсутствуют",
		"Задача завершена",
		"Задача завершена",
		"Сбой задачи",
		"Сбой задачи",
	...
	"vs/platform/actionWidget/browser/actionWidget": [
		"Цвет фона для переключаемых элементов действий на панели действий.",
	...
	"vs/platform/list/browser/listService": [
		...
		"Определяет количество залипающих элементов, отображаемых в дереве при включении параметра \"#workbench.tree.enableStickyScroll#\".",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Цвет фона для сегментов предварительно отформатированного текста.",
		...
		"Цвет, используемый для значка ИИ с лампочкой.",
		...
		"Цвет границы перетаскивания списка/дерева при перемещении элементов между элементами с помощью мыши.",
		...
		"Цвет маркера на мини-карте для информации.",
