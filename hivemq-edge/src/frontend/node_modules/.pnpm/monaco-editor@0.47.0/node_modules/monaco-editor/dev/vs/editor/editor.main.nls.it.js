...
define("vs/editor/editor.main.nls.it", {
	...
	"vs/editor/browser/widget/diffEditor/diffEditor.contribution": [
		"Usa la visualizzazione inline quando lo spazio è limitato",
		...
		"Attiva/disattiva la visualizzazione inline quando lo spazio è limitato",
		"Editor diff",
	...
	"vs/editor/common/config/editorConfigurationSchema": [
		...
		"Se la larghezza dell\'editor diff è inferiore a questo valore, verrà utilizzata la visualizzazione inline.",
		"Se questa opzione è abilitata e la larghezza dell\'editor è troppo piccola, verrà usata la visualizzazione inline.",
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Visualizza il menu azione codice quando il cursore è su righe di codice.",
		"Mostra il menu azione codice quando il cursore è su righe con codice o su righe vuote.",
		...
		"Se impostata, la barra di scorrimento orizzontale non aumenterà le dimensioni del contenuto dell\'editor.",
		...
		"Controlla se visualizzare le modifiche inline nell\'Editor.",
		"Mostra la barra degli strumenti di modifica inline ogni volta che viene visualizzato un suggerimento inline.",
		"Mostra la barra degli strumenti di modifica inline quando si passa il mouse su un suggerimento inline.",
		"Non mostrare mai la barra di modifica inline.",
		"Controlla quando mostrare la barra di modifica inline.",
		"Controlla la famiglia di caratteri della modifica inline.",
		"Controlla se colorare lo sfondo delle modifiche inline.",
		...
		"Controlla se è possibile trascinare un file in un editor di testo tenendo premuto il tasto “MAIUSC” (invece di aprire il file in un editor).",
		...
		"Controlla se l\'hint di accessibilità deve essere fornito agli utenti dell\'utilità per la lettura dello schermo quando viene visualizzato un completamento inline.",
	...
	"vs/editor/common/editorContextKeys": [
		...
		"Indica se il contesto è un editor con più differenze",
		"Indica se tutti i file nell\'editor con più differenze sono compressi",
		"Indica se l\'editor diff ha delle modifiche",
		"Indica se un blocco di codice spostato è selezionato per il confronto",
	...
	"vs/editor/contrib/codeAction/browser/codeActionContributions": [
		...
		"Abilita/disabilita la visualizzazione della correzione rapida più vicino all\'interno di una riga quando non è attualmente in una diagnostica.",
	],
	...
	"vs/editor/contrib/dropOrPasteInto/browser/dropIntoEditorContribution": [
		"Configura il provider di eliminazione predefinito da usare per il contenuto di un tipo MIME specifico.",
	],
	...
	"vs/editor/contrib/find/browser/findController": [
		"Il file è troppo grande per eseguire un\'operazione di sostituzione.",
		"Trova",
		"&&Trova",
	...
	"vs/editor/contrib/hover/browser/hover": [
		...
		"Il passaggio del mouse attiverà lo stato attivo solo se è già visibile.",
	...
	"vs/editor/contrib/rename/browser/renameInputField": [
		...
		"Indica se il widget di ridenominazione input è attivo",
	...
	"vs/platform/list/browser/listService": [
		...
		"Controlla se lo scorrimento permanente è abilitato negli alberi.",
		"Controlla il numero di elementi permanenti visualizzati nell\'albero quando \'#workbench.tree.enableStickyScroll#\' è abilitato.",
