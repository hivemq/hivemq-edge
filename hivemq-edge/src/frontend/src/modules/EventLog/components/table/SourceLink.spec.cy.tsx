...
import SourceLink from '@/modules/EventLog/components/table/SourceLink.tsx'
...
describe('SourceLink', () => {
  ...
  it('should render the bridge component', () => {
    cy.mountWithProviders(<SourceLink event={mockEdgeEvent(5)[0]} />)
  ...
  it('should render the adapter component', () => {
    cy.mountWithProviders(<SourceLink event={mockEdgeEvent(5)[1]} />)
  ...
  it('should render the adapter component', () => {
    cy.mountWithProviders(<SourceLink event={mockEdgeEvent(5)[2]} />)
  ...
  it('should render the adapter component', () => {
    cy.mountWithProviders(<SourceLink event={mockEdgeEvent(5)[3]} />)
  ...
  it('should render the adapter component', () => {
    cy.mountWithProviders(<SourceLink event={mockEdgeEvent(5)[4]} />)
