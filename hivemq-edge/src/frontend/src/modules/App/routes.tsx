...
const EdgeFlowPage = lazy(() => import('@/modules/EdgeVisualisation/EdgeFlowPage.tsx'))
const NodePanelController = lazy(
  () => import('@/modules/EdgeVisualisation/components/controls/NodePanelController.tsx')
)
