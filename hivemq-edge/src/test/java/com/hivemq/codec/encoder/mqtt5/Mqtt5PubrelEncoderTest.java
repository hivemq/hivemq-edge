...
public class Mqtt5PubrelEncoderTest extends AbstractMqtt5EncoderTest {
    ...
    public void encode_all_properties() {
        ...
        final PUBREL pubRel = new PUBREL((127 * 256) + 1, SUCCESS, "reason", userProperties);
    ...
    public void encode_simple_reason_string() {
        ...
        final PUBREL pubRel = new PUBREL(
                9, Mqtt5PubRelReasonCode.PACKET_IDENTIFIER_NOT_FOUND, "reason", Mqtt5UserProperties.NO_USER_PROPERTIES);
        encodeTestBufferSize(expected, pubRel);
    }
