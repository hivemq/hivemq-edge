...
public class Mqtt5DisconnectEncoderTest extends AbstractMqtt5EncoderTest {
    ...
    public void encode_reasonCode() {
        ...
        final DISCONNECT disconnect = new DISCONNECT(
                MALFORMED_PACKET, null, Mqtt5UserProperties.NO_USER_PROPERTIES, null, SESSION_EXPIRY_NOT_SET);
        encodeTestBufferSize(expected, disconnect);
    }
    ...
    public void encode_noReasonCodeIfNormalWithoutProperties() {
        ...
        final DISCONNECT disconnect = new DISCONNECT(
                NORMAL_DISCONNECTION, null, Mqtt5UserProperties.NO_USER_PROPERTIES, null, SESSION_EXPIRY_NOT_SET);
        encodeTestBufferSize(expected, disconnect);
    }
    ...
    public void encode_reasonString() {
        ...
        final String reasonString = "reason";
        final DISCONNECT disconnect = new DISCONNECT(
                MALFORMED_PACKET, reasonString, Mqtt5UserProperties.NO_USER_PROPERTIES, null, SESSION_EXPIRY_NOT_SET);
        encodeTestBufferSize(expected, disconnect);
    }
