...
public class Mqtt5PubcompDecoderTest extends AbstractMqtt5DecoderTest {
    ...
    private final @NotNull Mqtt5PubCompReasonCode reasonCode = Mqtt5PubCompReasonCode.SUCCESS;
    ...
    public void decode_big_packet() {
        ...
        final ImmutableList<MqttUserProperty> userProperties =
                pubComp.getUserProperties().asList();
    ...
    @NotNull
    private PUBCOMP decode(final byte @NotNull [] encoded) {
        final ByteBuf byteBuf = channel.alloc().buffer();
