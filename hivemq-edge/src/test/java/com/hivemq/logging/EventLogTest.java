...
public class EventLogTest {
    ...
    public void setUp() throws Exception {
        ...
        clientConnection.setConnectedListener(new MqttTcpListener(0, "localhost", "", null));
    ...
    public void messageDropped() {
        ...
        logMessageBuffer
                .append("Outgoing publish message was dropped. Receiving client: ")
                .append(clientId)
                .append(", topic: ")
                .append(topic)
                .append(", qos: ")
    ...
    public void sharedSubscriptionMessageDropped() {
        ...
        logMessageBuffer
                .append("Outgoing publish message was dropped. Receiving shared subscription group: ")
                .append(group)
                .append(", topic: ")
                .append(topic)
                .append(", qos: ")
    ...
    public void mqttMessageDropped() {
        ...
        logMessageBuffer
                .append("Outgoing MQTT packet was dropped. Receiving client: ")
                .append(clientId)
                .append(", messageType: ")
                .append(messageType)
                .append(", reason: ")
    ...
    public void clientDisconnected_ungracefully() {
        ...
        logMessageBuffer
                ...
                .append(", IP: ")
                .append("UNKNOWN")
                .append(" disconnected ungracefully from MQTT TCP Listener on port: 0.");
