...
public class TestRemoveSubscriberFromTopicInTopicTreeImpl {
    ...
    */
    ...
    public void test_remove_second_subscriber_with_one_level_wildcard_subscription() {
        ...
        assertThat(firstNode.exactSubscriptions.getSubscribers())
                .contains(new SubscriberWithQoS("subscriber", 0, (byte) 0, null, null, null));
    }
    ...
    public void test_remove_subscriber_subscription_multiple_levels_children_get_deleted() {
        ...
        assertEquals(
                1, LocalTopicTree.getChildrenCount(topicTree.segments.get("my").getChildren()[0]));
        assertEquals(
                1,
                topicTree
                        .segments
    ...
    @Test
    public void
            test_remove_subscription_multiple_levels_children_get_deleted_only_if_not_other_subscribers_available() {
        ...
        assertEquals(
                1,
                topicTree.segments.get("my").getChildren()[0].exactSubscriptions.getSubscriberCount());
        ...
        assertThat(topicTree
                        .segments
                        .get("my")
                        .getChildren()[1]
                        .exactSubscriptions
                        .getSubscribers())
                .contains(new SubscriberWithQoS("subscriber2", 0, (byte) 0, null, null, null));
    }
    ...
    */
    ...
    @Test
    public void
            test_remove_wildcard_subscription_multiple_levels_children_get_deleted_only_if_not_other_subscribers_available() {
        topicTree.addTopic("subscriber", new Topic("my/topic/#", QoS.AT_MOST_ONCE), (byte) 0, null);
        topicTree.addTopic("subscriber2", new Topic("my/second/#", QoS.AT_MOST_ONCE), (byte) 0, null);
    ...
    public void test_remove_multi_level_topic_from_index_map() {
        ...
        assertEquals(
                3, topicTree.segments.get("topic").children[0].getChildrenMap().size());
        ...
        assertEquals(
                2, topicTree.segments.get("topic").children[0].getChildrenMap().size());
        topicTree.removeSubscriber("subscriber3", "topic/topic1/part2", null);
        assertEquals(
                1, topicTree.segments.get("topic").children[0].getChildrenMap().size());
