...
class DeviceTagValidatorTest {
    ...
    void validate_validTagName() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("my-tag.name_1").build());
    ...
    void validate_invalidTagName_specialChars() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag with spaces").build());
    ...
    void validate_validQos() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1").maxQos(0).build(),
    ...
    void validate_invalidQos_tooHigh() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1").maxQos(3).build());
    ...
    void validate_invalidQos_negative() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1").maxQos(-1).build());
    ...
    void validate_northboundTopic_noWildcards() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .northboundTopic("adapter/data/int32").build());
    ...
    void validate_northboundTopic_withPlusWildcard() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .northboundTopic("adapter/+/int32").build());
    ...
    void validate_southboundTopic_wildcardAllowed() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .southboundTopic("adapter/+/write/#").build());

        final List<ValidationError> errors = validator.validate(rows, ImportMode.CREATE, "adapter1");

        assertThat(errors).noneMatch(e ->
                e.code().equals("INVALID_TOPIC") && e.column().equals("southbound_topic"));
    }
    ...
    void validate_validExpiryInterval() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .messageExpiryInterval(3600L).build());
    ...
    void validate_invalidExpiryInterval_negative() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .messageExpiryInterval(-1L).build());
    ...
    void validate_invalidExpiryInterval_zero() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .messageExpiryInterval(0L).build());
        ...
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .southboundFieldMapping(List.of(
                                new FieldMappingInstruction("source", "destination")))
                        .build());
    ...
    void validate_fieldMapping_emptySource() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .southboundFieldMapping(List.of(
                                new FieldMappingInstruction("", "destination")))
                        .build());
    ...
    void validate_fieldMapping_emptyDestination() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("tag1")
                        .southboundFieldMapping(List.of(
                                new FieldMappingInstruction("source", "")))
                        .build());
    ...
    void validate_northboundMappingWithoutTag() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1")
                        .northboundTopic("adapter/data/int32").build());
    ...
    void validate_southboundMappingWithoutTag() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1")
                        .southboundTopic("adapter/write/int32").build());
    ...
    void validate_missingNodeId_withTag() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().tagName("tag1").build());
    ...
    void validate_missingNodeId_withoutTag_noError() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodePath("/Objects/Data").build());
    ...
    void validate_multipleErrors_allCollected() {
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("-invalid").maxQos(5)
    ...
    void validate_tagConflict_createMode() {
        final ProtocolAdapterEntity adapter = new ProtocolAdapterEntity(
                "adapter1", "opcua", 1, Map.of(),
                List.of(), List.of(),
                List.of(new TagEntity("existing-tag", "desc", Map.of("node", "ns=2;i=1"))));
        ...
        final List<DeviceTagRow> rows = List.of(
                DeviceTagRow.builder().nodeId("ns=2;i=1").tagName("existing-tag").build());
    ...
    void validate_edgeTagConflict_otherAdapter() {
        final ProtocolAdapterEntity myAdapter = new ProtocolAdapterEntity(
                "adapter1", "opcua", 1, Map.of(), List.of(), List.of(), List.of());
        final ProtocolAdapterEntity otherAdapter = new ProtocolAdapterEntity(
                "adapter2", "opcua", 1, Map.of(), List.of(), List.of(),
