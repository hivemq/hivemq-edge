...
/**
 * Throws a {@link RuntimeException} when the class constructor is invoked.
 */
public class TestConstructorThrowsExceptionExtensionMain implements ExtensionMain {

    public TestConstructorThrowsExceptionExtensionMain() {
