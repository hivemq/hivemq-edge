...
public class ModifiablePublishPacketImplTest {
    ...
    public void setQos_null() {
        ...
        assertThatThrownBy(() -> modifiablePacket.setQos(null)).isInstanceOf(NullPointerException.class);
    }
    ...
    public void setRetain_notAvailable() {
        ...
        assertThatThrownBy(() -> modifiablePacket.setRetain(true)).isInstanceOf(IllegalArgumentException.class);
    }
