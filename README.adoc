...
* Download the latest https://github.com/hivemq/hivemq-edge/releases/download/2023.1/hivemq-edge-2023.1.zip[HiveMQ Edge binary package].
* Unzip the package.
...
[source,bash]
----
docker run --name hivemq-edge -d -p 1883:1883 -p 8080:8080 hivemq/hivemq-edge:2023.1
----
...
[source,bash]
----
docker run --name hivemq-edge -e HIVEMQ_LOG_LEVEL=INFO -d -p 1883:1883 -p 8080:8080 hivemq/hivemq-edge:2023.1
