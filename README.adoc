...
It is a Java-based open source MQTT broker that fully supports MQTT 3.x and 5.

MQTT-SN support has been removed.
...
* Contribution guidelines: link:CONTRIBUTING.md[Contributing.md]
