...
describe('ColorPicker', () => {
  ...
  it('should render properly', () => {
    ...
    cy.get("[data-testId^='colorPicker-selector']").should('have.length', 10)
    cy.get("[data-testId^='colorPicker-selector']").eq(5).should('have.attr', 'data-color-scheme', 'blue')

    cy.get('@onChange').should('not.have.been.called')
    cy.get("[data-testId^='colorPicker-selector']").eq(5).click()
